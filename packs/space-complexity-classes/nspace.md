---
title: "NSPACE"
source: https://en.wikipedia.org/wiki/NSPACE
...
> If a language *L* is decided in space *S*(*n*) (where *S*(*n*) ≥ log *n*) by a non-deterministic Turing machine, then there exists a constant *C* such that *L* is decided in time *O*(*C**S*(*n*)) by a deterministic one.
