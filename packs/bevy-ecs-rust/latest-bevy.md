...
This crate provides additional utilities for the
...
This crate provides a straightforward solution for integrating diagnostics in the

Bevy game engine

. It allows users to easily add diagnostic functionality to their Bevy applications, enhancing their ability to monitor and optimize their games.
...
is a collection of styled and themed widgets for building editors and inspectors.
...
and type definitions for loading glTF 2.0 (a standard 3D scene definition format) files in Bevy.
...
This crate provides logging functions and configuration for
...
Platform compatibility support for first-party
...
General utilities for first-party
...
provides utilities to handle window creation and the eventloop through
...
This plugin group will add the minimal plugins for a
