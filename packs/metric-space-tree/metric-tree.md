---
title: "Metric tree"
source: https://en.wikipedia.org/wiki/Metric_tree
...
- MATLAB: Metric trees are implemented in the `metricTree` class that is part of the United States Naval Research Laboratory's free and open-source software Tracker Component Library.
