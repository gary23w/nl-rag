---
title: "Acetylene"
source: https://en.wikipedia.org/wiki/Acetylene
...
The first sample of acetylene produced was by Edmund Davy in 1836, via hydrolysis (decomposition using water) of potassium carbide. Subsequently, the first industrial method for synthesis was by hydrolysis of calcium carbide:
...
At room temperature and atmospheric pressure, the solubility of acetylene in acetone is 27.9 g per kg. For the same amount of dimethylformamide (DMF), the solubility is 51 g. At 20.26 bar, the solubility increases to 689.0 and 628.0 g for acetone and DMF, respectively. These solvents are used in pressurized gas cylinders.
...
One of the major chemical applications is ethynylation of formaldehyde. Acetylene adds to aldehydes and ketones to form α-ethynyl alcohols:
...
Metal acetylides, species of the formula L*n*M−C2R, are also common. Copper(I) acetylide and silver acetylide can be formed in aqueous solutions with ease due to a favorable solubility equilibrium.
