---
title: "Gap reduction"
source: https://en.wikipedia.org/wiki/Gap_reduction
...
. Here, the best solution to instance
...
has a cost, or score, below

k

.

${\text{OPT}}_{P}(x)>c\cdot k$
...
The gap between the two thresholds is thus
