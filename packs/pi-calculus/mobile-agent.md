---
title: "Mobile agent"
source: https://en.wikipedia.org/wiki/Mobile_agent
domain: pi-calculus
...
2. Free roaming mobile agent: these have a dynamic migration path. Depending on the present network condition, the mobile agent chooses its path.
