...
Following Hopcroft & Ullman (1979), a (one-tape) Turing machine can be formally defined as a 7-tuple $M=\langle Q,\Gamma ,b,\Sigma ,\delta ,q_{0},F\rangle$ where
...
> > 
> > ..., which represents the standard model for string-oriented computation, and the
> > 
> > random access machine (RAM)
> > 
> > as introduced by Cook and Reckhow ..., which models the idealised Von Neumann-style computer.
