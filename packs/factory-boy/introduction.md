---
title: "Introduction"
source: https://factoryboy.readthedocs.io/en/stable/introduction.html
domain: factory-boy
...
For more complex situations, you may also use the `@factory.sequence` decorator (note that `self` is not added as first parameter):
...
As for `Sequence`, a `@factory.lazy_attribute` decorator is available:
