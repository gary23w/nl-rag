---
title: "Amazons"
source: https://en.wikipedia.org/wiki/Amazons
domain: trousers
...
It may alternatively be a Greek word descended from **n̥-mn̥gʷ-yō-nós* 'manless, without husbands' (alpha privative combined with a derivation from **man-* cognate with Proto-Balto-Slavic **mangjá-*, found in Czech and South Slavic *muž*) has been proposed, an explanation deemed "unlikely" by Hjalmar Frisk. A further explanation proposes Iranian **ama-janah* 'virility-killing' as source.
...
Another list of Amazons' names is found in Hyginus's *Fabulae*. Along with Hippolyta, Otrera, Antiope and Penthesilea, it attests the following names: Ocyale, Dioxippe, Iphinome, Xanthe, Hippothoe, Laomache, Glauce, Agave, Theseis, Clymene, Polydora.
...
The medieval Borgia Velletri map pictures females with bow and arrow and others with spear and shield, with thedescription "The land formerly of illustrious women", at the north (on the bottom) of *Edilus fluuius maximus* (the Volga river).

In the medieval Fra Mauro map, a land called Ancient Greek: Ἀμαζόnia, romanized: *Amazonia* is placed on the Middle Volga region.
