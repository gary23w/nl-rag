---
title: "Refraction"
source: https://en.wikipedia.org/wiki/Refraction
...
For light, refraction follows Snell's law, which states that, for a given pair of media, the ratio of the sines of the angle of incidence ${\theta _{1}}$ and angle of refraction ${\theta _{2}}$ is equal to the ratio of phase velocities ${\textstyle {\frac {v_{1}}{v_{2}}}}$ in the two media, or equivalently, to the refractive indices ${\textstyle {\frac {n_{2}}{n_{1}}}}$ of the two media:
