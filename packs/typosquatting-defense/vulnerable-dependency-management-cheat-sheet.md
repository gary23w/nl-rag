...
domain: typosquatting-defense
license: CC-BY-SA-4.0
tags: typosquatting defense, package name confusion, malicious lookalike package, registry namespace protection
fetched: 2026-07-02
---
...
- OWASP TOP 10 2017 under the point *A9 - Using Components with Known Vulnerabilities*.
...
- One or several tests failed, several output paths are possible:
  ...
  - Technical incompatibility of the released dependency (*e.g.* require a more recent runtime version) which leads to the following actions: 1. Raise the issue to the provider. 2. Apply Case 2 while waiting for the provider's feedback.
...
- Free
  ...
  - OWASP Dependency Track can be used to manage vulnerable dependencies across an organization.
  - Trivy
  ...
  - Grype
    ...
    - Targets: container images, filesystems, and SBOMs produced by Syft
- Commercial
