...
source: https://en.wikipedia.org/wiki/3D_Computer_Aided_Design
domain: asme-y14-41
...
Based on market statistics, commercial software from Autodesk, Dassault Systèmes, Siemens PLM Software, and PTC dominate the CAD industry. The following is a list of major CAD applications, grouped by usage statistics.
