...
In the early years of the 19th century, Humphry Davy experimented on decomposing compounds into elements using the newly invention of the voltaic pile. This led to speculation that chemical bonding was related to electricity and in 1812 Jöns Jakob Berzelius published a theory of chemical combination stressing the electronegative and electropositive characters of the combining atoms.

By the mid 19th century, Edward Frankland, F.A. Kekulé, A.S. Couper, Alexander Butlerov, and Hermann Kolbe, building on the theory of radicals, developed the theory of valency, originally called "combining power", in which compounds were joined owing to an attraction of positive and negative poles. In 1904, Richard Abegg proposed his rule that the difference between the maximum and minimum valencies of an element is often eight.
