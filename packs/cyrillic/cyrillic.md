...
source: https://en.wikipedia.org/wiki/Cyrillic
domain: cyrillic
...
Differences between upright and italic Cyrillic letters of the

Russian alphabet

; italic forms significantly different from their upright analogues, or especially confusing to users of a Latin alphabet, are highlighted; also available as a
...
Examples of non-Slavic Cyrillic letters (see
...
As of Unicode version 17.0, Cyrillic letters, including national and historical alphabets, are encoded across several blocks:
