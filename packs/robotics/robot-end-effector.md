...
source: https://en.wikipedia.org/wiki/Robot_end_effector
domain: robotics
...
3. Astrictive: attractive forces applied to the object's surface (whether by vacuum, magneto-, or electroadhesion).
...
Here, the value of $\,g$ should be taken as the acceleration due to gravity and $\,a$ the acceleration due to movement.
...
- (An example of a basic force-closure end effector)An example of a basic force-closure end effector
- (A spot welding end effector)A spot welding end effector
- A laser welding end effector
- (A repair and observation end effector in use in space (Canadarm2 Latching End Effector))A repair and observation end effector in use in space (Canadarm2 Latching End Effector)
- (A highly sophisticated attempt at reproducing the human-hand force-closure end effector)A highly sophisticated attempt at reproducing the human-hand force-closure end effector
