...
's are consumed, and then recognizing the
...
will then descend into B, which in turn
...
's by means of many recursive calls to
...
then, rather than descending again into

X

, queries the position 0 against rule
