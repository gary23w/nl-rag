...
source: https://en.wikipedia.org/wiki/Acadian_French
domain: auregnais
...
- /ɡ/ and /dj/ often become [d͡ʒ] (sometimes [ʒ]) before a front vowel. For example, *bon dieu* and *gueule* become [bɔ̃ ˈdʒø] and [d͡ʒœl] in informal Acadian French. *Braguette* becomes [bɾaˈd͡ʒɛt]. (This pronunciation led to the word Ca**j**un, from Aca**di**en.)
