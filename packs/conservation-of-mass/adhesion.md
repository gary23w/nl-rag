...
> 
> *Note 1*: Adhesion requires energy that can come from chemical and/or physical linkages, the latter being reversible when enough energy is applied.
> 
...
If the surfaces are unequal, the Young-Dupré equation applies: W12 = γ1 + γ2 – γ12, where γ1 and γ2 are the surface energies of the two new surfaces, and γ12 is the interfacial energy.
