---
title: "Package on a package"
source: https://en.wikipedia.org/wiki/Package_on_package
...
PoP packaging can be done by the chip manufacturer (such as Samsung or TSMC), or can be done by the OEM (such as Xiaomi).
...
- PSvfBGA: refers to the bottom package: *P*ackage *S*tackable *V*ery thin *F*ine pitch *B*all *G*rid *A*rray
- PSfcCSP: refers to the bottom package: *P*ackage *S*tackable *F*lip *C*hip *C*hip *S*cale *P*ackage
