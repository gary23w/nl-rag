...
Get Spark from the downloads page of the project website. This documentation is for Spark version 4.1.2. Spark uses Hadoop’s client libraries for HDFS and YARN. Downloads are pre-packaged for a handful of popular Hadoop versions. Users can also download a “Hadoop free” binary and run Spark with any Hadoop version by augmenting Spark’s classpath. Scala and Java users can include Spark in their projects using its Maven coordinates and Python users can install Spark from PyPI.
...
- SparkR (Deprecated): processing data with Spark in R
- PySpark: processing data with Spark in Python
- Spark SQL CLI: processing data with SQL on the command line
- Declarative Pipelines: building data pipelines that create and maintain multiple tables
...
- Deployment modes:
  ...
  - Kubernetes: deploy Spark apps on top of Kubernetes directly
  - Amazon EC2: scripts that let you launch a cluster on EC2 in about 5 minutes
- Spark Kubernetes Operator:
  - SparkApp: deploy Spark apps on top of Kubernetes via operator patterns
  - SparkCluster: deploy Spark clusters on top of Kubernetes via operator patterns

**Other Documents:**

- Configuration: customize Spark via its configuration system
- Monitoring: track the behavior of your applications
- Web UI: view useful information about your applications
...
- Code Examples: more are also available in the `examples` subfolder of Spark (Python, Scala, Java, R)
