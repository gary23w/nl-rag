...
source: https://en.wikipedia.org/wiki/Robot_kinematics
...
**Robot kinematics** applies geometry to the study of the movement of multi–degree of freedom kinematic chains that form the structure of robotic systems. The emphasis on geometry means that the links of the robot are modeled as rigid bodies and its joints are assumed to provide revolute or prismatic motion.
