...
The −C≡C− ion has a closed shell ground state of 1Σ+ g, making it isoelectronic to a neutral molecule N2, which may afford it some gas-phase stability.

- (Structure of sodium acetylide [Na+]2[−C≡C−]. Color code: gray = C, blue = Na.) Structure of sodium acetylide [Na+]2[−C≡C−]. Color code: gray = C, blue = Na.
- (Structure and unit cell of potassium acetylide [K+]2[−C≡C−].) Structure and unit cell of potassium acetylide [K+]2[−C≡C−].
- (Structure of the cluster formed from PhC≡CLi complexed to N,N,N′,N′-tetramethyl-1,6-diaminohexane (methylene groups omitted for clarity). Color key: turquoise = Li, blue = N.) Structure of the cluster formed from PhC≡CLi complexed to N,N,N′,N′-tetramethyl-1,6-diaminohexane (methylene groups omitted for clarity). Color key: turquoise = Li, blue = N.
