...
where *TF* is also a constant. Now if we set $K_{P}=K\left(1+{\frac {T_{D}}{T_{I}}}\right)$ , *KD* = *KTD*, and $K_{I}={\frac {K}{T_{I}}}$ , we can express the PID controller transfer function in series form as
