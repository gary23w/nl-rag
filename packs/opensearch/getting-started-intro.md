...
source: https://opensearch.org/docs/latest/getting-started/intro/
domain: opensearch
...
(A cluster containing two indexes and two nodes)
...
(A cluster containing two indexes with one replica shard for each shard in the index)
...
OpenSearch uses the BM25 ranking algorithm to calculate document relevance scores and then returns the results sorted by relevance. To learn more, see Okapi BM25.

## Next steps

- Learn how to install OpenSearch within minutes in Installation quickstart.
