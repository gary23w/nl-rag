---
title: "Abbreviation"
source: https://en.wikipedia.org/wiki/Abbreviations
domain: adjective
...
In the Early Modern English period, between the 15th and 17th centuries, the thorn Þ was used for *th*, as in Þe ('the'). In modern times, ⟨Þ⟩ was often used (in the form ⟨y⟩) for promotional reasons, as in Ye Olde Tea Shoppe.
...
In HTML, abbreviations can be annotated using a dedicated tag: `<abbr title="Editor">Ed.</abbr>` In this example, the meaning of "Ed." as "Editor" is revealed by hovering the cursor over it.
