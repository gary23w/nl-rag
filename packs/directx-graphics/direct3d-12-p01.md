---
title: "Direct3D (part 1/2)"
source: https://en.wikipedia.org/wiki/Direct3D_12
...
In 1992, Servan Keondjian, Doug Rabson and Kate Seekings started a company named RenderMorphics, which developed a 3D graphics API named Reality Lab, which was used in medical imaging and CAD software. Two versions of this API were released. Microsoft bought RenderMorphics in February 1995, bringing its staff on board to implement a 3D graphics engine for Windows 95. The first version of Direct3D shipped in **DirectX 2.0** (June 2, 1996) and **DirectX 3.0** (September 26, 1996).
