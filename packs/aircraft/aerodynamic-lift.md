---
title: "Lift (force)"
source: https://en.wikipedia.org/wiki/Aerodynamic_lift
domain: aircraft
...
Lift depends on the size of the wing, being approximately proportional to the wing area. It is often convenient to quantify the lift of a given airfoil by its *lift coefficient* $C_{L}$ , which defines its overall lift in terms of a unit area of the wing.

If the value of $C_{L}$ for a wing at a specified angle of attack is given, then the lift produced for specific flow conditions can be determined:
