...
source: https://en.wikipedia.org/wiki/Entity_Framework
...
- **ComplexType**, is an aggregate of multiple properties of type *SimpleType*, or *ComplexType*. Unlike *EntityType*s, however, *ComplexTypes* cannot have an *EntityKey*. In Entity Framework v1 *ComplexTypes* cannot be inherited.
