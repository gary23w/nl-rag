...
domain: incident-management-deep
...
Written by Andrew Stribblehill78 Edited by Kavita Guliani
...
Incident management skills and practices exist to channel the energies of enthusiastic individuals. Google’s incident management system is based on the Incident Command System,79 which is known for its clarity and scalability.
...
, the commander holds all positions that they have not delegated. If appropriate, they can remove roadblocks that prevent Ops from working most effectively.
...
78An earlier version of this chapter appeared as an article in *;login:* (April 2015, vol. 40, no. 2).

79See *https://www.fema.gov/national-incident-management-system* for further details.
