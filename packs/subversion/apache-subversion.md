...
source: https://en.wikipedia.org/wiki/Apache_Subversion
domain: subversion
...
Subversion was created by CollabNet Inc. in 2000, and was a top-level Apache project being built and used by a global community of contributors.
...
|---|---|---|---|---|
| Unsupported: 1.0 | 2004-02-23 | 1.0.9 | 2004-10-13 | No longer supported |
| Unsupported: 1.1 | 2004-09-29 | 1.1.4 | 2005-04-01 | No longer supported |
| Unsupported: 1.2 | 2005-05-21 | 1.2.3 | 2005-08-19 | No longer supported |
| Unsupported: 1.3 | 2005-12-30 | 1.3.2 | 2006-05-23 | No longer supported |
| Unsupported: 1.4 | 2006-09-10 | 1.4.6 | 2007-12-21 | No longer supported |
| Unsupported: 1.5 | 2008-06-19 | 1.5.9 | 2010-12-06 | No longer supported |
| Unsupported: 1.6 | 2009-03-20 | 1.6.23 | 2013-05-30 | No longer supported |
| Unsupported: 1.7 | 2011-10-11 | 1.7.22 | 2015-08-12 | No longer supported |
| Unsupported: 1.8 | 2013-06-18 | 1.8.19 | 2017-08-10 | No longer supported |
| Unsupported: 1.9 | 2015-08-05 | 1.9.12 | 2019-07-24 | No longer supported |
| Unsupported: 1.10 | 2018-04-13 | 1.10.8 | 2022-04-12 | No longer supported |
| Unsupported: 1.11 | 2018-10-30 | 1.11.1 | 2019-01-11 | No longer supported |
| Unsupported: 1.12 | 2019-04-24 | 1.12.2 | 2019-07-24 | No longer supported |
| Unsupported: 1.13 | 2019-10-30 | 1.13.0 | 2019-10-30 | No longer supported |
| Latest version: 1.14 LTS | 2020-05-27 | 1.14.5 | 2024-12-08 | Fully supported |
| Future version: 1.15 |   |   |   | In development |
...
1. Local filesystem or network filesystem, accessed by client directly. This mode uses the file:///path access scheme.
...
-hosted working copies executable, when supported by the filesystem.
...
A list of filename patterns to ignore in a directory. Similar to
...
to substitute into a file when changes are made. The file itself must also reference the keywords as
...
The keyword substitution mechanism originates from
...
This property is not meant to be set or modified directly by users.

As of 2010

it is only used for having

symbolic links

in the repository. When a symbolic link is added to the repository, a file containing the link target is created with this property set. When a Unix-like system checks out this file, the client converts it to a symbolic link.

**svn:mergeinfo**

Used to track merge data (revision numbers) in Subversion 1.5 (or later). This property is automatically maintained by the

merge

command, and it is not recommended to change its value manually.
...
2. When two (ideally independent) object types live in the repository tree, a "fight to the top" can ensue. In other words, it is often difficult to decide at which level to create the `tags/` subdirectory: **trunk**/ /component**foo**/ /component**bar**/ **tags**/ /1.1/ /component**foo**/ /component**bar**/  or  component**foo**/ /**trunk**/ /**tags**/ /1.1/ component**bar**/ /**trunk**/ /**tags**/ /1.1/
