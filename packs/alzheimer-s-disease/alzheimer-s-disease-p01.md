---
title: "Alzheimer's disease (part 1/2)"
source: https://en.wikipedia.org/wiki/Alzheimer's_disease
...
Alzheimer's disease (AD) can be definitively diagnosed only with autopsy findings; in the absence of autopsy, clinical diagnoses of AD are "possible" or "probable", based on other findings. Up to 23% of those clinically diagnosed with AD may be misdiagnosed and may have pathology suggestive of another condition with symptoms that mimic those of AD.
