---
title: ".us - Wikipedia"
source: https://en.wikipedia.org/wiki/.us
...
- *fed.us* for agencies of the U.S. federal government (historical; superseded by *.gov*)
  - Example: www.fs.fed.us (formerly the United States Forest Service)
- *isa.us* for interstate authorities created by interstate compacts
  - Example: imcc.isa.us (Interstate Mining Compact Commission)
...
- *dni.us* for distributed national institutes
  - Example: ccj.ncsc.dni.us (formerly the Conference of Chief Justices, part of the National Center for State Courts), www.theta-delta-chi.dni.us (formerly the Theta Delta Chi fraternity)
...
- ci.*locality*.*state*.us for city governments
  - Example: www.ci.east-palo-alto.ca.us (East Palo Alto, California), ci.mansfield.oh.us (Mansfield, Ohio)
- co.*locality*.*state*.us for county governments
  - Example: www.co.adams.id.us (Adams County, Idaho)
...
- *borough*.*locality*.*state*.us for borough governments
  - Example: borough.shippensburg.pa.us (Shippensburg, Pennsylvania)
- *city*.*locality*.*state*.us for city governments
  - Example: www.city.waltham.ma.us (Waltham, Massachusetts)
...
- *town*.*locality*.*state*.us for town governments
  - Example: www.town.northlake.tx.us (Northlake, Texas), www.town.windermere.fl.us (Windermere, Florida)
- *twp*.*locality*.*state*.us or *township*.*locality*.*state*.us for township governments
  - Examples: twp.jerusalem.oh.us (Jerusalem Township, Lucas County, Ohio), www.township.wilson.mn.us (Wilson Township, Winona County, Minnesota), twp.greene.franklin.pa.us (Green Township, Franklin County, Pennsylvania)
- *vil*.*locality*.*state*.us or *village*.*locality*.*state*.us for village governments
  - Examples: www.vil.bellwood.il.us (Bellwood, Illinois), www.village.fairport.ny.us (Fairport, New York)

In some cases, a local government that serves as the delegated manager for its own locality may locate its website directly under the *locality*, omitting the *organization-name*. For example, the website of the City of Brunswick, Ohio, is located at www.brunswick.oh.us rather than www.ci.brunswick.oh.us, and the website of Delhi Township, Ohio, is located at www.delhi.oh.us instead of www.twp.delhi.oh.us. Unusually, Lima, Ohio, is located at www.cityhall.lima.oh.us.

Many large cities use .gov extensions, for example Chicago (www.chicago.gov); Rochester, New York and (www.cityofrochester.gov). Several cities, villages, and towns use the *locality**state*.gov format, often with the state abbreviated, for example, Atlanta, Georgia (www.atlantaga.gov), Northport, New York (www.northportny.gov), and Huntington, New York (www.huntingtonny.gov). Although most New York City websites have moved to www.nyc.gov, *us* redirects exist for individual city agencies, such as the Independent Budget Office at www.ibo.nyc.ny.us and the Board of Elections at vote.nyc.ny.us.

Private organizations and individuals may register fourth-level domains parallel to these government domains, for example:

- bcn.boulder.co.us (a community network in Boulder, Colorado)
- hpnc.cincinnati.oh.us (the neighborhood council for Hyde Park, Cincinnati)
- michael.silverton.palo-alto.ca.us (Michael Silverton, a resident of Palo Alto, California)
- owen.sj.ca.us or owen.san-jose.ca.us (a family in San Jose, California)
- www.sna.providence.ri.us (the neighborhood association for Hope, Providence, Rhode Island)
- social.seattle.wa.us (a Mastodon instance in Seattle)
- social.tulsa.ok.us (a Mastodon instance in Tulsa, Oklahoma)
- wclug.chicago.il.us (a Linux user group in Chicago)
- well.sf.ca.us (The WELL, a virtual community in San Francisco)
...
- *state*: state government agencies (*organization-name*.state.*state*.us)
  - Examples: arkleg.state.ar.us (Arkansas General Assembly), mdhhsmiimmsportal.state.mi.us (Michigan Department of Health and Human Services immunization records portal), tap.state.nm.us (New Mexico Taxation and Revenue Department tax filing system)
- *dst*: government agencies in administrative districts (*organization-name*.dst.*state*.us)
  - Example: lnva.dst.tx.us (Lower Neches Valley Authority)
- *cog*: councils of governments, that is, federations of cities or counties (*organization-name*.cog.*state*.us)
  - Example: stdc.cog.tx.us (South Texas Development Council)
- *k12*: public elementary and/or secondary unified school districts (*district-name*.k12.*state*.us) individual schools (*school-name*.k12.*state*.us). Also used by public agencies overseeing educational institutions.
  - Examples: iberia.k12.la.us (Iberia Parish School District), www.pctc.k12.oh.us (Pioneer Career and Technology Center), ospi.k12.wa.us (Washington State Office of Superintendent of Public Instruction)
  - *pvt.k12*: private elementary or secondary schools (*school-name*.pvt.k12.*state*.us or *school-name*.*diocese-name*.pvt.k12.*state*.us)
    - Examples: www.ionaprep.pvt.k12.ny.us (Iona Preparatory School), www.stmary-wooster.cld.pvt.k12.oh.us (a private K-12 school in the Roman Catholic Diocese of Cleveland in Ohio)
...
- *cc*: community colleges (*school-name*.cc.*state*.us)
  - Example: www.lakeland.cc.il.us (Lake Land College)
- *tec*: technical and vocational schools (*school-name*.tec.*state*.us)
  - Example: ap.tec.pa.us (Admiral Peary Vocational-Technical School)
...
- *mus*: museums (*museum-name*.mus.*state*.us)
  - Example: www.ok-history.mus.ok.us (Oklahoma Historical Society)
- *gen*: general independent entities (clubs or other groups not fitting into the above categories) (*organization-name*.gen.*state*.us)
  - Examples: www.mrc.gen.mn.us (a amateur radio association in Minnesota), luni.gen.il.us (a Linux user group for northern Illinois), squaredance.gen.or.us (a statewide federation of square dance clubs)
