...
2. Parameter learning for the probability distributions of each node in the network
3. Structure learning of the graphical network
...
Several equivalent definitions of a Bayesian network have been offered. For the following, let *G* = (*V*,*E*) be a directed acyclic graph (DAG) and let *X* = (*X**v*), *v* ∈ *V* be a set of random variables indexed by *V*.
