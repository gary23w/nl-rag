...
source: https://en.wikipedia.org/wiki/Event_log
domain: log-analysis-detection
license: CC-BY-SA-4.0
tags: security log analysis, audit event logging, syslog aggregation, log correlation detection, centralized log management
fetched: 2026-07-02
---
