...
- RFC 7763 – "*The text/markdown Media Type,*" *Informational.* Introduces MIME type `text/markdown`.
- RFC 7764 – "*Guidance on Markdown: Design Philosophies, Stability Strategies, and Select Registrations,*" *Informational.* Discusses and registers the variants MultiMarkdown, GitHub Flavored Markdown (GFM), Pandoc, and Markdown Extra (among others).
