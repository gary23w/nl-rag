...
source: https://en.wikipedia.org/wiki/Dynamic_equilibrium
...
Dynamic equilibria can also occur in the gas phase; for example, when nitrogen dioxide dimerizes.
...
There are two reactions to consider, the forward reaction in which the species A is converted into B and the reverse reaction in which B is converted into A. If both reactions are elementary reactions, then the rate of reaction is given by
...
In practice, concentration changes will not be measurable after ${\textstyle t\gtrapprox {\frac {10}{k_{f}+k_{b}}}.}$ Since the concentrations do not change thereafter, they are, by definition, equilibrium concentrations. Now, the equilibrium constant for the reaction is defined as
