---
title: "Deletion (genetics)"
source: https://en.wikipedia.org/wiki/Deletion_(genetics)
...
In the yeast *Saccharomyces cerevisiae*, the nuclear genes *Rad51*p, *Rad52*p and *Rad59p* encode proteins that are necessary for recombinational repair and are employed in the repair of double strand breaks in mitochondrial DNA. Loss of these proteins decreases the rate of spontaneous DNA deletion events in mitochondria. This finding implies that the repair of DNA double-strand breaks by homologous recombination is a step in the formation of mitochondrial DNA deletions.
