---
title: "Titration"
source: https://en.wikipedia.org/wiki/Titration
...
The approximate pH during titration can be approximated by three kinds of calculations. Before beginning of titration, the concentration of ${\ce {[H+]}}$ is calculated in an aqueous solution of weak acid before adding any base. When the number of moles of bases added equals the number of moles of initial acid or so called equivalence point, one of hydrolysis and the pH is calculated in the same way that the conjugate bases of the acid titrated was calculated. Between starting and end points, ${\ce {[H+]}}$ is obtained from the Henderson-Hasselbalch equation and titration mixture is considered as buffer. In Henderson-Hasselbalch equation the [acid] and [base] are said to be the molarities that would have been present even with dissociation or hydrolysis. In a buffer, ${\ce {[H+]}}$ can be calculated exactly but the dissociation of HA, the hydrolysis of ${\ce {A-}}$ and self-ionization of water must be taken into account. Four independent equations must be used:

$[{\ce {H+}}][{\ce {OH-}}]=10^{-14}$

$[{\ce {H+}}]=K_{a}{\ce {{\frac {[HA]}{[A^{-}]}}}}$
