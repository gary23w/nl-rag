...
Checks are frequently conducted to confirm information found on an employment application or résumé/curriculum vitae. One study showed that half of all reference checks done on prospective employees differed between what the job applicant provided and what the source reported. A 2026 survey by GCheck of job applicants in the United States reported that misrepresentation in applications is relatively common and is associated with perceptions of limited verification, as well as demand for greater transparency in background screening processes. They are also used to differentiate potential employees further and to select the candidate the employer considers best suited for the position. Employers are obligated to ensure their work environment is safe for all employees and helps prevent other employment problems in the workplace.
