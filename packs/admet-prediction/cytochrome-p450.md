...
source: https://en.wikipedia.org/wiki/Cytochrome_P450
domain: admet-prediction
...
The heme in cytochrome P450 binds to a conserved sequence: `FxxGxRxCxG`, where "x" denotes some variant amino acid. The cysteine (C) binds Fe and arginine (R), forming strong electrostatic interactions with negatively charged side chains of the heme. The glycine (G) residues within the conserved sequence are essential, as their small structure enables surrounding alpha helices to remain in place without interacting with a variant amino acid. Additional conserved motifs are:
