...
- uvloop: Shown to improve performance as an alternative to `asyncio`.
...
`run_async` is a helper function to run simple Tortoise scripts. For production use, see Tortoise-ORM FastAPI integration, Tortoise-ORM Sanic integration and other integrations, as welll as check out The Importance of Cleaning Up.
...
Find more examples (including transactions, using multiple databases and more complex querying) in Examples and Query API.
