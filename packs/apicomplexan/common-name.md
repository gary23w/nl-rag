---
title: "Common name"
source: https://en.wikipedia.org/wiki/Common_name
domain: apicomplexan
...
In biology, a **common name** is a name of a taxon or organism that is based on the normal language of everyday life. It is often contrasted with the scientific name for the same organism, which is often based in Latin. Common names can be used frequently, but that is not always the case.
...
| Plants Plant by common name Garden plants Culinary herbs and spices Poisonous plants Plants in the Bible Vegetables Useful plants | Animals Birds by region Mammals by region List of fish common names | Plants and animals Invasive species |
|---|---|---|
