---
title: "chroot"
source: https://en.wikipedia.org/wiki/Chroot
...
By 2002, a French article by Nicolas Boiteux described how to create jails on Linux.

By 2003, first internet microservices providers with Linux jails provide SaaS/PaaS (e.g., shell containers, proxy, ircd, bots, etc.) services billed for consumption into the jail by usage.
...
Legacy software or software using a different
...
Should a system be rendered unbootable, a chroot can be used to move back into the damaged environment after bootstrapping from an alternate root file system (such as from installation media, or a
...
Programs are allowed to carry open
...
The Postfix mail transfer agent may operate as a pipeline of individually chrooted helper programs.
