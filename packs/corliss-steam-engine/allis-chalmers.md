...
source: https://en.wikipedia.org/wiki/Allis-Chalmers
...
- (A-C Model 20-35)A-C Model 20-35
- (A-C Model B)A-C Model B
- (A-C Model G)A-C Model G
- (1939 A-C Model WC)1939 A-C Model WC
- (A-C Model WD)A-C Model WD
- (A-C Model WD45)A-C Model WD45
- (A-C Model D15)A-C Model D15
- (A-C Model D17 pulling a 12' Spring-Tooth Harrow)A-C Model D17 pulling a 12' Spring-Tooth Harrow
- (A-C Model D21 Series II)A-C Model D21 Series II
- (A-C Model 160)A-C Model 160
- (A-C Model 7060 in Wisconsin)A-C Model 7060 in Wisconsin
- (A-C model 4W-305, the most powerful Ag tractor built by the company)A-C model 4W-305, the most powerful Ag tractor built by the company
...
- (1958 A-C Model "60" All-Crop Harvester)1958 A-C Model "60" All-Crop Harvester
- (1965 Gleaner Model "E" Combine)1965 Gleaner Model "E" Combine
- (Gleaner Model "L2")Gleaner Model "L2"
...
- (A-C model HD20 with Hydraulic bulldozer blade)A-C model HD20 with Hydraulic bulldozer blade
- (A-C model W road grader)A-C model W road grader
- (A-C model HD20 crawler tractor with cable-actuated bulldozer blade)A-C model HD20 crawler tractor with cable-actuated bulldozer blade
- (A-C road grader)A-C road grader
...
- (An earlier version of Allis-Chalmers electric generator)An earlier version of Allis-Chalmers electric generator
- (A-C Made Steam Generator Turbines being assembled)A-C Made Steam Generator Turbines being assembled
- (A-C Steam Turbine with engine housing removed, 1929)A-C Steam Turbine with engine housing removed, 1929
- (A-C power generator at White River Power Plant, Washington State, 1925)A-C power generator at White River Power Plant, Washington State, 1925
...
- Steam turbines, Allis Chalmers built the steam turbines which powered the USS Coontz DLG-9 (Later DDG-40) and some other ships of the same class used by the United States Navy.
  - (Allis-Chalmers M4 High Speed)Allis-Chalmers M4 High Speed
  - (Allis-Chalmers M6 High-Speed Tractor)Allis-Chalmers M6 High-Speed Tractor
  - (A-C Model HD-15A Bulldozer)A-C Model HD-15A Bulldozer
