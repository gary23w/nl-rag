---
title: "At sign"
source: https://en.wikipedia.org/wiki/%40
domain: a
...
- In Afrikaans, it is called *aapstert*, meaning 'monkey tail', similarly to the Dutch use of the word (*aap* in *apenstaart*, is the word for 'monkey' or 'ape' in Dutch, *stert* comes from the Dutch *staart*).
- In Arabic, it is آتْ (*at*).
- In Armenian, it is շնիկ (*shnik*), which means 'puppy'.
- In Azerbaijani, it is *ət* (pronounced [æt]) which means 'meat', though most likely it is a phonetic transliteration of *at*.
