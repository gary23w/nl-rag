...
source: https://en.wikipedia.org/wiki/Bacillus_(shape)
domain: alistipes
...
Cocci is an English loanword of a modern or Neo-Latin noun, which in turn stems from the Greek masculine noun κόκκος (*cóccos*) meaning 'berry'.
