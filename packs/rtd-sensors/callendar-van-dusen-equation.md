---
title: "Callendar–Van Dusen equation"
source: https://en.wikipedia.org/wiki/Callendar%E2%80%93Van_Dusen_equation
domain: rtd-sensors
...
$R(T)=\left\{{\begin{array}{lr}R(0)[1+A\cdot T+B\cdot T^{2}]&{\text{if }}0^{\circ }{\text{C}}\leq T<661^{\circ }{\text{C}}\\R(0)[1+A\cdot T+B\cdot T^{2}+C\cdot (T-100)T^{3}]&{\text{if }}-200^{\circ }{\text{C}}<T<0^{\circ }{\text{C}}\end{array}}\right.$
