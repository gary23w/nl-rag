---
title: "Fluorescence (part 1/2)"
source: https://en.wikipedia.org/wiki/Fluorescence
...
Fluorescence was observed long before it was named and understood. An early observation of fluorescence was known to the Aztecs and described in 1560 by Bernardino de Sahagún and in 1565 by Nicolás Monardes in the infusion known as *lignum nephriticum* (Latin for "kidney wood"). It was derived from the wood of two tree species, *Pterocarpus indicus* and *Eysenhardtia polystachya*. The chemical compound responsible for this fluorescence is matlaline, which is the oxidation product of one of the flavonoids found in this wood.

In 1819, E.D. Clarke and in 1822 René Just Haüy described some varieties of fluorites that had a different color depending on whether the light was reflected or (apparently) transmitted. Haüy incorrectly viewed the effect as light scattering similar to opalescence. In 1833 Sir David Brewster described a similar effect in chlorophyll which he also considered a form of opalescence. Sir John Herschel studied quinine in 1845 and came to a different incorrect conclusion.
...
, from fluor-spar [i.e., fluorite], as the analogous term
...
When an excited molecule, atom, or nanostructure, emits a photon and the lower energy state (usually the ground state) has the same electronic spin multiplicity as the excited state, the process is called *fluorescence*. When the initial and final states have different multiplicity (spin), the phenomenon is termed *phosphorescence*.

When a molecule in its ground state (called S0) is photoexcited it may end up in any one of a number of excited electronic states (S1, S2, S3,...). It can occupy different vibrational states within the electronic state. These vibrational states are populated in proportion to their overlap with the ground state according to the Franck-Condon principle. These vibrational excited states typically decay rapidly to the ground vibrational state of the excited electronic state S1, followed by radiative transition to the ground state or to vibrational states close to the ground state. This transition is called fluorescence. All of these states are singlet states.
...
where ${k}_{f}$ is the rate constant of spontaneous emission of radiation and
...
where $I_{\parallel }$ is the emitted intensity parallel to the polarization of the excitation light and $I_{\perp }$ is the emitted intensity perpendicular to the polarization of the excitation light.
...
In 2019 it was observed, by chance, that a flying squirrel fluoresced pink under UV light. Subsequent research by biologists at Northland College in Northern Wisconsin found that this is true for all three species of North American flying squirrels. Non-flying squirrels do not fluoresce under UV light. This fluorescence may be an accident of evolution and serve no biological purpose.
...
A rare hybrid within *Nepenthes* (*N. benstonei* x *N. rafflesiana*) which was discovered in 2025 was reported to exhibit vivid green fluorescence on the peristomes of matured pitchers, while more juvenile pitchers exhibited blue fluorescence. Prior to this report, only blue fluorescence had been reported in the genus.

### Abiotic

#### Gemology, mineralogy and geology

In addition to the eponymous fluorspar, many gemstones and minerals may have a distinctive fluorescence or may fluoresce differently under short-wave ultraviolet, long-wave ultraviolet, visible light, or X-rays.
