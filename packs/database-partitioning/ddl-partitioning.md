...
- Manual `VACUUM` and `ANALYZE` commands will automatically process all inheritance child tables. If this is undesirable, you can use the `ONLY` keyword. A command like: will only process the root table.
  ```
...
| Prev | Up | Next |
|---|---|---|
| 5.11. Inheritance | Home | 5.13. Foreign Data |
