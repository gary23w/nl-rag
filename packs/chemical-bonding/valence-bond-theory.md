...
source: https://en.wikipedia.org/wiki/Valence_bond_theory
...
For example, in the case of the F2 molecule, the F−F bond is formed by the overlap of *p**z* orbitals of the two F atoms, each containing an unpaired electron. Since the nature of the overlapping orbitals are different in H2 and F2 molecules, the bond strength and bond lengths differ between H2 and F2 molecules.
...
In an HF molecule the covalent bond is formed by the overlap of the 1*s* orbital of H and the 2*p**z* orbital of F, each containing an unpaired electron. Mutual sharing of electrons between H and F results in a covalent bond in HF.
