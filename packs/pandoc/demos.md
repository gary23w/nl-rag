...
You can try pandoc in your browser at https://pandoc.org/app.
...
18. Syntax highlighting of delimited code blocks:
  ```
pandoc code.text -s --syntax-highlighting pygments -o example18a.html
  ```
  ```
pandoc code.text -s --syntax-highlighting kate -o example18b.html
  ```
  ```
pandoc code.text -s --syntax-highlighting monochrome -o example18c.html
  ```
  ```
pandoc code.text -s --syntax-highlighting espresso -o example18d.html
  ```
  ```
pandoc code.text -s --syntax-highlighting haddock -o example18e.html
  ```
  ```
pandoc code.text -s --syntax-highlighting tango -o example18f.html
  ```
  ```
pandoc code.text -s --syntax-highlighting zenburn -o example18g.html
  ```
19. GNU Texinfo:
  ```
