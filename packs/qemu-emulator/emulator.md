...
- writing to and reading from physical memory, by means of two procedures similar to the ones dealing with logical memory (although, unlike the latter, the former *can* often be left out, and direct references to the memory array be employed instead)
