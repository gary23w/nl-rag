...
Learn how to install the k6 CLI, run your first k6 test, and view metric results in the terminal.

Using k6

Learn about k6 options and concepts such as thresholds, metrics, lifecycle hooks, and more.

Testing guides

Discover how to plan and define your performance testing strategy with these guides.

k6 JavaScript API

Explore the k6 APIs through their documentation and examples.

Explore k6 extensions

Have a particular testing need? Find k6 extensions that extend the native k6 functionality.

k6 script examples

Learn how to write test scripts with this list of common k6 examples.

Grafana Cloud k6

Leverage the k6 OSS capabilities in Grafana Cloud, with built-in dashboards, insights into your application performance, and the ability to bring together teams in one place to resolve issues faster.

k6 Studio

Use the k6 Studio desktop application to quickly generate test scripts using a visual interface.
