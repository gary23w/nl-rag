---
title: "Variables"
source: https://dart.dev/language/variables
domain: dart
license: CC-BY-4.0
...
- Local variable declaration.dart`main() { var _ = 1; int _ = 2; }`
- For loop variable declaration.dart`for (var _ in list) {}`
- Catch clause parameters.dart`try { throw '!'; } catch (_) { print('oops'); }`
- Generic type and function type parameters.dart`class T<_> {} void genericFunction<_>() {}  takeGenericCallback(<_>() => true);`
- Function parameters.dart`Foo(_, this._, super._, void _()) {}  list.where((_) => true);  void f(void g(int _, bool _)) {}  typedef T = void Function(String _, String _);`
