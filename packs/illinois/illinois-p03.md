...
Illinois is home to the headquarters of over 32 Fortune 500 companies and 14 Global 500 companies. They include Abbott, Abbvie, Ace Hardware, Allstate, Archer Daniels Midland, Baxter International,CDW, Discover Financial, Exelon, GE Healthcare, Grainger, John Deere, Kraft Heinz, McDonald's, Motorola Solutions, Mondelez International, State Farm, Ulta Beauty, United Airlines, and Walgreens. Until 2022, Illinois was also home to the headquarters of Boeing, Caterpillar, and Tyson Foods.
...
The Chicago metropolitan area also hosts two zoos: The Brookfield Zoo, located about ten miles west of the city center in suburban Brookfield, contains more than 2,300 animals and covers 216 acres (87 ha). Lincoln Park Zoo is located in Lincoln Park on Chicago's North Side, approximately 3 miles (4.8 km) north of the Loop. The zoo, including Nature Boardwalk, occupies 49 acres (20 ha) of the park.

- Illinois Museums
- (Vandalia State House State Historic Site in Vandalia)Vandalia State House State Historic Site in Vandalia
- (The Museum of Science and Industry in Chicago)The Museum of Science and Industry in Chicago
- (Magnolia Manor is a Victorian period historic house museum in Cairo.)Magnolia Manor is a Victorian period historic house museum in Cairo.
- (Lincoln Home National Historic Site in Springfield)Lincoln Home National Historic Site in Springfield
- (The Polish Museum of America in Chicago)The Polish Museum of America in Chicago
- (A Railway Post Office preserved at the Illinois Railway Museum in Union)A Railway Post Office preserved at the Illinois Railway Museum in Union
...
| Local transit map |
|---|
| (Illinois is located in Illinois)(Beloit Transit)**Beloit Transit**(C-CARTS)**C-CARTS**(MTD)**MTD**(Chicago Transit Authority)**Chicago Transit Authority**(Coles County Zipline)**Coles County Zipline**(Connect Transit)**Connect Transit**(DMT)**DMT**(DPTS)**DPTS**(DeKalb Public Transit)**DeKalb Public Transit**(Galesburg Transit)**Galesburg Transit**(Go West Transit)**Go West Transit**(CityLink)**CityLink**(JCMTD)**JCMTD**(Saluki Express)**Saluki Express**(RMTD)**RMTD**(Madison County Transit)**Madison County Transit**(MetroLINK)**MetroLINK**(Pace)**Pace**(Quincy Transit Lines)**Quincy Transit Lines**(River Valley Metro)**River Valley Metro**(RMTD)**RMTD**(SCCTD)**SCCTD**(SMTD)**SMTD**(SHOW Bus)**SHOW Bus**(South Central Transit)**South Central Transit**(MRTD)**MRTD**(RMTD)**RMTD**(SHOW Bus)**SHOW Bus** Local Transit Systems (Only systems with fixed-route services are shown) |
