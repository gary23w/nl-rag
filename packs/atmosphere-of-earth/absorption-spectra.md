...
source: https://en.wikipedia.org/wiki/Absorption_spectra
...
The specificity also allows unknown samples to be identified by comparing a measured spectrum with a library of reference spectra. In many cases, qualitative information about a sample can be determined even if it is not in a library. Infrared spectra, for instance, have characteristic absorption bands that indicate if carbon-hydrogen or carbon-oxygen bonds are present.
