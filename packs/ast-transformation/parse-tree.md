...
A form of parse tree was in use as early as 1879 in Gottlob Frege's *Begriffsschrift* book.
...
For binary trees (where each parent node has two immediate child nodes), the number of possible parse trees for a sentence with *n* words is given by the Catalan number $C_{n}$ .
...
$[_{S}\ [_{\mathit {N}}\ {\text{John}}]\ [_{\mathit {VP}}\ [_{V}\ {\text{hit}}]\ [_{\mathit {NP}}\ [_{\mathit {D}}\ {\text{the}}]\ [_{N}\ {\text{ball}}]]]]$
