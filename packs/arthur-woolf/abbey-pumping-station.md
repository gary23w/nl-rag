...
source: https://en.wikipedia.org/wiki/Abbey_Pumping_Station
domain: arthur-woolf
...
- (Building viewed from Northeast)Building viewed from Northeast
- (Abbey Pumping Station entrance)Abbey Pumping Station entrance
- (One of the educational displays)One of the educational displays
- (Beam engines)Beam engines
