...
$E=E_{ex}+E_{D}+E_{\lambda }+E_{k}+E_{H}\,$
...
Magneto-optical images of different domain structures

Domain structure of a

shape-memory alloy

(recorded using CMOS-MagView)

Domain structure of an exemplary meander domain (recorded using CMOS-MagView)

Domain structure of an exemplary magnetic bubble domain (recorded using CMOS-MagView)
