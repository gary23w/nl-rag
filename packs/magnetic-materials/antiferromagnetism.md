...
source: https://en.wikipedia.org/wiki/Antiferromagnetism
...
**Antiferromagnetism** is a type of magnetic ordering, along with ferromagnetism and ferrimagnetism. In antiferromagnets the individual magnetic dipoles are oriented in a way such that the bulk of the material has a vanishing total magnetization. In the simplest model, as shown in the picture on the right, neighboring moments in an ordered lattice are oriented antiparallel to one another. Since there are multiple ways of arranging magnetic moments on a lattice (especially in three dimensions), there exist various types of antiferromagnetic ordering. The phenomenon of antiferromagnetism was first described by Lev Landau in 1933.
...
Antiferromagnetism plays a crucial role in devices employing giant magnetoresistance (GMR), an effect discovered in 1988 by the Nobel Prize winners Albert Fert and Peter Grünberg (awarded in 2007). First, for antiferromagnets being employed as pinning layers and also since the original device design (iron-chromium-iron multilayer with the Cr layer thickness carefully tuned) amounts to a synthetic antiferromagnet.
