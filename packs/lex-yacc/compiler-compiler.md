...
An analogy can be drawn: That as a *C++* compiler takes as input a *C++* programming language program, a *meta*compiler takes as input a *meta*programming metalanguage program.
