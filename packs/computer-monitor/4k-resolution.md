---
title: "4K resolution"
source: https://en.wikipedia.org/wiki/4K_resolution
...
**4K resolution** is a horizontal display resolution of approximately 4,000 pixels. For digital cinematography, it is 4096 × 2160 (DCI 4K), typically with a 256:135 (1.9:1) aspect ratio; for digital television, it is 3840 × 2160 (4K UHD), typically with a 16:9 (1.78:1) aspect ratio.
...
This resolution is used mainly in digital cinema production, and has a total of 8,847,360 pixels with an aspect ratio of 256∶135 (≈19∶10). It was standardized as the resolution of the 4K container format defined by Digital Cinema Initiatives in the Digital Cinema System specification, and is the native resolution of all DCI-compliant 4K digital projectors and monitors. The DCI specification allows several different resolutions for the content inside the container, depending on the desired aspect ratio. The allowed resolutions are defined in SMPTE 428-1:
