...
source: https://en.wikipedia.org/wiki/Voltage-controlled_oscillator
...
- $f_{0}$ is the quiescent frequency of the oscillator (not the waveform amplitude)
- $K_{0}$ is called the oscillator sensitivity, or gain. Its units are hertz per volt.
