...
source: https://en.wikipedia.org/wiki/Asynchronous_circuit
...
When implemented in gallium arsenide (HGaAs 3) it was claimed to achieve 100MIPS. Overall, the research paper interpreted the resultant performance of CAM as superior compared to commercial alternatives available at the time.
...
Performance comparison of the Caltech CPUs (in
