...
source: https://en.wikipedia.org/wiki/Symplectic_geometry
...
Unlike in the Riemannian case, symplectic manifolds have no local invariants such as curvature. This is a consequence of Darboux's theorem which states that a neighborhood of any point of a 2*n*-dimensional symplectic manifold is isomorphic to the standard symplectic structure on an open set of $\mathbb {R} ^{2n}$ .
