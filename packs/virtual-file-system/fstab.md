...
See the swapon(8) man page for details about swap area fstab
configuration.
...
representation of the UUID should be based on lowercase
characters. But when specifying the volume ID of FAT or NTFS
filesystems uppercase characters are used (e.g UUID="A40D-85E7" or
