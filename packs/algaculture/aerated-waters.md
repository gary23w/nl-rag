...
source: https://en.wikipedia.org/wiki/Aerated_waters
domain: algaculture
...
One of the drawbacks to fine bubble aeration is that the membranes of ceramic diffusers can sometimes clog and must be cleaned in order to keep them working at their optimum efficiency. Also, they do not possess the ability to mix the water column as well as other aeration techniques, such as coarse bubble aeration.
