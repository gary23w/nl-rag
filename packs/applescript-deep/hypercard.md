---
title: "HyperCard"
source: https://en.wikipedia.org/wiki/HyperCard
...
Atkinson said in 1987 that the odds a non-Macintosh software product would clone HyperCard were "99 percent", and hoped that they would be data compatible with HyperCard. In 2017 he said of iBooks Author, "I think it's the closest thing we have today to what HyperCard was", but with superior video and distribution tools. As of 2024, two products are available which offer HyperCard-like abilities:

- HyperStudio, one of the first HyperCard clones, is as of 2009, developed and published by Software MacKiev.
...
- IBM LinkWay is a mouse-controlled HyperCard-like environment for MS-DOS. It has minimal system requirements, runs in graphics CGA and VGA. It even supported video disc control.
...
Zoomracks, an application for the Atari ST and IBM PC compatibles with a similar "stack" database metaphor, predates HyperCard by four years, which led to a contentious lawsuit against Apple.
