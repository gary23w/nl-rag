...
- (MEM rewirable fuse box with four rewirable fuse holders (two 30 A and two 15 A) installed c. 1957 (cover removed)) MEM rewirable fuse box with four rewirable fuse holders (two 30 A and two 15 A) installed c. 1957 (cover removed)
- (MEM rewirable fuse holders (30 A and 15 A)) MEM rewirable fuse holders (30 A and 15 A)
- (Wylex standard fuse box with eight rewirable fuse holders) Wylex standard fuse box with eight rewirable fuse holders
- (Fuse wire as sold to UK consumers) Fuse wire as sold to UK consumers
...
- (Edison base (left) and Type S fuses (right)) Edison base (left) and Type S fuses (right)
- (An older fuse box of the type used in North America) An older fuse box of the type used in North America
