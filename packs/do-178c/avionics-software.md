...
source: https://en.wikipedia.org/wiki/Avionics_software
domain: do-178c
...
Next, the most important features of the software are integrated. At this stage, it is often beneficial for the integrators to have a way to run small, selected pieces of code, perhaps from a simple menu system.
