...
source: https://en.wikipedia.org/wiki/ASME_Boiler_and_Pressure_Vessel_Code
domain: american-society-of-mechanical-engineers
license: CC-BY-SA-4.0
tags: american society of mechanical engineers
fetched: 2026-07-03
---

# ASME Boiler and Pressure Vessel Code

The **ASME Boiler and Pressure Vessel Code (BPVC)** is a set of standards published by the American Society of Mechanical Engineers (ASME) that provides rules for the design, fabrication, inspection, testing, and certification of boilers and pressure vessels.

The BPVC is developed and updated through a consensus process managed by ASME committees, with participation from volunteer technical experts representing industry, regulators, and other stakeholders.

ASME also operates a conformity assessment and certification system under which accredited organizations—including manufacturers and authorized inspection agencies—may apply ASME Code Symbol Stamps to equipment that meets BPVC requirements.
...
Addenda, which include additions and revisions to the individual Sections of the Code, are issued accordingly for a particular edition of the code up until the next edition. Addenda is no longer in use since Code Edition 2013. It has been replaced by two years edition period.
...
**Section IX – Welding, Brazing, and Fusing Qualifications** establishes the qualification requirements for welding, brazing, and plastic fusing procedures and for the personnel performing these joining processes. Unlike most sections of the ASME Boiler and Pressure Vessel Code (BPVC), which prescribe fabrication requirements directly or specify design, inspection, and testing for components like boilers and pressure vessels, Section IX is primarily a referencing code. Its qualification requirements are not invoked independently but are instead called upon by other ASME construction codes (such as Section VIII for pressure vessels or B31 for piping).

### History

Prior to the introduction of Section IX, individual sections of the BPVC contained their own separate and varying qualification requirements for welded construction. Following the formal acceptance of welding for pressure-retaining components in the 1935 edition of the Code (where it was initially introduced as a supplement to Section VIII), a joint committee of the American Society of Mechanical Engineers (ASME) and the American Welding Society (AWS) was established to develop a unified qualification standard.

Section IX was first published as a standalone section of the BPVC in 1941, initially covering only three welding processes: Shielded Metal Arc Welding (SMAW), Oxy-Fuel Welding (OFW), and Carbon-Arc Welding (CAW). The fundamental philosophy of qualifying procedures and personnel while permitting qualified ranges of variables has remained largely unchanged since this first edition. Although additional joining processes and qualification rules have been incorporated over time to keep pace with industrial technology, the core mechanics of the code have remained highly stable.

The scope of Section IX has expanded periodically over its history. Brazing qualifications were incorporated in the 1960 edition, turning it into the "Welding and Brazing Qualifications" standard. The 2013 edition introduced qualification requirements for plastic fusing, along with a common set of general requirements applicable to all material-joining processes.

### Core Concepts and Methodology

For welding, Section IX establishes requirements for qualifying Welding Procedure Specifications (WPSs) by means of Procedure Qualification Records (PQRs) and for qualifying welders and welding operators through performance qualification tests. Similar qualification systems are provided for brazing procedures and brazers, and for plastic fusing procedures and operators.

A fundamental concept of Section IX is the classification of qualification variables as essential, supplementary essential, and nonessential variables:

- **Essential variables** are those that may affect the mechanical properties or soundness of a joint and generally require complete requalification when changed.
- **Supplementary essential variables** apply when notch toughness requirements are specified by the referencing construction code.
- **Nonessential variables** may be changed on a shop floor without requiring requalification, provided the Welding Procedure Specification is revised accordingly.

To reduce the administrative and economic burden of procedure qualifications, Section IX groups base materials into P-Numbers and welding filler metals into F-Numbers. Qualification of a procedure using one material or filler metal may therefore extend to other materials or filler metals within the same classification, subject to the qualification rules of the Code.

### Internal Structure

Since the 2013 edition, Section IX has been organized into a modular structure consisting of four principal Parts:

- **Part QG** – General Requirements (universal rules applicable to all joining types)
- **Part QW** – Welding (Articles I through V)
- **Part QB** – Brazing (Articles XI through XIV)
- **Part QF** – Plastic Fusing (Articles XXI through XXIV)

Within Part QW, Article V is unique because it permits manufacturers and contractors to use prequalified Standard Welding Procedure Specifications (SWPSs) that have been developed by the American Welding Society (AWS) and formally adopted by ASME, bypassing the typical requirement for an organization to perform its own independent Procedure Qualification Record (PQR) testing.

### Global Significance

Section IX is referenced by numerous ASME construction codes, including those governing boilers, pressure vessels, and pressure piping. Because of its rigorous framework and historical reliability, it is widely used internationally as the definitive qualification standard for joining procedures and personnel in pressure equipment fabrication, even in countries that do not otherwise utilize the ASME construction codes. Within ISO-based manufacturing systems, it serves a functionally parallel purpose to the ISO 15614 series (for procedure qualification) and the ISO 9606 series (for personnel qualification).
