...
|---|---|---|---|
| Latest commit History1,637 Commits1,637 Commits |   |   |   |
| .github | .github |   |   |
| .vib | .vib |   |   |
| carvel | carvel |   |   |
| cmd | cmd |   |   |
| contrib/prometheus-mixin | contrib/prometheus-mixin |   |   |
| docker | docker |   |   |
| docs | docs |   |   |
| githooks/pre-commit | githooks/pre-commit |   |   |
| hack | hack |   |   |
| helm/sealed-secrets | helm/sealed-secrets |   |   |
| integration | integration |   |   |
| pkg | pkg |   |   |
| scripts | scripts |   |   |
| site | site |   |   |
| vendor_jsonnet/kube-libsonnet | vendor_jsonnet/kube-libsonnet |   |   |
...
| controller-norbac.jsonnet | controller-norbac.jsonnet |   |   |
| controller-podmonitor.jsonnet | controller-podmonitor.jsonnet |   |   |
| controller.jsonnet | controller.jsonnet |   |   |
| go.mod | go.mod |   |   |
| go.sum | go.sum |   |   |
| jsonnetfile.json | jsonnetfile.json |   |   |
| jsonnetfile.lock.json | jsonnetfile.lock.json |   |   |
| kube-fixes.libsonnet | kube-fixes.libsonnet |   |   |
| schema-v1alpha1.yaml | schema-v1alpha1.yaml |   |   |
...
The `kubeseal` client is also available on Nixpkgs: (**DISCLAIMER**: Not maintained by bitnami)
...
- For Helm deployment: kubectl apply -f main.key kubectl delete pod -n kube-system -l app.kubernetes.io/name=sealed-secrets
- For deployment via `controller.yaml` manifest kubectl apply -f main.key kubectl delete pod -n kube-system -l name=sealed-secrets-controller
...
- `kseal` A Kubeseal Companion: https://github.com/eznix86/kseal
- `kubeseal-convert`: https://github.com/EladLeev/kubeseal-convert
