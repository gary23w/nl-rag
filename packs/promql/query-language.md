...
- JPQL is a query language defined as part of Jakarta Persistence (used in Java applications to make queries to a relational DB using entity objects instead of DB tables).
...
- KQL (Kusto Query Language), a query language by Microsoft used in Azure Data Explorer
