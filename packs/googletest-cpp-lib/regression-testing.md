...
This technique checks all the test cases on the current program to check its integrity. Though it is expensive as it needs to re-run all the test cases, it ensures that there are no errors because of the modified code.
