---
title: "Airspeed"
source: https://en.wikipedia.org/wiki/Airspeed
...
$V_{c}=a_{0}{\sqrt {{\bigg (}{\frac {2}{\gamma -1}}{\bigg )}{\Bigg [}{\bigg (}{\frac {q_{c}}{p_{0}}}+1{\bigg )}^{\frac {\gamma -1}{\gamma }}-1{\Bigg ]}}}$ minus position and installation error correction.
...
$V=V_{c}{\sqrt {\theta {\frac {(1+q_{c}/p)^{(\gamma -1)/\gamma }-1}{(1+q_{c}/p_{0})^{(\gamma -1)/\gamma }-1}}}}$
...
${\frac {1}{2}}\rho _{0}{V_{e}}^{2}={\frac {1}{2}}\rho V^{2}$
...
at the altitude at which the aircraft is currently flying;

$\rho _{0}\,$

is the density of air at sea level in the International Standard Atmosphere (1.225 kg/m
