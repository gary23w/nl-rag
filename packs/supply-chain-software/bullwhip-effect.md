...
Research on supply-chain complexity has identified additional mechanisms through which variability may propagate through supply networks. The "supply chain complexity triangle" describes uncertainty as arising from the interaction of demand amplification, deterministic chaos, and parallel interactions between supply-chain channels. In addition to demand amplification, the framework highlights how disturbances may spread through interconnected channels and nonlinear feedback processes within the supply chain. The causes can further be divided into behavioral and operational causes.

### Behavioral causes

The first theories focusing onto the bullwhip effect were mainly focusing on the irrational behavior of the human in the supply chain, highlighting them as the main cause of the bullwhip effect. Since the 90's, the studies evolved, placing the supply chain's malfunctioning at the heart of their studies abandoning the human factors.
...
Some other behavioral causes can be highlighted:
...
- **Rationing and gaming** is when a retailer limits order quantities by providing only a percentage of the order, but the buyer acts on this knowledge by placing larger orders in hopes of getting closer to the actual desired quantity. Rationing and gaming generate inconsistencies in the ordering information that is being received, and may feed into the bullwhip effect.
...
Since the Corona virus pandemic, many companies have been dealing with a strong bullwhip effect. This problem is directly linked to the ongoing impacts of the Corona virus pandemic, even though it is further exacerbated by the ever changing nature of demand for consumer goods . For instance, during the pandemic many companies were over-buying to meet rising consumer demand as consumers were also panic-buying and stocking up to meet up with perceived future lockdown demands, but due to container and harbor shortages which is very important for logistics, a lot of these products were backed up.

These shortages caused companies to order even more as they reasoned this would give them a larger share of the pie. As lead times return to normal, however, all these products are finally flowing in but demand drops for these same products leading to large excess inventory. In other words, retailers or customers order more based on slight sales increases or increases in demand, which causes each entity in the supply chain to request or produce more in anticipation of higher demands, at the end creating a ripple effect in the supply and logistics chain.

For instance, during the pandemic, people suddenly bought lots of essential and safety-related goods like nose masks, hand sanitizers, causing big fluctuations in demand. As each level in the supply chain reacted to these extra demands, they tended to over-order to prevent stockouts, which made the problem worse down to the manufacturer. This led to excessive investment in inventory, lost revenue, declines in customer service, delayed schedules, and even layoffs or bankruptcies and global freight services delivery delays as was the case for e-commerce platforms like Amazon and Alibaba. During the COVID-19 pandemic, they faced global shipping delays, increased freight costs, and lead-time uncertainties.

When shipping and production are delayed, downstream partners, retailers and consumers often order more just in case, thereby further enhancing the ripple effects of the bullwhip effect.
...
Many studies demonstrate the bullwhip effect in a supply chain from different perspectives, including information sharing, information distortion, bankruptcy events and systematic risk. Most of them devote themselves to exploring the bullwhip effect from the perspectives of inventory flow risk and information flow risk rather than that of cash flow risk. For a firm's internal liquidity risk (Chen et al., 2011), it is an appropriate proxy for a firm's financial risk.
...
This is more generally modelled in Proselkov's work in 2023, which uses complex adaptive systems modelling to study cascade failures as a consequence of financial bullwhips. Specifically, they create an agent-based supply network simulation model capturing the behaviours of companies with asymmetric power dynamics with their partners. To remain operational, they maximise their liquidity by negotiating longer repayment terms and cheaper financing, thus distributing risk onto weaker companies and propagating financial stress. This results in network-wide breakdown.
