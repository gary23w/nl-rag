---
title: "Ars Technica"
source: https://en.wikipedia.org/wiki/Ars_Technica
...
Since 2024, Condé Nast, *Ars Technica*'s parent company, has entered a bilateral deal with OpenAI. The terms of this deal have not been publicly disclosed, but *The Guardian* reported that it is more than just access to Condé Nast publications and extends to the usage of AI in the news cycle to "ensure that as AI plays a larger role in news discovery and delivery, it maintains accuracy, integrity and respect for quality reporting".
