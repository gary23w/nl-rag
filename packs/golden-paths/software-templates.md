...
source: https://backstage.io/docs/features/software-templates/
domain: golden-paths
...
There could be situations where you would like to disable the `Register Existing Component` button for your users.
