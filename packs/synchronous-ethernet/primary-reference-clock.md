---
title: "Master clock"
source: https://en.wikipedia.org/wiki/Primary_reference_clock
...
Diagram of electric time system used around 1910 to keep time in factories, schools, and other large institutions. The master clock

(bottom centre)

, controlled by a temperature-compensated mercury pendulum, is wired to

slave clocks

throughout the building. In addition to wall clocks, it also controls time stamps that are used to stamp documents with the time and a turret clock used in a clock tower. The

program clock

is a timer that can be programmed with punched paper tape to ring bells or turn machines on and off at preprogrammed times.
