---
title: "Nanowire"
source: https://en.wikipedia.org/wiki/Nanowire
...
Molecular nanowires are composed of repeating molecular units either organic (e.g. DNA) or inorganic (e.g. Mo6S9−*x*I*x*).
...
This conductance is twice the reciprocal of the resistance unit called the von Klitzing constant, *R*K = 25812.80745... Ω, defined as *R*K = *h*/*e*2 and named for Klaus von Klitzing, the discoverer of the integer quantum Hall effect.
...
A single-step vapour phase reaction at elevated temperature synthesises inorganic nanowires such as Mo6S9−*x*I*x*. From another point of view, such nanowires are cluster polymers.
