...
source: https://en.wikipedia.org/wiki/Algebraic_structure
...
with respect to another operation
...
has an identity element if there is an element
...
in the structure. Here, the auxiliary operation is the operation of arity zero that has
