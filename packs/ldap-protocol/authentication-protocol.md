...
source: https://en.wikipedia.org/wiki/Authentication_protocol
...
Remote Authentication Dial-In User Service (RADIUS) is a full AAA protocol commonly used by Internet service providers. Credentials are mostly username-password combination based, and it uses NAS and UDP protocol for transport.
