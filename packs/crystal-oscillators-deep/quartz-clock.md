...
A cantilever made of quartz ( E = 1011 N/m2 = 100 GPa = 15 million psi; $\rho$ = 2.625 g/cm3 = 0.0948 lb/cu in), with a length of 3 mm (0.12 in) and a thickness of 0.3 mm (0.012 in), thus has a fundamental frequency around 33 kHz. The crystal is tuned to exactly 215 = 32768 Hz, or runs at a slightly higher frequency with inhibition compensation (see below).
...
Ships Marine Chronometer

giving an accuracy better than ± 5 seconds per year, French Navy issued

Citizen analog-digital

chronograph

with 4 area radio time signal reception (North America, Europe, China, Japan) and radio-controlled synchronization
