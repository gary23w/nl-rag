---
title: "Cartogram"
source: https://en.wikipedia.org/wiki/Cartogram
domain: cartograms
...
- **Circles** (Dorling), typically brought together to be touching and arranged to retain some semblance of the overall shape of the original space. These often look like proportional symbol maps, and some consider them to be a hybrid between the two types of thematic map.
