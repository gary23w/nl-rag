...
- Torvalds' "*Boot-Root*" images, from v0.95a onwards "*Root*" was maintained by Jim Winstead Jr., the aforementioned disk image pair with the kernel and the absolute minimal tools to get started (0.10: 4 November 1991)
- MCC Interim Linux (3 March 1992)
- TAMU Linux, based on MCC with simpler installation and X11 (14 July 1992)
...
Some distributions let the user install Linux on top of their current system, such as coLinux. Linux is installed to the Windows hard disk partition, and can be started from inside Windows itself.
...
Statcounter, a web traffic analysis company, within the *operating system market share*, showed that the Linux operating systems had, according to them, 3.9% of the worldwide market share in July 2025.
