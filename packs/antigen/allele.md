...
is an inherited trait influenced by
...
. The interaction of multiple genes—and the variation in these genes ("alleles") between individuals—help to determine a person's eye color

phenotype

. Eye color is influenced by
...
and the frequency-dependence of the light
