...
source: https://en.wikipedia.org/wiki/2000s_energy_crisis
domain: jet-fuel
...
Detailed analysis of changes in oil price from 1970–2007. The graph is based on the
...
Although swift continued growth in China is often predicted, others predict that China's export-dominated economy will not continue such growth trends due to wage and price inflation and reduced demand from the US. India's oil imports are expected to more than triple from 2005 levels by 2020, rising to 5 million barrels per day (790×10^3 m3/d).
...
In their December meeting, OPEC members agreed to reduce their production by 2.2 million barrels (350,000 m3) per day, and said their resolution to reduce production in October had an 85% compliance rate.
