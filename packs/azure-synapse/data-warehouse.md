...
| Attribute | Data warehouse | Database |
|---|---|---|
| Data type | historical | operational |
| Format of the data | highly structured | structured |
| Purpose | OLAP | OLTP |
| Volume of data stored | larger | limited |
...
|---|---|---|
| Format of the data | structure | structure, semi or unstructured |
| How is data processed | cleaned, transformed, stored | raw form and processed when needed |
| How difficult to build | complex | easy but hard to govern |
| Volume of data stored | larger | very large |
