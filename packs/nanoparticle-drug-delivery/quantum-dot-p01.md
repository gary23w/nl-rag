...
The formation of quantum dots can be spontaneous when a semiconductor material is deposited on a substrate and a difference in lattice space exists between them.
...
The previous property allows to record the current flow as the number of electrons on the dot, this implies that the energy variates.
...
### Quantum dot anodes for batteries

#### Improvement in batteries

Improvements can be seen in the electrical conductivity and charge retention of batteries when QDs are added to anodes.
