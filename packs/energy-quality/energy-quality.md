...
source: https://en.wikipedia.org/wiki/Energy_quality
...
Ohta therefore also included, 'abundance in nature' as another criterion for the determination energy quality rank. For example, Ohta said that, "the only electrical energy which exists in natural circumstances is lightning, while many mechanical energies exist." (See also table 1. in Wall's article for another example ranking of energy quality).
