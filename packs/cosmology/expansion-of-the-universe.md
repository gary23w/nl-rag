...
source: https://en.wikipedia.org/wiki/Expansion_of_the_universe
domain: cosmology
...
where the Hubble constant $H_{0}$ quantifies the rate of expansion today.

While the expansion in space is uniform, it is not uniform across long time intervals: the rate of expansion varies with time and this variation is a central object of study in cosmology. Using cosmic time with $t_{0}$ indicating the present, the Hubble constant, $H_{0}=H(t=t_{0})$ , is the present day value of the Hubble parameter, $H(t)$ , describing the dynamics of expansion.
