---
title: "HashiCorp"
source: https://en.wikipedia.org/wiki/HashiCorp
...
HashiCorp is headquartered in San Francisco, but its employees are distributed across the United States, Canada, Australia, India, and Europe. HashiCorp offers source-available libraries and other proprietary products.
...
- Packer (first released in June 2013): a tool for building virtual-machine images for later deployment.
...
- Vault Radar (first released in April 2025): Discover, copy and secure secrets discovered in Git-supported repositories and collaboration platforms directly into HashiCorp Vault
