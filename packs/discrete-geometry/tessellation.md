---
title: "Tessellation"
source: https://en.wikipedia.org/wiki/Tessellation
...
, forming edge‑to‑edge, regular and other tessellations
...
- (Triangular tiling, one of the three regular tilings of the plane) Triangular tiling, one of the three regular tilings of the plane
- (Snub hexagonal tiling, a semiregular tiling of the plane) Snub hexagonal tiling, a semiregular tiling of the plane
- (Floret pentagonal tiling, dual to a semiregular tiling and one of 15 monohedral pentagon tilings) Floret pentagonal tiling, dual to a semiregular tiling and one of 15 monohedral pentagon tilings
- (All tiling elements are identical pseudo‑triangles by disregarding their colors and ornaments) All tiling elements are identical pseudo‑triangles by disregarding their colors and ornaments
- (The Voderberg tiling, a spiral, monohedral tiling made of enneagons) The Voderberg tiling, a spiral, monohedral tiling made of enneagons
- (Alternated octagonal or tritetragonal tiling is a uniform tiling of the hyperbolic plane) Alternated octagonal or tritetragonal tiling is a uniform tiling of the hyperbolic plane
- (Topological square tiling, isohedrally distorted into I shapes) Topological square tiling, isohedrally distorted into I shapes
