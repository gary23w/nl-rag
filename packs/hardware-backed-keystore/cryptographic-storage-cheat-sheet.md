...
domain: hardware-backed-keystore
license: CC-BY-SA-4.0
tags: hardware backed keystore, secure key storage element, trusted platform module keystore, non exportable private key
fetched: 2026-07-02
---
...
| PHP | `array_rand()`, `lcg_value()`, `mt_rand()`, `rand()`, `uniqid()` | random_bytes(), Random\Engine\Secure in PHP 8, random_int() in PHP 7, openssl_random_pseudo_bytes() in PHP 5 |
