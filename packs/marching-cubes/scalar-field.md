---
title: "Scalar field"
source: https://en.wikipedia.org/wiki/Scalar_field
...
- Vector fields, which associate a vector to every point in space. Some examples of vector fields include the air flow (wind) in meteorology.
