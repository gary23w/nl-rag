---
title: "Rebol"
source: https://en.wikipedia.org/wiki/Rebol
domain: rebol-red
...
3. *Rebol 3* [R3], the newest version of the interpreter, had alpha versions released by REBOL Technologies since January 2008. Since its release as an Apache 2 project in December 2012, it is being developed by the Rebol community.
...
| Visual interface dialect (VID) or RebGUI | `layout` function or `display` function | specifies graphical user interface |
