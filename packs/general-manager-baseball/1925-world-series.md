...
source: https://en.wikipedia.org/wiki/1925_World_Series
...
In Game 2, Joe Judge's second inning home run off Vic Aldridge gave the Senators a 1–0 lead, but the Pirates tied the game in the fourth on Glenn Wright's home run in the fourth off Stan Coveleski. In the eighth, Kiki Cuyler's two-run home run in the eighth following a Roger Peckinpaugh error that let Eddie Moore reached first put the Pirates up 3–1. In the ninth, the Senators loaded the bases with no outs on two walks and a single, but scored only once on Bobby Veach's sacrifice fly as Aldridge retired the next two batters and the Pirates tied the series heading to Washington.

### Game 3

October 10, 1925 2:00
