...
source: https://en.wikipedia.org/wiki/Windows_Presentation_Foundation
domain: wpf-xaml
...
namespace WpfExample
{
    public partial class MainWindow : Window
    {
        ...
        {
            string name = this.NameInputTextBox.Text;
