...
In a scientific notion, the relative humidity ( $RH$ or $\phi$ ) of an air-water mixture is defined as the ratio of the partial pressure of water vapor ( p ) in air to the saturation vapor pressure ( $p_{s}$ ) of water at the same temperature, usually expressed as a percentage: $\phi =100\%\cdot p/p_{s}$
...
A device used to measure humidity of air is called a psychrometer or hygrometer (not to be confused with Hydrometer). A humidistat is a humidity-triggered switch, often used to control a humidifier or a dehumidifier.
...
The enhancement factor $(f_{w})$ is defined as the ratio of the saturated vapor pressure of water in moist air $(e'_{w})$ to the saturated vapor pressure of pure water: $f_{W}={\frac {e'_{w}}{e_{w}^{*}}}.$
...
Some people experience difficulty breathing in humid environments. Some cases are related to respiratory conditions such as asthma, where humidity as low as 50% was shown to meaningfully increase risks for dyspnea, cough and exercise induced bronchoconstriction. Other cases may be the product of anxiety. Affected people will often hyperventilate in response, causing sensations of numbness, faintness, and loss of concentration, among others.
...
High humidity may adversely impact people with asthma, where humidity as low as 50% was shown to meaningfully increase risks for dyspnea, cough and exercise induced bronchoconstriction. Exercise induced symptoms pose a significant challenge, while physical exercise and weight loss (to normal) are important parts in management.
...
A device used to measure humidity is called a hygrometer (not to be confused with Hydrometer); one used to regulate it is called a humidistat, or sometimes hygrostat. These are analogous to a thermometer and thermostat for temperature, respectively.
