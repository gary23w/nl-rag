---
title: "WebAssembly concepts - WebAssembly"
...
WebAssembly is an open standard developed inside the W3C WebAssembly Community Group with the following goals:
...
**Note:** Though WebAssembly was originally designed for the web, it has many uses outside browsers and JavaScript environments (see Non-web embeddings).
