---
title: "Affix"
source: https://en.wikipedia.org/wiki/Affix
...
| **Infix** (see also tmesis) | edu⟨ma⟩cated | st⟨infix⟩em | Appears within a stem — common e.g. in Austronesian languages |
...
| **Suprafix** | *pro*duce (noun) pro*duce* (verb) | stem\suprafix | Changes a suprasegmental feature of a stem |
