---
title: "Bacteriophage"
source: https://en.wikipedia.org/wiki/Bacteriophage
domain: virology
...
Bacteriophages are among the most common and diverse entities in the biosphere. Bacteriophages are ubiquitous viruses, found wherever bacteria exist. It is estimated there are more than 1031 bacteriophages on the planet, more than every living organism on Earth, including bacteria, combined. Viruses are the most abundant biological entity in the water column of the world's oceans, and the second largest component of biomass after prokaryotes, where up to 9×108 virions per millilitre have been found in microbial mats at the surface, and up to 70% of marine bacteria may be infected by bacteriophages.

Bacteriophages were used from the 1920s as an alternative to antibiotics in the Soviet Union and Central Europe, as well as in France and Brazil. They are seen as a possible therapy against multi-drug-resistant strains of many bacteria.
...
Bacteriophages are a major threat to bacteria and prokaryotes, which have evolved numerous mechanisms to block infection (host resistance) or to block the replication of bacteriophages within host cells (anti-phage defense). Some examples include

- The CRISPR system
- Retrons and the anti-toxin system encoded by them.
- The Thoeris defense system is known to deploy a unique strategy for bacterial antiphage resistance via NAD+ degradation.
- The Hailong anti-phage defense system consists of a two-gene operon encoding a transmembrane ion channel effector (HalA) and a nucleotidyltransferase (NTase, HalB). An infecting phage can activate HalA, triggering membrane depolarization and thus cell death. Although the infected cell is likely going to die, this protects the bacterial population from further spread.
- Cyclic-oligonycleotide-based antiphage signaling system (CBASS) is an innate immune system found in many bacteria that protects against bacteriophage infection. When bacteria detect a phage infection CBASS enzymes synthesize cyclic nucleotide second messengers such as cyclic GMP-AMP (cGAMP). These signaling molecules activate downstream effector proteins, such as CapV (a phospholipase that can promote membrane lysis), that disrupt essential cellular processes leading to abortive infection and cell death. This is important in the defence of the bacteria population as the infected cell is sacrificed before viral replication is completed and the virus spreads to the whole population.
- The surface-associated nuclease inhibiting phage entry (SNIPE) system uses a membrane-bound nuclease which directly cleaves phage DNA during genome injection. SNIPE was discovered in *Escherichia coli* where it blocks phage λ infection but it appears to protect against a range of other siphoviruses too. In fact, the SNIPE proteins have homologs in a third of known bacterial clades although it remains unclear whether all of these proteins are involved in phage resistance.
...
Among the countless phages, only a few have been studied in detail, including some historically important phages that were discovered in the early days of microbial genetics. These, especially the T-phage, helped to discover important principles of gene structure and function.
