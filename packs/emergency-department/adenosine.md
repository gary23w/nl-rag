---
title: "Adenosine"
source: https://en.wikipedia.org/wiki/Adenosine
...
Alcohol can increase extracellular adenosine levels.

## Contraindications

Common contraindications for adenosine include

- Asthma, traditionally considered an absolute contraindication. This is being contested, and it is now considered a relative contraindication (however, selective adenosine antagonists are being investigated for use in treatment of asthma)
...
In general, adenosine has an inhibitory effect in the central nervous system (CNS). Caffeine's stimulatory effects are credited primarily (although not entirely) to its capacity to block adenosine receptors, thereby reducing the inhibitory tonus of adenosine in the CNS. This reduction in adenosine activity leads to increased activity of the neurotransmitters dopamine and glutamate. Experimental evidence suggests that adenosine and adenosine agonists can activate Trk receptor phosphorylation through a mechanism that requires the adenosine A2A receptor. Adenosine in the brain acts through three major receptor subtypes—A1, A2A, and A3—distributed across various neuronal and glial populations. Activation of neuronal A1 receptors generally exerts inhibitory effects, contributing to synaptic regulation. In a preclinical knock-in model of Alzheimer's disease, neuronal hyperexcitability during the asymptomatic stage has been shown to originate at the synaptic compartment and is associated with a deficient adenosinergic tone, suggesting that impaired adenosine signaling may contribute to early synaptic dysfunction.
