...
**Vite** (French: [vit], like "veet") is a local development server backed by **VoidZero** **Inc**. Vite was written by Evan You, the creator of Vue.js. It has support for TypeScript and JSX. It uses Rolldown internally for bundling.
