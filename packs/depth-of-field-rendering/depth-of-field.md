...
${\text{DOF}}\approx 2Nc\left({\frac {u}{f}}\right)^{2}=2Nc\left(1-{\frac {1}{M_{T}}}\right)^{2}$
...
- (Detail from a lens set to f/11. The point half-way between the 1 m and 2 m marks, the DOF limits at f/11, represents the focus distance of approximately 1.33 m (the reciprocal of the mean of the reciprocals of 1 and 2 being 4/3).) Detail from a lens set to f/11. The point half-way between the 1 m and 2 m marks, the DOF limits at f/11, represents the focus distance of approximately 1.33 m (the reciprocal of the mean of the reciprocals of 1 and 2 being 4/3).
- (DOF scale on Tessina focusing dial) DOF scale on Tessina focusing dial
