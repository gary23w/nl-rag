...
- superscript curls
  ...
  - ◌̉ – hook above (Vietnamese: *dấu hỏi*); for example ỏ
...
- Karelian has the umlauted vowels ä, ö, but not ü as in Estonian or some orthographies of Veps, instead using y. It also has caron letters š and ž, and sometimes č (although it's replaced with tš in other orthographies).
...
- Asturian uses an underdot: ⟨Ḷ⟩ (lower case, ⟨ḷ⟩), and ⟨Ḥ⟩ (lower case ⟨ḥ⟩)
...
- Filipino also has the character *ñ* as a letter and is collated between letters *n* and *ng*.
