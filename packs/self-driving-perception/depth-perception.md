...
source: https://en.wikipedia.org/wiki/Depth_perception
...
- (Context-dependent interpretation of the size) Context-dependent interpretation of the size
- (Shots at different distances) Shots at different distances
- (The horizon line is at the height of the armrests.) The horizon line is at the height of the armrests.
- (View from a window on the 2nd floor of a house) View from a window on the 2nd floor of a house
- (Mountain peak near the snow line and several mountain peaks above the snow line) Mountain peak near the snow line and several mountain peaks above the snow line
