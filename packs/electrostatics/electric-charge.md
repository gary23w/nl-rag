...
The elementary charge is defined as a fundamental constant in the SI. The value for elementary charge, when expressed in SI units, is exactly 1.602176634×10−19 C.
...
$-{\frac {d}{dt}}\int _{V}\rho \,\mathrm {d} V=$
