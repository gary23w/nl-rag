...
source: https://en.wikipedia.org/wiki/Equation_solving
...
holds. For example, the projection π1 : **R**2 → **R** defined by π1(*x*, *y*) = *x* has no post-inverse, but it has a pre-inverse π−1 1 defined by π−1 1(*x*) = (*x*, 0). Indeed, the equation π1(*x*, *y*) = *c* is solved by
