...
source: https://en.wikipedia.org/wiki/IBM_System/360
...
Available on special bid beginning Nov 1964
...
4,290–8,830 lb (1,946–4,005 kg)

depends on memory and number of processors
...
3,674 lb (1,666 kg) – Processor only
...
14,428 lb (6,544 kg) – Processor only
...
13,450–28,350 lb (6,101–12,859 kg)

depends on memory

32 KB IC cache memory. Performance estimated as 3× Model 85.
...
Models 65 and below sold with an IBM 1052–7 as the console typewriter. The 360/85 with feature 5450 uses a display console that was not compatible with anything else in the line; the later 3066 console for the 370/165 and 370/168 use the same basic display design as the 360/85. The IBM System/360 models 91 and 195 use a graphical display similar to the IBM 2250 as their primary console.
...
- Two Model 20 systems were purchased by UK enthusiasts. As of 2024 they are on long-term loan to the System Source Computer Museum for display and restoration.
- The Living Computers: Museum + Labs had a 360 model 30 before it closed in February 2020.
...
This gallery shows the operator's console, with register indicator lamps, toggle switches (middle of pictures), and "emergency pull" switch (upper right of pictures) of the various models.
