---
title: "NetLogo"
source: https://en.wikipedia.org/wiki/NetLogo
...
NetLogo is open source and freely available from the NetLogo website. It is in use in a wide variety of educational contexts from elementary school to graduate school. Many teachers make use of NetLogo in their curricula. NetLogo is also widely used in scientific research having been used in several thousand research papers.
...
NetLogo supports many features including but not limited to:
...
- First-class function values: anonymous procedures and reporters
...
- Headless mode: NetLogo can run headlessly, allowing batch runs from the command line
- BehaviorSpace: a tool used to collect data from multiple runs of a model with varying parameters
...
- *Smaldino, Paul E. (2023). *Modeling Social Behavior: Mathematical and Agent-Based Models of Social Dynamics and Cultural Evolution*. Princeton, New Jersey: Princeton University Press. ISBN 978-0-691-22414-5.*
...
- *Railsback, Steven F.; Grimm, Volker (2011). *Agent-Based and Individual-Based Modeling: A Practical Introduction*. Princeton, New Jersey: Princeton University Press. ISBN 978-0-691-13674-5.*
...
- *"NetLogo User Manual" (PDF). *NetLogo User Manual*. Center for Connected Learning and Computer Modeling, Northwestern University. 2025. Retrieved 4 August 2025.*
...
The **Traffic Grid** model in NetLogo simulates vehicular movement and traffic light control on a two‑dimensional city grid. Cars accelerate, decelerate, or stop depending on traffic lights, other vehicles, and a user‑defined speed limit. The model is designed to demonstrate urban traffic dynamics and gridlock formation while allowing users to experiment with traffic management strategies.
