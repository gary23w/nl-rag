---
title: "Generic Types (The Java™ Tutorials > Learning the Java Language > Generics (Updated))"
...
Many developers use the terms "type parameter" and "type argument" interchangeably, but these terms are not the same. When coding, one provides type arguments in order to create a parameterized type. Therefore, the
