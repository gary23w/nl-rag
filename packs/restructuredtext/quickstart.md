...
source: https://docutils.sourceforge.io/docs/user/rst/quickstart.html
...
1. upper-case letters and it goes over many lines with two paragraphs and all!
...
To indicate the document title in reStructuredText, use a section title with unique adornment style at the beginning of the document. To indicate the document subtitle, use another unique adornment style immediately after the document title. For example:
