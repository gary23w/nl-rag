...
source: https://en.wikipedia.org/wiki/Real-time_clock
...
Some motherboards are made without RTCs. The RTC may be omitted out of a desire to save money or reduce possible sources of hardware failure.
...
In newer computer systems, the RTC is integrated into the southbridge chip.
