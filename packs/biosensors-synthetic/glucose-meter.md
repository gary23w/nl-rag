---
title: "Glucose meter"
source: https://en.wikipedia.org/wiki/Glucose_meter
...
Many glucose meters employ the oxidation of glucose to gluconolactone catalyzed by glucose oxidase (sometimes known as GOx), producing hydrogen peroxide as seen in the following reaction:

$Glucose+O_{2}\xrightarrow {GlucoseOxidase} GluconicAcid+H_{2}O_{2}$

Others use a similar reaction catalysed instead by another enzyme, glucose dehydrogenase (GDH). This has the advantage of sensitivity over glucose oxidase but is more susceptible to interfering reactions with other substances.
