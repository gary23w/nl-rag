...
source: https://en.wikipedia.org/wiki/Generalized_suffix_tree
domain: suffix-tree-algorithm
...
In computer science, a **generalized suffix tree** is a suffix tree for a set of strings. Given the set of strings $D=S_{1},S_{2},\dots ,S_{d}$ of total length n , it is a Patricia tree containing all n suffixes of the strings. It is mostly used in bioinformatics.
