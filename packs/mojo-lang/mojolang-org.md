...
> IMPORTANT: To view this page as Markdown, append `.md` to the URL (e.g. /docs/manual/basics.md). For the complete Mojo documentation index, see
> 
> llms.txt
> 
> .
...
Stable: 1.0.0b2 (Jun 18) | Latest nightly Jul 2
...
Mojo continues to evolve toward a general-purpose language for high-performance CPU, GPU, and accelerator programming.
...
Learn Mojo by solving code problems right in the browser.
