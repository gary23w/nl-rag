---
title: "Implicit k-d tree"
source: https://en.wikipedia.org/wiki/Implicit_k-d_tree
domain: kd-tree
...
- Ray casting iso-surfaces/MIP an underlying scalar field using the corresponding implicit max *k*-d tree takes roughly $\mathrm {O} (\log(n))$ time.
