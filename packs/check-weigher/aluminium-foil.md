...
source: https://en.wikipedia.org/wiki/Aluminium_foil
domain: check-weigher
...
Aluminium foil has a thickness less than 0.2 mm (7.9 mils); thinner gauges down to 6 μm (0.24 mils) are also commonly used. Standard household foil is typically 0.016 mm (0.63 mils) thick, and heavy-duty household foil is typically 0.024 mm (0.94 mils). Foil may have a non-stick coating on only one side.
...
The continuous casting method is much less energy-intensive and has become the preferred process. It is difficult to produce rollers with a gap fine enough to cope with the foil gauge, and to avoid this, as well as reducing tearing, increasing production rates, and controlling thickness, for the final pass when producing thicknesses below 0.025 mm (1 mil), two sheets are rolled at the same time, doubling the thickness of the gauge at entry to the rollers. After the rollers, the two sheets are separated, which produces foil with one shiny side and one matte side.
...
Aluminium foil is available in various types, classified by thickness, alloy composition, manufacturing process, and surface treatment. The most common classification is by thickness (or gauge), which determines the foil's strength, flexibility, and application. Other distinctions are based on temper, surface finish, and intended use.

### By thickness

The thickness of aluminium foil is typically measured in microns (μm) or mils (thousandths of an inch). A thickness-based classification includes the following general categories:

- **Ultra-thin / Light gauge foil (Double zero foil)**: Ranges from 6–12 μm in thickness. It is extremely thin and often laminated with other materials due to its fragility. Common applications include flexible packaging, candy wrappers, and cigarette packs.
- **Standard household foil**: Typically 12–18 μm (0.4–0.7 mils) thick. It is the most common type for everyday kitchen use, suitable for wrapping food, covering dishes, and light baking.
- **Heavy-duty foil**: Usually 18–40 μm (0.7–1.6 mils) thick, offering greater strength and puncture resistance. It is used for grilling, roasting, freezing, and lining baking sheets.
- **Industrial foil**: Ranges from 40–200 μm in thickness. This type is employed in applications such as thermal insulation, heat exchangers, and aerospace components.

### By manufacturing process and surface

Depending on the production process and surface finishing, aluminium foil can be categorized into:

- **Rolled (bare) foil**: The most common type, consisting of pure aluminium rolled to the desired thickness.
- **Laminated foil**: Combines aluminium foil with other materials like plastic or paper, enhancing barrier properties for packaging of food, juice boxes, and medicine.
- **Coated foil**: Has a thin layer of lacquer or polymer applied for non-stick properties or to prevent reactions with acidic foods.
- **One-side bright / Two-side bright foil**: Foil produced by single-rolling has two bright sides; foil produced by double-rolling has one bright and one matte side. The matte side results from two layers being in contact during the rolling process.

### By alloy series

Aluminium foil is produced from different alloy series, each offering distinct characteristics:

- **1xxx Series (Pure Aluminium)**: Virtually pure aluminium with excellent corrosion resistance and conductivity, commonly used for packaging and electrical applications.
- **3xxx Series (Aluminium-Manganese)**: Offers added strength while maintaining formability, often used for foil containers.
- **8xxx Series**: Designed for specific properties such as increased strength or reduced thickness.

### Specialized types

- **Non-stick foil**: Coated to prevent food from sticking, ideal for roasting and baking.
- **Pharmaceutical foil**: Specialized foil used for blister packs, requiring absolute moisture and gas barrier with strict tolerances. Typically, thicknesses range from 20–50 μm.
