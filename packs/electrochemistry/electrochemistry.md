...
source: https://en.wikipedia.org/wiki/Electrochemistry
...
During operation of an electrochemical cell, chemical energy is transformed into electrical energy. This can be expressed mathematically as the product of the cell's emf *E*cell measured in volts (V) and the electric charge $Q_{e,trans}$ transferred through the external circuit.

Electrical energy =

$E_{\mathrm {cell} }Q_{\mathrm {e,trans} }$

$Q_{\mathrm {e,trans} }$ is the cell current integrated over time and measured in coulombs (C); it can also be determined by multiplying the total number *n*e of electrons transferred (measured in moles) times Faraday's constant (*F*).
...
Note that *⁠RT/F⁠* is also known as the thermal voltage *V*T and is found in the study of plasmas and semiconductors as well. The value 0.05916 V in the above equation is just the thermal voltage at standard temperature multiplied by the natural logarithm of 10.
...
is the molar mass of the substance (in grams per
