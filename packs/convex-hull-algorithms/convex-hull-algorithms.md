...
- **Quickhull** Created independently in 1977 by W. Eddy and in 1978 by A. Bykat. Just like the quicksort algorithm, it has the expected time complexity of *O*(*n* log *n*), but may degenerate to *O*(*n*2) in the worst case.
- **Divide and conquer**, a.k.a. **merge hull** — *O*(*n* log *n*) Another O(*n* log *n*) algorithm, published in 1977 by Preparata and Hong. This algorithm is also applicable to the three dimensional case. Chan calls this "one of the best illustrations of the power of the divide-and-conquer paradigm".
