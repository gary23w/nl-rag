...
source: https://en.wikipedia.org/wiki/Human%E2%80%93machine_interface
domain: plc-scada
...
4. Findable: Are users able to quickly find the information they are looking for? Information needs to be findable and simple to navigate. A user should never have to hunt for your product or information.
...
13. *Motion tracking interfaces* monitor the user's body motions and translate them into commands, some techniques of which were at one point patented by Apple.
...
27. *Zero-input interfaces* get inputs from a set of sensors instead of querying the user with input dialogs.
...
- (Historic HMI in the driver's cabin of a German steam locomotive) Historic HMI in the driver's cabin of a German steam locomotive
- (Modern HMI in the driver's cabin of a German Intercity-Express high-speed train) Modern HMI in the driver's cabin of a German Intercity-Express high-speed train
- (The HMI of a toilette (in Japan)) The HMI of a toilette (in Japan)
- (Wearable computers, like Google Glass in the image, may use voice user interface) Wearable computers, like *Google Glass* in the image, may use voice user interface
- (HMI for audio mixing) HMI for audio mixing
- (HMI for video production) HMI for video production
- (HMI of a machine for the sugar industry with pushbuttons) HMI of a machine for the sugar industry with pushbuttons
- (HMI for a computer numerical control (CNC)) HMI for a computer numerical control (CNC)
- (Slightly newer HMI for a CNC-machine) Slightly newer HMI for a CNC-machine
- (Emergency switch/panic switch) Emergency switch/panic switch
- (DMD 5620 terminal) DMD 5620 terminal
