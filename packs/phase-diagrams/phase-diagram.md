---
title: "Phase diagram"
source: https://en.wikipedia.org/wiki/Phase_diagram
...
- Chart in U.S. units
- (enthalpy–entropy (h–s) diagram for steam) enthalpy–entropy (*h*–*s*) diagram for steam
- (pressure–enthalpy (p–h) diagram for steam) pressure–enthalpy (*p*–*h*) diagram for steam
- (temperature–entropy (T–s) diagram for steam) temperature–entropy (*T*–*s*) diagram for steam
...
- (Gibbs triangle) Gibbs triangle
- (Space diagram of a three-component system) Space phase diagram of a ternary system
...
However, the most common methods to present phase equilibria in a ternary system are the following: 1) projections on the concentration triangle ABC of the liquidus, solidus, solvus surfaces; 2) isothermal sections; 3) vertical sections.
