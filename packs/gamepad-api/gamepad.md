---
title: "Gamepad"
source: https://en.wikipedia.org/wiki/Gamepad
domain: gamepad-api
...
Gamepads or devices closely modelled on them are sometimes used for controlling real machinery and vehicles, as they are familiar to users and (in the case of actual gamepads) provide an off-the-shelf solution. The US Army and US Navy use Xbox controllers for operating devices, and the British Army uses a device modelled on gamepads to operate systems on the Challenger 2 main battle tank. The *Titan* submersible used a gamepad for control.
