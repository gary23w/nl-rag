---
title: "Image scanner"
source: https://en.wikipedia.org/wiki/Image_scanner
domain: container-image-scanning
license: CC-BY-SA-4.0
tags: container image scanning, image vulnerability scanner, software composition analysis, container supply chain security, oci image inspection
fetched: 2026-07-02
---
...
Inexpensive, portable, battery-powered or USB-powered wand scanners and pen scanners, typically capable of scanning an area as wide as a normal letter and much longer, remain available as of 2024. Some computer mice can also scan documents.
...
3. Barcode-like QR code scanning apps that then search the internet for information associated with the code.
...
- ImageCaptureCore - A Cocoa API used by Apple devices, replacing the Carbon-based ImageCapture Services.
