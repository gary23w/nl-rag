...
domain: bat-and-ball-games
license: CC-BY-SA-4.0
tags: bat-and-ball games
fetched: 2026-07-08
---

# Airsoft

**Airsoft**, also known as **survival game** in Japan where it originated, is a team-based shooting game involving participants eliminating opposing players by shooting and tagging the latter with spherical plastic projectiles shot from low-power toy airguns known as airsoft guns.

Although similar to paintball in concept and gameplay, airsoft pellets do not leave visible dye markings on their target and hits are not always apparent, though the pellets can sometimes leave small bruises or welts on exposed skin (and so protective gear is still recommended). The game therefore relies heavily on an honor system in which players who have been hit are expected to call themselves out of play in keeping with honesty, fairness and sportsmanship.
...
Rules such as a maximum muzzle velocity and engagement distance guidelines are used by different groups. Some organizations have created common safety rules and guidelines. Most minimum engagement distances are 10 feet (3.0 m).
