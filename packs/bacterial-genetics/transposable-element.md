...
source: https://en.wikipedia.org/wiki/Transposable_element
...
Transposition can be classified as either "autonomous" or "non-autonomous" in both Class I and Class II TEs. Autonomous TEs can move through the genome by themselves as they encode for their transpositional machinery allowing for their ability to move around the genome. This is contrasted by non-autonomous where they lack the ability to encode for their transposition machinery and require the presence of another TE machinery to move. This is often because dependent TEs lack transposase (for Class II) or reverse transcriptase (for Class I).
...
Transposable elements can be all over a genome, and in the case of maize, TEs make up 50% of the genome. In yeast (which has 5 classes of retrotransposons, Ty1-Ty5), over 90% of the Ty1 through T4 elements are located within 750 bp upstream of genes transcribed by RNA polymerase III, particularly tRNA genes. The Ty5 elements are all located at the telomeres or regions with telomeric chromatin.
...
Currently, diseases asssociated with TEs included:
