...
source: https://en.wikipedia.org/wiki/Adjunct_(grammar)
...
– Conditional adjuncts establish the condition in which an action occurs or state holds.

- I would go to Paris, **if I had the money**.

Consecutive

– Consecutive adjuncts establish an effect or result.
...
– Instrumental adjuncts establish the instrument used to accomplish an action.
...
– Measure adjuncts establish the measure of the action, state, or quality that they modify
...
– Modal adjuncts establish the extent to which the speaker views the action or state as (im)probable.
...
– Modificative adjuncts establish how the action happened or the state existed.
...
– Temporal adjuncts establish when, how long, or how frequent the action or state happened or existed.
...
b. I know. - the sentence is acceptable, but its meaning is changed entirely. Therefore,
...
is an object argument (=complement).
...
is not an obligatory argument.

c. *Fred ate, which occurred
...
c. *We are working, which is occurring
