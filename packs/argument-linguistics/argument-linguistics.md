---
title: "Argument (linguistics)"
source: https://en.wikipedia.org/wiki/Argument_(linguistics)
...
Fred tried to say something

twice

. → Fred tried to say something, which occurred
...
. → *Fred tried to say, which happened
...
. → *We are waiting, which is happening
...
. → *Tom put the knife, which occurred
...
*bold reading of the poem after lunch that was
...
Bill's reading of the poem after lunch that was
...
*Bill's bold reading after lunch that was
...
Bill's bold reading of the poem that was
...
The notion of argument structure was first conceived in the 1980s by researchers working in the government–binding framework to help address controversies about arguments.
