...
core has a cylindrical central leg.

The

EP

core is halfway between a
...
Construction of an inductor using two
...
of the previous figure showing the structure
...
- $R_{ac}$ is the effective core loss resistance (ohms),
- $\mu$ is the material permeability,
- L is the inductance (henrys),
- a is the hysteresis loss coefficient,
- $B_{\text{max}}$ is the maximum flux density (gauss),
- c is the residual loss coefficient,
- f is the frequency (hertz), and
- ${\ce {e}}$ is the eddy loss coefficient.
