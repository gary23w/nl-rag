---
title: "Amborella"
source: https://en.wikipedia.org/wiki/Amborella
domain: dicotyledon
...
- (Specimen in Berkeley, California)Specimen in Berkeley, California
- (Young leaves)Young leaves
- (Buds and staminate (male) flowers)Buds and staminate (male) flowers
- (Diagram of a female flower with 5 carpels and 2 staminodes)Diagram of a female flower with 5 carpels and 2 staminodes
...
| extant seed plants | Acrogymnosperms angiosperms ***Amborella*** *Nuphar* *Illicium* monocots magnoliids eudicots |
|---|---|
|   |   |
