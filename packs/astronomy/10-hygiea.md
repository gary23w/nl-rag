---
title: "10 Hygiea"
source: https://en.wikipedia.org/wiki/10_Hygiea
domain: astronomy
...
- (Annibale de Gasparis, discoverer of Hygiea)Annibale de Gasparis, discoverer of Hygiea
- (The Astronomical Observatory of Capodimonte, where Hygiea was discovered)The Astronomical Observatory of Capodimonte, where Hygiea was discovered
...
Hygiea orbits the Sun at an average distance (semi-major axis) of 3.14 astronomical units (AU; 470 million km or 290 million mi), which places it in the outer portion of the main asteroid belt between Mars and Jupiter. Hygiea has an orbital period of 5.57 Earth years and follows an elliptical orbit where its distance from the Sun ranges between 2.79 AU (420 million km; 260 million mi) at perihelion to 3.49 AU (520 million km; 320 million mi) at aphelion. Hygiea has a relatively low orbital inclination of 3.8° with respect to the ecliptic plane. In its current orbit, Hygiea never comes closer than 1.24 AU (186 million km; 115 million mi) to Mars and 1.54 AU (230 million km; 143 million mi) to Jupiter.
...
Other asteroids occasionally pass close to Hygiea, sometimes close enough that their trajectories become visibly perturbed or deflected by Hygiea's gravity. This allows astronomers to measure Hygiea's mass. A 2002 study identified 40 known asteroids that have passed within 0.05 AU (7.5 million km; 4.6 million mi) of Hygiea between 1970 and 2000. Over a time span of 30 million years, Hygiea's gravitational perturbations can cause the proper semi-major axes of close-passing asteroids to change by 0.000908 AU (136,000 km; 84,400 mi).

## Hygiea family

Hygiea is the parent body of the Hygiea family, an asteroid family comprising over 7,000 known asteroids that share similar orbital and compositional characteristics with Hygiea. The Hygiea family is the most populous asteroid family in the outer main belt, and is believed to have formed by a giant impact on Hygiea that ejected at least 1.7% of the asteroid's original mass about 2 to 3 billion years ago. The impactor that formed the Hygiea family was probably between 75 and 150 km (47 and 93 mi) in diameter. Hygiea contains almost all the mass (over 98%) of the family.

## Rotation

Rotational light curve of Hygiea measured by the
...
A total of 17 stellar occultations by Hygiea have been tracked by Earth-based astronomers, including two (in 2002 and 2014) that were seen by a large number of observers. The observations have been used to constrain Hygiea's size, shape and rotation axis. The Hubble Space Telescope has resolved the asteroid and ruled out the presence of any orbiting companions larger than about 16 kilometres (9.9 mi) in diameter.
