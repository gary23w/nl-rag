---
title: "Agar"
source: https://en.wikipedia.org/wiki/Agar
domain: arab-indonesian-cuisine
license: CC-BY-SA-4.0
tags: arab indonesian cuisine
fetched: 2026-07-08
---

# Agar

**Agar** (/ˈeɪɡɑːr/ or /ˈɑːɡər/), or **agar-agar**, is a jelly-like substance consisting of polysaccharides obtained from the cell walls of some species of red algae (phylum Rhodophyta) primarily from the *Gracilaria* genus (Irish moss, ogonori) and the Gelidiaceae family (tengusa). These algae are known as agarophytes.
...
The word *agar* comes from **agar-agar**, the Malay name for red algae (*Gigartina*, *Eucheuma*, *Gracilaria*) from which the jelly is produced. It is also known as **kanten** (Japanese: 寒天) (from the phrase ***kan**-zarashi tokoro**ten*** (寒晒し心太) or "cold-exposed agar"), **Japanese isinglass**, **China grass**, **Ceylon moss**, and **Jaffna moss**. *Gracilaria edulis* or its synonym *G. lichenoides* is specifically referred to as **agal-agal** or **Ceylon agar**.
