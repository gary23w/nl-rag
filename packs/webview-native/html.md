...
. It was the first version developed and standardized exclusively by the W3C, as the IETF had closed its HTML Working Group on 12 September 1996.
...
A markup for mathematical formulas similar to that of HTML was standardized 14 months later in
...
HTML 4.0 adopted many browser-specific element types and attributes, but also sought to phase out Netscape's visual markup features by marking them as
...
was reissued with minor edits without incrementing the version number.

**24 December 1999**

HTML 4.01

was published as a W3C Recommendation. It offers the same three variations as HTML 4.0 and its last errata

were published on 12 May 2001.
...
HTML", based on HTML 4.01 Strict) was published as an ISO/IEC international standard.

In the ISO, this standard is in the domain of the
...
with seven subsequent revisions (15 July, 6 August, 18 August, 17 November, 18 November, 20 November, and 22 November)
...
First draft (revision 00) of HTML 2.0 published by the IETF

(called "HTML 2.0" starting with revision 02

), that finally led to the publication of
...
was proposed as a standard to the IETF, but the proposal expired five months later (28 September 1995)
...
for HTML 3 and Cascading Style Sheets,

but HTML 3.0 did not succeed for several reasons. The draft was considered very large at 150 pages and the pace of browser development, as well as the number of interested parties, had outstripped the resources of the IETF.
...
1. The language for an element is specified with a `lang` attribute rather than the XHTML `xml:lang` attribute. XHTML uses XML's built-in language-defining functionality attribute.
