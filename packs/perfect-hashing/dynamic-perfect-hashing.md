...
source: https://en.wikipedia.org/wiki/Dynamic_perfect_hashing
...
If *x* exists at *j* or at the subtable *Tj*, and is not marked as deleted, then a collision is said to occur and the *j*th bucket's second-level table *Tj* is rebuilt with a different randomly selected hash function *hj*.
