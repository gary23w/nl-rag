...
- You can find the API URL in the **Integrations > Data API** section of the Dashboard.
- You can find the API Keys in the **Settings > API Keys** section of the Dashboard.

## Features

Supabase provides a RESTful API using PostgREST, a thin API layer on top of Postgres. It exposes everything you need from a CRUD API at the URL `https://<project_ref>.supabase.co/rest/v1/`.
