...
- ERC-20 Contract Walk-Through *– A line-by-line annotated walkthrough of the OpenZeppelin ERC-20 contract implementation.*
- ERC-20 with Safety Rails *– How to add safeguards to ERC-20 tokens to help users avoid common mistakes.*
- Sending Tokens Using ethers.js *– A beginner-friendly guide to transferring ERC-20 tokens using ethers.js.*
- Some tricks used by scam tokens and how to detect them *– A deep-dive into scam ERC-20 token patterns and how to identify them.*
