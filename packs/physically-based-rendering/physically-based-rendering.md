...
source: https://en.wikipedia.org/wiki/Physically_based_rendering
...
Starting in the 1980s, a number of rendering researchers worked on establishing a solid theoretical basis for rendering, including physical correctness. An early system, Radiance, for lighting design and architecture, was presented in Greg Ward's 1994 SIGGRAPH paper, "The RADIANCE Lighting Simulation and Rendering System," which may have introduced the phrase "physically-based rendering". Other work was done at the Cornell University Program of Computer Graphics; a 1997 paper from that lab describes the work done at Cornell in this area to that point.
