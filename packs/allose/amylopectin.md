...
Amylopectin is divided into *A* and *B* helical chains of α-glucose. *A* chains are chains that carry no other chains, resulting in an eventual terminus, whereas *B* chains are chains that do carry other chains, perpetuating the amylopectin polymer. The ratio between these is usually between 0.8 and 1.4.

The formation of chain structures has a direct impact on the overall strength of the whole polymer; the longer a chain is, the more differing the effects amylopectin will have on starch's morphology. Packing of chains, inter block chain length (IB-CL), also correlates with the gelatinization temperature of starch granules. In tandem, the IB-CL will increase as the length of *B* chains increases, meaning that as the length of individual *B* chains increases, so does the blocks between connections with other chains. Finally, in general, the more densely packed the resulting molecule of amylopectin, the higher the strength of the starch gel as a whole unit.
...
The synthesis of amylopectin depends on the combined efforts of four different enzymes:

1. ADP glucose pyrophosphorylase (AGPase)
2. soluble starch synthase (SS)
...
1. alpha, beta amylases
2. phosphorylases
3. starch debranching enzyme (DBE)
