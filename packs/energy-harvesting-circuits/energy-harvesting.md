...
One of the main driving forces behind the search for new energy harvesting devices is the desire to power sensor networks and mobile devices without batteries that run on intermittent computing systems and need external charging or service. Batteries have several limitations, such as limited lifespan, environmental impact, size, weight, and cost. Energy harvesting devices can provide an alternative or complementary source of power for applications that require low power consumption, such as remote sensing, wearable electronics, condition monitoring, and wireless sensor networks. Energy harvesting devices can also extend the battery life or enable batteryless operation of some applications.
...
Soil microbial fuel cells harvest electrical energy from the anaerobic respiration of naturally occurring soil bacteria, which provides the oxidation reaction at the anode. Soil microbial fuel cells can output microwatts of power, and have been used in both classroom demonstrations and to power analog radar sensors.
...
Asymmetries in bistable energy harvesters can significantly affect dynamic performance and harvested power, especially under nonlinear piezoelectric coupling and parametric variability. Recent studies show that while asymmetries may degrade response in certain regimes, they can also be exploited—through sloping angle tuning and robust parameter selection—to enhance energy conversion and outperform symmetric designs.
