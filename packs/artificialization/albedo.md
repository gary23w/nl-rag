...
- the directional-hemispherical reflectance at that solar zenith angle, ${{\bar {\alpha }}(\theta _{i})}$ , sometimes referred to as black-sky albedo, and
...
$\alpha =(1-D){\bar {\alpha }}(\theta _{i})+D{\bar {\bar {\alpha }}}.$
...
An important relationship between an object's astronomical (geometric) albedo, absolute magnitude and diameter is given by: $A=\left({\frac {1329\times 10^{-H/5}}{D}}\right)^{2},$ where A is the astronomical albedo, D is the diameter in kilometers, and H is the absolute magnitude.
...
$\rho ={\begin{cases}3.20{\text{ g cm}}^{-3}\ln \left({\frac {1+{\sqrt {0.83{\hat {\sigma }}_{\text{OC}}}}}{1-{\sqrt {0.83{\hat {\sigma }}_{\text{OC}}}}}}\right)&{\text{for }}{\hat {\sigma }}_{\text{OC}}\leq 0.07\\(6.944{\hat {\sigma }}_{\text{OC}}+1.083){\text{ g cm}}^{-3}&{\text{for }}{\hat {\sigma }}_{\text{OC}}>0.07\end{cases}}$
