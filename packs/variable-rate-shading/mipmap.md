---
title: "Mipmap"
source: https://en.wikipedia.org/wiki/Mipmap
domain: variable-rate-shading
...
Showing each color channel of each level of an RGB mipmap as a separate plane (left) demonstrates that the whole mipmap forms a square of 4 times the area. As each plane requires
...
the storage, mipmaps therefore require
