---
title: "AC power plugs and sockets (part 1/3)"
...
Plugs and sockets may sometimes combine male and female contacts. Clockwise from top left: CEE
...
7/3 socket with exposed

earth (ground)

contacts around the circumference;

CEE

7/5

(Belgian/French) socket with projecting earth pin
...
An old US non-polarized multisocket adaptor
...
A so-called "universal socket", which meets no official standard

but is intended to accept a number of different plug types.

An earthed Thai socket that complies with figure

4 of TIS

166-2549. Although it accepts NEMA plugs, the Thai voltage is 230

V and thus is electrically incompatible with devices designed only for 120

V.

Old Chinese dual socket accepting both unearthed two-pin (upper) and earthed three-pin (lower) plugs.
...
Swappable plug and IEC 60320 C7 cable
