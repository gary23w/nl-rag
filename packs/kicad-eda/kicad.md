...
Alfons Wirtz's open-source Java-based FreeRouting can be used to externally autoroute boards. Anthony Blake's Toporouter, a topological autorouter developed in 2008 for gEDA PCB as a Google-funded open source project mentored by DJ Delorie, has been adapted for use with KiCad as well.

## Community

On 12 March 2015 Olimex Ltd, a provider of development tools and embedded device programmers, announced that they have switched from EAGLE to KiCad as their primary EDA tool.
