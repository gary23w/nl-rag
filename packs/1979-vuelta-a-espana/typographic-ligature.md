...
source: https://en.wikipedia.org/wiki/Typographic_ligature
...
In writing and typography, a **ligature** is the combination two or more graphemes or letters into one glyph. Common examples include:
...
Ligatures are also used for logo creation, such as the Bluetooth logo, (a ligature merging the runes  (ᚼ, Hagall) and  (ᛒ, Bjarkan)).
...
The Initial Teaching Alphabet, a short-lived alphabet intended for young children, used a number of ligatures to represent long vowels: ⟨æ⟩, ⟨ꜷ⟩, ⟨œ⟩, ⟨ᵫ⟩, and ligatures for ⟨ϵϵ⟩, ⟨ie⟩, ⟨oi⟩, and ⟨ou⟩. Ligatures for consonants also existed, including ligatures of ⟨ʗh⟩, ⟨ʃh⟩, ⟨ʈh⟩, ⟨th⟩, and ⟨wh⟩. The ligatures were approved in 2025 for publication in Unicode 18.0.
...
One popular ligature used on *chūntiē* decorations used for Chinese Lunar New Year is "(⿱𡩧⿺進⿰貝招)" a combination of the four characters for *zhāocái jìnbǎo* (招財進寶), meaning "ushering in wealth and fortune" and used as a popular New Year's greeting.

Chinese ligatures

"

" Chinese ligature for
...
|---|---|---|---|
| superscript small capital AA | 𐞀 | U+10780 | &#x10780; |
...
| dʒ with palatal hook | 𝼒 | U+1DF12 | &#x1DF12; |
| dʒ with retroflex hook | 𝼙 | U+1DF19 | &#x1DF19; |
| fŋ (or feng) | ʩ | U+02A9 | &#x2A9; |
| Superscript fŋ | 𐞐 | U+10790 | &#67472; |
| fŋ with trill | 𝼀 | U+1DF00 | &#x1DF00; |
...
| lʒ with retroflex hook | 𝼅 | U+1DF05 | &#x1DF05; |
| superscript lʒ with retroflex hook | 𐞟 | U+1079F | &#x1079F; |
| oə | ꭀ | U+AB40 | &#xAB40; |
| qp | ȹ | U+0239 | &#x239; |
...
| superscript ts with retroflex hook | 𐞭 | U+107AD | &#x107AD; |
| tʂ | ꭧ | U+AB67 | &#43879; |
| tʃ (or tesh) | ʧ | U+02A7 | &#x2A7; |
| superscript tʃ | 𐞮 | U+107AE | &#x107AE; |
| tʃ with retroflex hook | 𝼜 | U+1DF1C | &#x1DF1C; |
| tʃ with palatal hook | 𝼗 | U+1DF17 | &#x1DF17; |
| ui | ꭐ | U+AB50 | &#xAB50; |
...
Typographic ligatures are used in a form of contemporary art, as can be illustrated by Chinese artist Xu Bing's work in which he combines Latin letters to form characters that resemble Chinese. Croatian designer Maja Škripelj also created a ligature that combined Glagolitic letters ⰘⰓ for euro coins.
