---
title: "2005 EU Cup Australian rules football"
source: https://en.wikipedia.org/wiki/2005_EU_Cup_Australian_rules_football
...
| Pool A (Austria) Austria (Belgium) Belgium (Catalonia) Catalonia (Germany) Germany (Israel) Israel | Pool B (England) England (France) France (Scotland) Scotland (Netherlands) Netherlands (Sweden) Sweden |
|---|---|
