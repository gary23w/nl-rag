---
title: "Atole"
source: https://en.wikipedia.org/wiki/Atole
domain: acaçá
...
***Atole*** (Spanish: [aˈtole] ⓘ, believed to come from Nahuatl *ātōlli* [aːˈtoːlːi] or from Mayan), also known as ***atolli***, ***atol*** and ***atol de elote***, is a traditional hot masa-based beverage of Mexican origin. Atole can have different flavors added, such as vanilla, cinnamon, and guava. Chocolate *atole* is known as *champurrado* or simply *atole*. It typically accompanies tamales and is especially consumed during Day of the Dead (observed November 2) and Las Posadas (Christmas holiday season).
