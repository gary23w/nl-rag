---
title: "Runbook"
source: https://en.wikipedia.org/wiki/Runbook
domain: security-orchestration-soar
license: CC-BY-SA-4.0
tags: security orchestration automation, soar playbook automation, incident response runbook, workflow automation engine, security operations center
fetched: 2026-07-02
---
...
The documentation for running a task, whether in electronic or paper form, is called a runbook. Sometimes written as "run book," it may supplement bullet-pointed steps with error messages (and what to do) and flowcharts.
