...
source: https://en.wikipedia.org/wiki/Hierarchical_storage_management
domain: aws-glacier
...
HSM may also be used where more robust storage is available for long-term archiving, but this is slow to access. This may be as simple as an off-site backup for recovery from disaster.
