...
- *P*1 is the projection operator (which projects a 2-D function onto a 1-D line),
...
where *A*1 represents the Abel-transform operator, projecting a two-dimensional circularly symmetric function onto a one-dimensional line, *F*1 represents the 1-D Fourier-transform operator, and *H* represents the zeroth-order Hankel-transform operator.
