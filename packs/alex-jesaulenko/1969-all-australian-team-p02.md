---
title: "All-Australian team (part 2/3)"
...
| **Int:** | Lachie Whitfield (GWS) | Lachie Neale (BL) | Adam Treloar (WB) |
| Zak Butters (Port) |   |   |   |
| **Coach:** | Chris Fagan (BL) |   |   |
...
| **F:** | Charlie Cameron (BL) | Charlie Curnow (Carl) | Toby Greene (GWS) (capt) |
...
| **Foll:** | Max Gawn (Melb) | Patrick Cripps (Carl) (v.c) | Lachie Neale (BL) |
...
|---|---|---|---|
| **HB:** | Daniel Rich (BL) | Aliir Aliir (Port) | Bailey Dale (WB) |
...
| **Int:** | Darcy Parish (Ess) | Nic Naitanui (WC) | Touk Miller (GC) |
| Jack Steele (St K) |   |   |   |
| **Coach:** | Simon Goodwin (Melb) |   |   |

#### 2020

| **B:** | Brad Sheppard (WC) | Harris Andrews (BL) | Luke Ryan (Frem) |
|---|---|---|---|
...
| **Foll:** | Nic Naitanui (WC) | Christian Petracca (Melb) | Lachie Neale (BL) |
...
| **B:** | Tom Stewart (Geel) | Harris Andrews (BL) | Dylan Grimes (Rich) |
|---|---|---|---|
| **HB:** | Bachar Houli (Rich) | Jeremy McGovern (WC) | Shannon Hurn (WC) (v.c) |
...
| **F:** | Jack Darling (WC) | Tom Hawkins (Geel) | Charlie Cameron (BL) |
| **Foll:** | Brodie Grundy (Coll) | Nat Fyfe (Frem) (capt) | Lachie Neale (BL) |
| **Int:** | Scott Pendlebury (Coll) | Elliot Yeo (WC) | Max Gawn (Melb) |
| Jack Macrae (WB) |   |   |   |
| **Coach:** | Damien Hardwick (Rich) |   |   |
...
| **HF:** | Robbie Gray (Port) | Lance Franklin (Syd) | Dayne Zorko (BL) |
| **F:** | Joe Daniher (Ess) | Josh Kennedy (WC) (v.c) | Eddie Betts (Adel) |
| **Foll:** | Paddy Ryder (Port) | Patrick Dangerfield (Geel) | Tom Mitchell (Haw) |
| **Int:** | Matt Crouch (Adel) | Elliot Yeo (WC) | Joel Selwood (Geel) |
| Dylan Shiel (GWS) |   |   |   |
| **Coach:** | Damien Hardwick (Rich) |   |   |

#### 2016

| **B:** | Dane Rampe (Syd) | Alex Rance (Rich) | Jeremy McGovern (WC) |
|---|---|---|---|
...
| **F:** | Eddie Betts (Adel) | Josh Kennedy (WC) | Tom Lynch (GC) |
...
| **C:** | Dan Hannebery (Syd) | Matt Priddis (WC) | Andrew Gaff (WC) |
| **HF:** | Chad Wingard (Port) | Jack Riewoldt (Rich) | Cyril Rioli (Haw) |
| **F:** | Eddie Betts (Adel) | Josh Kennedy (WC) (v.c) | Jake Stringer (WB) |
...
| **B:** | Matthew Scarlett (Geel) | Darren Glass (WC) | Corey Enright (Geel) |
|---|---|---|---|
...
| **Foll:** | Dean Cox (WC) | Chris Judd (Carl) (v.c) | Gary Ablett Jr. (GC) (capt) |
...
| **F:** | Barry Hall (WB) | Jack Riewoldt (Rich) | Mark LeCras (WC) |
...
| **Foll:** | Dean Cox (WC) | Chris Judd (Carl) (capt) | Gary Ablett Jr. (Geel) |
...
- With nine players selected, Geelong set a record for most players from one club in an All-Australian team, a record which stands to this day.
...
| **Foll:** | Brendon Lade (Port) | Chris Judd (WC) | Ben Cousins (WC) |
| **Int:** | Shaun Burgoyne (Port) | Dean Cox (WC) | James McDonald (Melb) |
| Matthew Pavlich (Frem) |   |   |   |
| **Coach:** | John Worsfold (WC) |   |   |

#### 2005

| **B:** | David Wirrpanda (WC) | Ben Rutten (Adel) | James Clement (Coll) |
|---|---|---|---|
| **HB:** | Joel Bowden (Rich) | Trent Croad (Haw) | Luke Hodge (Haw) |
| **C:** | Nick Dal Santo (St K) | Scott West (WB) | Lenny Hayes (St K) |
| **HF:** | Mark Ricciuto (Adel) (capt) | Matthew Pavlich (Frem) | Shannon Grant (Kang) |
| **F:** | Brad Johnson (WB) | Barry Hall (Syd) | Peter Everitt (Haw) |
| **Foll:** | Dean Cox (WC) | Luke Ball (St K) | Ben Cousins (WC) (v.c) |
...
| **B:** | Leo Barry (Syd) | Matthew Scarlett (Geel) | Chris Johnson (BL) |
|---|---|---|---|
| **HB:** | Austinn Jones (St K) | Chad Cornes (Port) | Adam McPhee (Ess) |
| **C:** | Chris Judd (WC) | Simon Black (BL) | Nigel Lappin (BL) |
| **HF:** | Jason Akermanis (BL) | Warren Tredrea (Port) (v.c) | Nick Riewoldt (St K) |
| **F:** | Barry Hall (Syd) | Fraser Gehrig (St K) | Luke Power (BL) |
| **Foll:** | Jeff White (Melb) | Mark Ricciuto (Adel) (capt) | Scott West (WB) |
| **Int:** | James Clement (Coll) | Chad Fletcher (WC) | Brett Kirk (Syd) |
| Matthew Lappin (Carl) |   |   |   |
...
|---|---|---|---|
| **HB:** | Rohan Smith (WB) | Justin Leppitsch (BL) | Nigel Lappin (BL) |
| **C:** | Lenny Hayes (St K) | Michael Voss (BL) (capt) | Paul Williams (Syd) |
| **HF:** | Matthew Pavlich (Frem) | Warren Tredrea (Port) | Mark Ricciuto (Adel) |
| **F:** | Phillip Matera (WC) | Matthew Lloyd (Ess) | Chris Tarrant (Coll) |
| **Foll:** | Adam Goodes (Syd) | Nathan Buckley (Coll) (v.c) | Peter Bell (Frem) |
| **Int:** | James Hird (Ess) | Michael Gardiner (WC) | Paul Hasleby (Frem) |
| Robert Harvey (St K) |   |   |   |
| **Coach:** | Leigh Matthews (BL) |   |   |

#### 2002

| **B:** | Chris Johnson (BL) | Matthew Pavlich (Frem) | Glenn Archer (Kang) |
|---|---|---|---|
| **HB:** | Brett Montgomery (Port) | Justin Leppitsch (BL) | Ben Hart (Adel) |
| **C:** | Jason Akermanis (BL) | Simon Black (BL) | Adem Yze (Melb) |
| **HF:** | Michael Voss (BL) (capt) | Warren Tredrea (Port) | Brad Johnson (WB) |
| **F:** | Nathan Brown (WB) | David Neitz (Melb) | Luke Darcy (WB) |
| **Foll:** | Matthew Primus (Port) (v.c) | Josh Francou (Port) | Ben Cousins (WC) |
| **Int:** | Shane Crawford (Haw) | Nigel Lappin (BL) | Mark Ricciuto (Adel) |
| Adam Simpson (Kang) |   |   |   |
| **Coach:** | Leigh Matthews (BL) |   |   |
...
| **C:** | Jason Akermanis (BL) | Brett Ratten (Carl) | Nathan Buckley (Coll) |
| **HF:** | Michael Voss (BL) (v.c) | Warren Tredrea (Port) | James Hird (Ess) (capt) |
| **F:** | Brad Ottens (Rich) | Matthew Lloyd (Ess) | Ben Cousins (WC) |
| **Foll:** | Matthew Primus (Port) | Simon Black (BL) | Andrew McLeod (Adel) |
...
| **B:** | Jason Akermanis (BL) | Justin Leppitsch (BL) | Ben Hart (Adel) |
|---|---|---|---|
| **HB:** | Byron Pickett (Kang) | Stephen Silvagni (Carl) | Andrew McKay (Carl) |
| **C:** | Brad Johnson (WB) | Nathan Buckley (Coll) (v.c) | Wayne Schwass (Syd) |
| **HF:** | Mark Mercuri (Ess) | Wayne Carey (Kang) (capt) | Michael Voss (BL) |
| **F:** | Ben Cousins (WC) | Matthew Lloyd (Ess) | Matthew Richardson (Rich) |
| **Foll:** | Matthew Allan (Carl) | Robert Harvey (St K) | Shane Crawford (Haw) |
| **Int:** | Peter Bell (Kang) | Nathan Burke (St K) | Wayne Campbell (Rich) |
| Chris Grant (WB) |   |   |   |
| **Coach:** | Denis Pagan (Kang) |   |   |
...
|---|---|---|---|
| **HB:** | Peter Matera (WC) | Michael Sexton (Carl) | Adam Heuskes (Port) |
| **C:** | Austinn Jones (St K) | Craig Bradley (Carl) | Nathan Buckley (Coll) |
| **HF:** | Rohan Smith (WB) | Chris Grant (WB) | Michael O'Loughlin (Syd) |
| **F:** | Fraser Gehrig (WC) | Tony Modra (Adel) | Paul Kelly (Syd) (capt) |
| **Foll:** | Paul Salmon (Haw) | Robert Harvey (St K) | Nathan Burke (St K) (v.c) |
...
|---|---|---|---|
| **HB:** | Nathan Buckley (Coll) | Paul Roos (Syd) | Peter Matera (WC) |
| **C:** | Chris Mainwaring (WC) | Paul Kelly (Syd) (capt) | Shane Crawford (Haw) |
| **HF:** | James Hird (Ess) | Wayne Carey (NM) (v.c) | Mitchell White (WC) |
| **F:** | Michael Voss (BB) | Tony Lockett (Syd) | Darren Jarman (Adel) |
| **Foll:** | Corey McKernan (NM) | Robert Harvey (St K) | Craig Lambert (BB) |
