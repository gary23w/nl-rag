...
- size: The bit-width of the constant (optional, but strongly recommended)
- base: The radix specifier - `b` (binary), `o` (octal), `d` (decimal), `h` (hexadecimal)
- value: The numeric value in the specified base

Examples:

- 16'h1A23 or 16'h1a23 – Hexadecimal 1A23 lower and upper case are allowed (using 16 bits)
...
The order of execution is not always guaranteed within Verilog. This can best be illustrated by a classic example. Consider the code snippet below:
