...
source: https://en.wikipedia.org/wiki/Combustion_chamber
...
combustion chamber (shown in yellow), located above the piston (orange) and valve (blue)

OHC engine

combustion chamber, located between the piston (shown in yellow) and the valves (blue and red)
...
- Indirect injection, where the fuel is injected into a swirl chamber or pre-combustion chamber. The fuel ignites as it is injected into this chamber and the burning air/fuel mixture spreads into the main combustion chamber.
