...
The first ground-based, ship-based and airborne AESA radars became operational in the mid 1990s.
...
- Defence Research and Development Organisation
  ...
  - Uttam AESA – Gallium Arsenide (GaAs) based multifunction radar for India's combat aircraft HAL Tejas
  - Virupaaksha – an advanced variant of Uttam AESA radar based on Gallium Nitride (GaN). To be used in air superiority fighter Su-30MKI
- Elta Systems
...
- Northrop Grumman
  ...
  - AN/APG-83, for the F-16V Viper and Rockwell B-1B Lancer upgrades.
  ...
  - AN/ZPY-1 STARLite Small Tactical Radar – Lightweight, for crewed and uncrewed aircraft
...
- NRIET (Nanjing Research Institute of Electronics Technology/14 institute), 607 institute, and 38 institute
  - Radar for KJ-2000 AEW&C system
...
- CEA Technologies
  - CEAFAR a 4th generation, S-Band multifunction digital active phased-array radar, installed on all of the Royal Australian Navy's Anzac class frigates, HMAS Choules, and the future Hunter-class frigates.
- China
...
- Raytheon
  ...
  - KuRFS
- Saab Group
  - GIRAFFE Radar: GIRAFFE 1X, GIRAFFE 4A, GIRAFFE 8A
- Selex ES
