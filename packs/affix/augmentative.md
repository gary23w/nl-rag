---
title: "Augmentative"
source: https://en.wikipedia.org/wiki/Augmentative
domain: affix
...
In Russian there is a variety of augmentatives formed with prefixes (including loans from Latin) and suffixes, including -ище and -ина for example: дом ('house') дом**ище** ('great house') дом**ина** ('huge house'). To provide an impression of excessive qualities the suffix -га can be used for example: ветер ('wind'), ветрю**га** ('strong wind').
...
- -urina, e.g. pti**c**a, f. ("bird") + urina → pti**č**urina
