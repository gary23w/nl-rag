...
- **Formosan**
  - **Tsouic** (abandoned in Blust 2013)
    - Tsou language
    - Saaroa language
    - Kanakanavu language
  - **Western Plains**
  ...
  - **East Formosan** (based on a single merger, of pAN *n and *j)
      ...
      - **Enemish** (additive 'five-and-one' or 'twice-three' replaced by reduplicated *Nem-Nem > *emnem [*Nem 'three' is reflected in Basay, Siraya and Makatao]; pAN *kawaS 'year, sky' replaced by *CawiN)
        ...
        - **Walu-Siwaish** (*walu 'eight' and *Siwa 'nine' from *RaCepat(e)lu 'five-and-three' and *RaCepiSepat 'five-and-four')
          ...
          - East WS (pEWS ca. 4500 BP) (innovations *baCaq-an 'ten'; *nanum 'water' alongside pAN *daNum)
            - Kavalanic languages
            - **Puluqish** (innovative *sa-puluq 'ten', from *sa- 'one' + 'separate, set aside'; use of prefixes *paka- and *maka- to mark abilitative)
...
A manuscript from the early 1800s using the
...
glyph, assumed to be the writing system of the
