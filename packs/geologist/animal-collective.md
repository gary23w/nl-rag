...
source: https://en.wikipedia.org/wiki/Animal_Collective
domain: geologist
...
|---|---|---|---|---|
| Primary albums |   |   |   |   |
| *Spirit They're Gone, Spirit They've Vanished* | (check)Y | (check)Y |   |   |
| *Danse Manatee* | (check)Y | (check)Y | (check)Y |   |
| *Hollinndagain* | (check)Y | (check)Y | (check)Y |   |
| *Campfire Songs* | (check)Y | (check)Y |   | (check)Y |
| *Here Comes the Indian* | (check)Y | (check)Y | (check)Y | (check)Y |
| *Sung Tongs* | (check)Y | (check)Y |   |   |
| *Feels* | (check)Y | (check)Y | (check)Y | (check)Y |
| *Strawberry Jam* | (check)Y | (check)Y | (check)Y | (check)Y |
| *Merriweather Post Pavilion* | (check)Y | (check)Y | (check)Y |   |
| *Oddsac* | (check)Y | (check)Y | (check)Y | (check)Y |
| *Centipede Hz* | (check)Y | (check)Y | (check)Y | (check)Y |
| *Painting With* | (check)Y | (check)Y | (check)Y |   |
| *Tangerine Reef* | (check)Y |   | (check)Y | (check)Y |
| *Time Skiffs* | (check)Y | (check)Y | (check)Y | (check)Y |
| *Isn't It Now?* | (check)Y | (check)Y | (check)Y | (check)Y |
| Soundtrack albums |   |   |   |   |
| *Crestone (Original Score)* |   |   | (check)Y | (check)Y |
| *The Inspection (Original Motion Picture Soundtrack)* | (check)Y | (check)Y | (check)Y | (check)Y |
| *Jetty (Original Motion Picture Soundtrack)* |   |   | (check)Y | (check)Y |
| Extended plays |   |   |   |   |
| *Prospect Hummer* | (check)Y | (check)Y | (check)Y | (check)Y |
| *People* | (check)Y | (check)Y | (check)Y | (check)Y |
| *Water Curses* | (check)Y | (check)Y | (check)Y | (check)Y |
| *Fall Be Kind* | (check)Y | (check)Y | (check)Y |   |
| *Keep + Animal Collective* | (check)Y | (check)Y | (check)Y | (check)Y |
| *Transverse Temporal Gyrus* | (check)Y | (check)Y | (check)Y | (check)Y |
| *Monkey Been to Burn Town* | (check)Y | (check)Y | (check)Y | (check)Y |
| *New Psycho Actives Vol. 1* | (check)Y |   | (check)Y |   |
| *The Painters* | (check)Y | (check)Y | (check)Y |   |
| *Meeting of the Waters* | (check)Y |   | (check)Y |   |
| *New Psycho Actives Vol. 2* | (check)Y |   | (check)Y |   |
| *Bridge to Quiet* | (check)Y | (check)Y | (check)Y | (check)Y |

1. Only appears on "Baleen Sample"
