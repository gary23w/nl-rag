...
Before installing Boto3, ensure you’re using Python 3.10 or later. For details on how to update your project from older versions of Python, see Migrating to Python 3.
