...
In November 2025, the Colorado Public Utilities Commission approved mandatory time-of-use (TOU) rates for all residential customers of Xcel Energy's Public Service Company of Colorado, effective November 1, 2025. Under the rate structure, electricity costs approximately $0.213 per kWh during peak hours (5–9 PM on weekdays) and $0.079 per kWh during off-peak hours — a ratio of approximately 2.7:1. Colorado became one of the first states to implement mandatory, rather than voluntary, residential TOU pricing for a major investor-owned utility statewide. The Colorado Public Utilities Commission cited grid demand reduction and the promotion of battery storage and electric vehicle charging during off-peak hours as primary policy goals.
