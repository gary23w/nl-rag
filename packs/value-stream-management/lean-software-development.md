...
Lean philosophy regards everything not adding value to the customer as waste (*muda*). The seven wastes mapped from manufacturing to software as described in the book Lean Software Development: An Agile Toolkit, Table 1.1:
