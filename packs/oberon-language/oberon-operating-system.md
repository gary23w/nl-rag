...
- (Oberon on a Tatung TWN-5213 CU tablet.) Oberon on a Tatung TWN-5213 CU tablet.
- (Oberon V5 RISC emulator on GNURoot Debian on Android on an Alcatel 9015B tablet with keyboard and mouse connected by Bluetooth.) Oberon V5 RISC emulator on GNURoot Debian on Android on an Alcatel 9015B tablet with keyboard and mouse connected by Bluetooth.
