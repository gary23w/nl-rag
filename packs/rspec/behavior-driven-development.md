...
- Writing this down in an unambiguous, precise way so that it can become executable specifications
...
A description of each specific

scenario

of the narrative with the following structure:
