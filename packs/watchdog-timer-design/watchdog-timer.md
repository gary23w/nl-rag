...
- Watchdog state diagrams
- (Unconditionally enabled watchdog) Unconditionally enabled watchdog
- (Watchdog with enable input signal) Watchdog with *enable* input signal
