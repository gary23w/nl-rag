...
Pujols is second in major league history in runs batted in and total bases behind only Hank Aaron. He and Aaron are the only two players to amass 3,000 hits, 700 home runs, and 2,200 RBIs. Only two other players (Stan Musial and Willie Mays) have surpassed 6,000 total bases. Pujols hit home runs off of a record 458 different pitchers over the course of his career, and is fourth in career home runs and fifth in doubles. In 2009, Pujols set the major league single-season record for assists by a first baseman with 185. In an age when seasons of 150+ strikeouts were the norm for sluggers, he never struck out 100 times in a season.
