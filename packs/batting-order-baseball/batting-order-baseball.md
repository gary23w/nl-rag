...
source: https://en.wikipedia.org/wiki/Batting_order_(baseball)
...
However, today's model for a leadoff hitter developed only gradually. An early "job description" for a leadoff hitter by baseball pioneer Henry Chadwick in 1867 advised only, "Let your first striker always be the coolest hand of the nine." By 1898, though, a *Sporting Life* article noted, "It is customary to have a small, active fellow who can hit, run and steal bases, and also worry a pitcher into a preliminary base on balls, as a leader in the list."
