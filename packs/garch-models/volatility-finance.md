...
source: https://en.wikipedia.org/wiki/Volatility_(finance)
domain: garch-models
...
$\sigma _{\text{annually}}=\sigma _{\text{daily}}{\sqrt {P}}.$

so

$\sigma _{\text{T}}=\sigma _{\text{daily}}{\sqrt {PT}}.$
...
One method of measuring volatility, often used by quant option trading firms, divides up volatility into two components: clean volatility - the amount of volatility caused standard events like daily transactions and general noise - and dirty volatility, the amount caused by specific events like earnings or policy announcements. For instance, a company like Microsoft would have clean volatility caused by people buying and selling on a daily basis but dirty (or event volatility) events like quarterly earnings or a possibly anti-trust announcement.
