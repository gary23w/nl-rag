...
However, the final form of the electron shell model still in use today for the number of electrons in shells was discovered in 1923 by Edmund Stoner, who introduced the principle that the *n*th shell was described by 2(*n*2). Seeing this in 1925, Wolfgang Pauli added a fourth quantum number, "spin", during the old quantum theory period of the Sommerfeld-Bohr Solar System atom to complete the modern electron shell theory.
...
Therefore, the K shell, which contains only an s subshell, can hold up to 2 electrons; the L shell, which contains an s and a p, can hold up to 2 + 6 = 8 electrons, and so forth; in general, the *n*th shell can hold up to 2*n*2 electrons.
...
| 57 | Lanthanum | 2, 8, 18, 18, 9, 2 | f-block groups |
| 58 | Cerium | 2, 8, 18, 19, 9, 2 | f-block groups |
| 59 | Praseodymium | 2, 8, 18, 21, 8, 2 | f-block groups |
| 60 | Neodymium | 2, 8, 18, 22, 8, 2 | f-block groups |
| 61 | Promethium | 2, 8, 18, 23, 8, 2 | f-block groups |
| 62 | Samarium | 2, 8, 18, 24, 8, 2 | f-block groups |
| 63 | Europium | 2, 8, 18, 25, 8, 2 | f-block groups |
| 64 | Gadolinium | 2, 8, 18, 25, 9, 2 | f-block groups |
| 65 | Terbium | 2, 8, 18, 27, 8, 2 | f-block groups |
| 66 | Dysprosium | 2, 8, 18, 28, 8, 2 | f-block groups |
| 67 | Holmium | 2, 8, 18, 29, 8, 2 | f-block groups |
| 68 | Erbium | 2, 8, 18, 30, 8, 2 | f-block groups |
| 69 | Thulium | 2, 8, 18, 31, 8, 2 | f-block groups |
| 70 | Ytterbium | 2, 8, 18, 32, 8, 2 | f-block groups |
...
| 89 | Actinium | 2, 8, 18, 32, 18, 9, 2 | f-block groups |
| 90 | Thorium | 2, 8, 18, 32, 18, 10, 2 | f-block groups |
| 91 | Protactinium | 2, 8, 18, 32, 20, 9, 2 | f-block groups |
| 92 | Uranium | 2, 8, 18, 32, 21, 9, 2 | f-block groups |
| 93 | Neptunium | 2, 8, 18, 32, 22, 9, 2 | f-block groups |
| 94 | Plutonium | 2, 8, 18, 32, 24, 8, 2 | f-block groups |
| 95 | Americium | 2, 8, 18, 32, 25, 8, 2 | f-block groups |
| 96 | Curium | 2, 8, 18, 32, 25, 9, 2 | f-block groups |
| 97 | Berkelium | 2, 8, 18, 32, 27, 8, 2 | f-block groups |
| 98 | Californium | 2, 8, 18, 32, 28, 8, 2 | f-block groups |
| 99 | Einsteinium | 2, 8, 18, 32, 29, 8, 2 | f-block groups |
| 100 | Fermium | 2, 8, 18, 32, 30, 8, 2 | f-block groups |
| 101 | Mendelevium | 2, 8, 18, 32, 31, 8, 2 | f-block groups |
| 102 | Nobelium | 2, 8, 18, 32, 32, 8, 2 | f-block groups |
