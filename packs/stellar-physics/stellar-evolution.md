...
The evolutionary tracks of

stars

with different initial masses on the

Hertzsprung–Russell diagram

. The tracks start once the star has evolved to the
...
stops (for massive stars) and at the end of the
...
A yellow track is shown for the
...
, which will be the last phase in which the Sun undergoes fusion.
