...
| G2 | 01.00 | 001.00 | 000,001.00 | 05,780 | **Sun** |
...
where *M* and *L* are the mass and luminosity of the star, respectively, $M_{\bigodot }$ is a solar mass, $L_{\bigodot }$ is the solar luminosity and $\tau _{\text{MS}}$ is the star's estimated main-sequence lifetime.
