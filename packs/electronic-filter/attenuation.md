---
title: "Attenuation"
source: https://en.wikipedia.org/wiki/Attenuation
...
| Material | $\alpha {\text{ }}\left[{\frac {\text{dB}}{{\text{MHz}}{\cdot }{\text{cm}}}}\right]$ |
|---|---|
| Air, at 20 °C | 1.64 |
| Blood | 0.2 |
| Bone, cortical | 6.9 |
...
where $P_{1}$ is the input power into a 100 m long cable terminated with the nominal value of its characteristic impedance, and $P_{2}$ is the output power at the far end of this cable.
