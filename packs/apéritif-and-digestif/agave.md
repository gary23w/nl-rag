---
title: "Agave"
source: https://en.wikipedia.org/wiki/Agave
domain: apéritif-and-digestif
license: CC-BY-SA-4.0
tags: apéritif and digestif
fetched: 2026-07-08
---
...
In other regions, it goes by different names. In the Chinese, Japanese, and Korean languages, it is referred to as the compound word *dragon tongue orchid* (simplified Chinese: 龙舌兰; traditional Chinese: 龍舌蘭; pinyin: *lóngshélán*; Japanese: 竜舌蘭, romanized: *ryūzetsuran*; Korean: 용설란; Hanja: 龍舌蘭; RR: *yongseollan*).
...
- (Agave americana var. americana)*Agave americana* var. *americana*
- (Variegated Century Plant -- Agave americana 'Marginata')Variegated Century Plant -- *Agave americana* 'Marginata'
- (Agave americana 'Marginata')*Agave americana* 'Marginata'
- (Agave americana cv. 'Mediopicta Alba')*Agave americana* cv. 'Mediopicta Alba'
- (Agave angustifolia 'Marginata')*Agave angustifolia* 'Marginata'
- (Agave angustifolia (flowering))*Agave angustifolia* (flowering)
- (Agave attenuata)*Agave attenuata*
- (Agave bracteosa (spider agave))*Agave bracteosa* (spider agave)
- (Agave deserti)*Agave deserti*
- (Agave filifera)*Agave filifera*
- (Agave inaequidens ssp. barrancensis)*Agave inaequidens* ssp. *barrancensis*
- (Agave lechuguilla)*Agave lechuguilla*
- (Agave lophantha)*Agave lophantha*
- (Agave palmeri)*Agave palmeri*
- (Agave parrasana (syn. Agave wislizeni subsp. parrasana))*Agave parrasana* (syn. *Agave wislizeni* subsp. *parrasana*)
- (Agave parryi)*Agave parryi*
- (Agave potatorum cv. 'Kichiokan')*Agave potatorum* cv. 'Kichiokan'
- (Agave salmiana)*Agave salmiana*
- (Agave salmiana var. ferox)*Agave salmiana* var. *ferox*
- (Agave schidigera cv. 'Durango Delight')*Agave schidigera* cv. 'Durango Delight'
- (Agave shawii)*Agave shawii*
- (Agave sisalana (sisal))*Agave sisalana* (sisal)
- (Agave sisalana (flowers))*Agave sisalana* (flowers)
- (Agave stricta)*Agave stricta*
- (Agave tequilana)*Agave tequilana*
- (Agave tequilana 'Weber's Azul' (tequila agave))*Agave tequilana* 'Weber's Azul' (tequila agave)
- (Agave utahensis)*Agave utahensis*
- (Agave victoriae-reginae)*Agave victoriae-reginae*
- (Agave vilmoriniana)*Agave vilmoriniana*
- (Agave xylonacantha)*Agave xylonacantha*
- (Agave dussiana)Agave dussiana
