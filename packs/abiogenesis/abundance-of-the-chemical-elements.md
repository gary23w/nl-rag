...
Abundance of each element is expressed as a relative number. Astronomy uses a logarithmic scale for abundance $\epsilon _{X}$ of element X relative to hydrogen, defined by $\epsilon _{X}\equiv \log(N_{X}/N_{H})+12.00$ for number density N ; $\epsilon _{H}=12.00$ on this scale. Another scale is mass fraction or, equivalently, percent by mass.
...
The mass of the Earth is approximately 5.97×1024 kg. By mass, it is composed mostly of iron (32.1%), oxygen (30.1%), silicon (15.1%), magnesium (13.9%), sulfur (2.9%), nickel (1.8%), calcium (1.5%), and aluminium (1.4%); with the remaining 1.2% consisting of trace amounts of other elements. The amount of oxygen, silicon, sulfur, carbon, and hydrogen in the Earth's core can only be inferred from theoretical models and consequently the abundance of these elements in the total Earth is not known precisely.
...
| Atomic number | Name | Symbol | Mass fraction (ppm) | Atomic fraction (ppb) |
|---|---|---|---|---|
