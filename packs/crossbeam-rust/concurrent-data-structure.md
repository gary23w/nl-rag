---
title: "Concurrent data structure"
source: https://en.wikipedia.org/wiki/Concurrent_data_structure
...
.NET have ConcurrentDictionary, ConcurrentQueue and ConcurrentStack in the System.Collections.Concurrent namespace.

(UML class diagram of System.Collections.Concurrent in .NET)

## Rust

Rust instead wraps data structures in Arc and Mutex.
