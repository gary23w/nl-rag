...
- `recursive_version_locations` - when set to ‘true’, revision files are searched recursively in each “version_locations” directory. Added in version 1.10.
