...
The constant words spell "expand 32-byte k" in ASCII (i.e. the 4 words are "expa", "nd 3", "2-by", and "te k") as a nothing-up-my-sleeve number. The core operation in Salsa20 is the quarter-round `QR(a, b, c, d)` that takes a four-word input and produces a four-word output:
...
Adiantum (cipher) uses XChaCha12.
