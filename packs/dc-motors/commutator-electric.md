...
This consists of a block of wood or ebonite with four wells, containing mercury, which are cross connected by copper wires. The output is taken from a pair of curved copper wires which are moved to dip into one or other pair of mercury wells. Instead of mercury, ionic liquids or other liquid metals such as galinstan can be used.
