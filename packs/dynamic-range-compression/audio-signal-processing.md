...
source: https://en.wikipedia.org/wiki/Audio_signal_processing
domain: dynamic-range-compression
...
Musicians, audio engineers and record producers use effects units during live performances or in the recording studio, typically with electric guitar, bass guitar, electronic keyboard or electric piano. While effects are most frequently used with electric or electronic instruments, they can be used with any audio source, such as acoustic instruments, drums, and vocals.
