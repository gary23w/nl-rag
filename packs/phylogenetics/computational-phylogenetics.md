...
source: https://en.wikipedia.org/wiki/Computational_phylogenetics
...
The UPGMA (**U**nweighted **P**air **G**roup **M**ethod with **A**rithmetic Mean) and WPGMA (***W**eighted **P**air **G**roup **M**ethod with **A**rithmetic Mean*) methods produce rooted trees and require a constant-rate assumption - that is, it assumes an ultrametric tree in which the distances from the root to every branch tip are equal.
