---
title: "Flow control (data)"
source: https://en.wikipedia.org/wiki/Flow_control_(data)
...
Error free: ${\frac {1}{2a+1}}$ .

With errors: ${\frac {1-P}{2a+1}}$ .

### Selective repeat

We define throughput T as the average number of blocks communicated per transmitted block. It is more convenient to calculate the average number of transmissions necessary to communicate a block, a quantity we denote by 0, and then to determine T from the equation $T={\frac {1}{b}}$ .
...
Conversely, XON / XOFF is usually referred to as software flow control, and uses the characters 0x11 and 0x13 hexadecimal.
