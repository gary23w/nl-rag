...
Although the terms 3D printing and additive manufacturing can both be seen as the same thing, some standards organizitons make a distinction between them. The American National Standards Institute (ANSI) says that international standards such as IS0/ASTM 52900 define additive manufacturing as the process of building parts from 3D model data and adding material layer by layer. In comparison, 3D printing is described as creating objects by depositing material through a print head or some variation of a nozzle type of device. In industrial and technical settings, additive manufacturing is often the preferred term, and 3D printing is used more by the general public.
...
In 1983, Robert Howard started R.H. Research (later named Howtek, Inc. in February 1984) to develop Pixelmaster, a color inkjet 2D printer using Thermoplastic (hot-melt) plastic ink, which was commercialized in 1986. A team was put together, 6 members from Exxon Office Systems, Danbury Systems Division, an inkjet printer startup and some members of Howtek, Inc group who became popular figures in the 3D printing industry. One Howtek member was Richard Helinski, responsible for patent US5136515A ("Method and Means for constructing three-dimensional articles by particle deposition", application 7 November 1989 granted 4 August 1992). He formed C.A.D-Cast, Inc (later renamed to Visual Impact Corporation (VIC) on 22 August 1991), a New Hampshire company. The company's prototype VIC 3D printer is available with a video presentation showing a 3D model printed with a single nozzle inkjet. Another employee, Herbert Menhennett, formed HM Research, a New Hampshire company, in 1991 and introduced the Howtek, Inc, inkjet technology and thermoplastic materials to Royden Sanders of SDI and Bill Masters of Ballistic Particle Manufacturing (BPM), where he worked for a number of years. Both BPM 3D printers and SPI 3D printers use Howtek, Inc style Inkjets and materials. James K. McMahon, who was hired by Howtek, Inc to help develop the inkjet, later worked at Sanders Prototype and now operates Layer Grown Model Technology, a 3D service provider specializing in Howtek single nozzle inkjet and SDI printer support. McMahon worked with Steven Zoltan, inventor of the 1972 drop-on-demand inkjet at Exxon and holder of a 1978 patent that expanded the understanding of the single nozzle design inkjets (Alpha jets), to help perfect the Howtek, Inc hot-melt inkjets. This Howtek hot-melt thermoplastic technology is popular with metal investment casting, especially in the 3D printing jewelry industry. Royden Sanders licensed the Helinksi patent prior to manufacturing the Modelmaker 6 Pro at Sanders prototype, Inc (SPI) in 1993. The first customer of the Modelmaker 6Pro was Hitchner Corporations, Metal Casting Technology, Inc in Milford, New Hampshire, a mile from the SDI facility in late 1993–1995 casting golf clubs and auto engine parts.
...
In October 2025, the North Bristol NHS Trust reported that a UK cyclist named Dave Richards had received a full-face 3D-printed prosthesis, created at the newly opened Bristol 3D Medical Center at North Bristol NHS Trust. Led by senior reconstructive scientist Amy Davey, the process used advanced scanning and medical-grade resins to replicate his facial features after severe burns. It marked a milestone in integrated medical 3D-printing facilities in the UK.
...
Some additive manufacturing techniques can benefit from annealing as a post-processing step. Annealing a 3D-printed part allows for better internal layer bonding due to recrystallization of the part. It allows for an increase in mechanical properties, some of which are fracture toughness, flexural strength, impact resistance, and heat resistance. Annealing a component may not be suitable for applications where dimensional accuracy is required, as it can introduce warpage or shrinkage due to heating and cooling. Some additively manufactured parts—especially parts that are mission critical—are post-processed with hot isostatic pressing to improve the density and to configure the microstructure to get the required mechanical performance of the printed parts.
