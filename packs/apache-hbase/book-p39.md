---
title: "Apache HBase® Reference Guide (part 39/41)"
...
- NONE This compression type constant selects no compression, and is the default.
...
Figure 19. ColumnFamily with No Encoding

Here is the same data with prefix data encoding.

Figure 20. ColumnFamily with Prefix Encoding
...
Figure 21. ColumnFamily with Diff Encoding
...
|   | The Snappy and Hadoop libraries need to be available on each node of your cluster. See compression.test to find out how to test that this is the case. See hbase.regionserver.codecs to configure your RegionServers to fail to start if a given compressor is not available. |
|---|---|
