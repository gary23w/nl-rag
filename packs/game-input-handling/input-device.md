...
A keyboard placing design emphasis on
...
A layer placed over a

computer screen

, used by physically touching it with one's finger or a stylus.
...
is used, often to draw images or capture signatures.

- (Mouse)Mouse
- (Digitizer mouse)Digitizer mouse
- (A large-format graphic tablet by manufacturer Summagraphics (OEM'd to Gerber): The puck's external copper coil can be clearly seen. Note using of a Digitizer mouse with a magnifying glass.)A large-format graphic tablet by manufacturer Summagraphics (OEM'd to Gerber): The puck's external copper coil can be clearly seen. Note using of a Digitizer mouse with a magnifying glass.
- (Touchpad (or trackpad))Touchpad (or trackpad)
...
Similar to a compass, a magnetometer senses magnetic
...
- (An infrared proximity sensor used in a smartphone allows it to turn off its screen when held up to the user's ear.)An infrared proximity sensor used in a smartphone allows it to turn off its screen when held up to the user's ear.
...
A paddle could be a game controller consisting of a dial and a button, or an input device such as a
...
video game console which integrates an
...
- (Gamepad (or joypad))Gamepad (or joypad)
- (Paddle (game controller))Paddle (game controller)
- (Jog dial/shuttle (or knob))Jog dial/shuttle (or knob)
