...
source: https://en.wikipedia.org/wiki/Open-source_artificial_intelligence
domain: llama-model
...
The debate over what should count as ‘open-source’ given a range of openness among AI projects has been significant. Some large language models touted as open-sourced that are merely open-weights and do not release training data and code have been criticized as "openwashing" systems that are mostly closed.
