---
title: "Bow (watercraft)"
source: https://en.wikipedia.org/wiki/Bow_(watercraft)
domain: ship-motions
...
- (Straight-stem bow) Straight-stem bow
- (Plumb bow) Plumb bow
- (Raked bow) Raked bow
- (Flared bow) Flared bow
- (Clipper bow) Clipper bow
- (Bulbous bow) Bulbous bow
- (Inverted bow) Inverted bow
- (Ram bow) Ram bow
- (High-chin spoon bow) High-chin spoon bow
- (Low-chin spoon bow) Low-chin spoon bow
...
The "prow" (French: *proue*, Latin: *prora*) is the foremost part of a ship's bow above the waterline. The terms *prow* and "bow" are often used interchangeably to describe the foremost part of a ship and its surrounding parts.
