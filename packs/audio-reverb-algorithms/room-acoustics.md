...
source: https://en.wikipedia.org/wiki/Room_acoustics
...
$f_{m,n,l}={\frac {c}{2}}{\sqrt {{\Big (}{\frac {m}{L_{x}}}{\Big )}^{2}+{\Big (}{\frac {n}{L_{y}}}{\Big )}^{2}+{\Big (}{\frac {l}{L_{z}}}{\Big )}^{2}}}$ $p_{m,n,l}(x,y,z)=A\cos {\Big (}{\frac {m\pi }{L_{x}}}x{\Big )}\cos {\Big (}{\frac {n\pi }{L_{y}}}y{\Big )}\cos {\Big (}{\frac {l\pi }{L_{z}}}z{\Big )}$
