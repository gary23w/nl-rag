...
Drizzle operates natively through industry-standard database drivers. We support all major **PostgreSQL**, **MySQL**, **SQLite**, **SingleStore**, **MSSQL** or **CockroachDB** drivers out there, and we’re adding new ones **really fast**.
...
Now go build something awesome with Drizzle and your **PostgreSQL**, **MySQL**, **SQLite**, **MSSQL** or **CockroachDB** database. 🚀
