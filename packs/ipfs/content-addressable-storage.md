...
source: https://en.wikipedia.org/wiki/Content-addressable_storage
domain: ipfs
...
- Snix: a content addressable storage based upon the concepts and inner workings of the Nix (package manager).
- Bazel: a distributed build system. When using remote execution, source files and artifacts are stored in a CAS.
