---
title: "Chart"
source: https://en.wikipedia.org/wiki/Chart
...
- (Open-high-low-close chart)Open-high-low-close chart
- (Candlestick chart)Candlestick chart
- (Kagi chart)Kagi chart
- (Sparkline)Sparkline
...
- (Greninger chart)Greninger chart
- (Heatmap)Heatmap
...
- (Box plot)Box plot
- (Dot plot (statistics))Dot plot (statistics)
