...
*Boolean monotonic theories* are a class of theory that support efficient theory propagation and conflict analysis, enabling practical use within DPLL(T) solvers. Monotonic theories support only Boolean variables (Boolean is the only *sort*), and all their functions and predicates p obey the axiom
...
, linear integer and rational arithmetic, non-linear arithmetic,
...
, linear arithmetic, arrays, tuples, types, records, bitvectors,
...
rational and integer linear arithmetic, arrays, tuples, records, inductive data types, bitvectors, finite fields, strings, sequences, bags, and equality over uninterpreted function symbols
...
, differences, linear arithmetic, bitvectors
...
Can implement new theories using
...
, linear arithmetic, bitvectors, and constrained lambda (arrays, memories, cache, etc.)

no

SAT-solver based, written in

Moscow ML

. Input language is SMV model checker. Well-documented!
...
, rational and integer linear arithmetics, quantifiers, and equality over uninterpreted function symbols
...
, linear arithmetic, nonlinear arithmetic, bitvectors, arrays, datatypes,
...
- Atelier-B can use Alt-Ergo instead of its main prover (increasing success from 84% to 98% on the ANR Bware project benchmarks Archived 2014-11-29 at the Wayback Machine);
