...
| ${\frac {\Gamma \vdash M:\forall \alpha .\sigma }{\Gamma \vdash M\tau :\sigma [\tau /\alpha ]}}$ (1) | ${\frac {\Gamma ,\alpha ~{\text{type}}\vdash M:\sigma }{\Gamma \vdash \Lambda \alpha .M:\forall \alpha .\sigma }}$ (2) |
|---|---|
