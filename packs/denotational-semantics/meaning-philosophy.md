...
source: https://en.wikipedia.org/wiki/Meaning_(philosophy)
...
In philosophy, **meaning** is "a relationship between two sorts of things: signs and the kinds of things they intend, express, or signify". It is studied in the fields of semantics and philosophy of language.

Meanings can be categorised in relation to the types of things being represented. Some examples include:

- things, which might have meaning;
