---
title: "Modified-release dosage"
source: https://en.wikipedia.org/wiki/Controlled_release
...
The terminology used in modified-release formulations is not standardized, which can be cause for confusion, misreading and prescription errors. Common terminology is summarized in the table below.
...
1. Not to be confused with ES, or *Extra Strength*.
2. Not to be confused with SA for *Short-Acting*.
3. Not to be confused with XS, or *Extra Strength*.
