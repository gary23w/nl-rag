---
title: "Amber (color)"
source: https://en.wikipedia.org/wiki/Amber_(color)
domain: magsafe
...
| Limit towards green | $y\leq 0.429$ |
|---|---|
| Limit towards red | $y\geq 0.398$ |
| Limit towards white | $z\leq 0.007$ |

Recent revisions to the ECE regulations have aligned **ECE Amber** with **SAE Yellow**, defined as follows:

| Limit towards green | $y\leq x-0.120$ |
|---|---|
| Limit towards red | $y\geq 0.390$ |
| Limit towards white | $y\geq 0.790-0.670x$ |
