---
title: "Agglutination"
source: https://en.wikipedia.org/wiki/Agglutination
domain: anindilyakwa-language
license: CC-BY-SA-4.0
tags: anindilyakwa language
fetched: 2026-07-05
---
...
Dravidian languages are agglutinative. For example, in Tamil, the word "அதைப்பண்ணமுடியாதவர்களுக்காகவும்" (*ataippaṇṇamuṭiyātavarkaḷukkākavum*) means "and for the sake of those who cannot do that", composed of the morphemes அது (*atu*, "that") + -ஐ (*-ai*, accusative marker) + பண்ணு (*paṇṇu*, "to do") + -அ (*-a*, infinitive ending) + முடி (*muṭi*, "to be possible") + -ஆத- (*-āta-*, negation marker) + அவர் (*avar*, "he") + -கள் (*-kaḷ*, plural marker) + -உக்கு (*-ukku*, dative marker) + ஆகு (*āku*, "to become", in this case "for the sake of") + -அ (*-a*, infinitive ending) + -உம் (*-um*, "and"). Another example is verb conjugation. In all Dravidian languages, verbal markers are used to convey tense and mood, and usually person (though Malayalam is an exception to the latter). For example, in Tamil, "சாப்பிடுகிறேன்" (*cāppiṭukiṟēṉ*, "I eat") is formed from the verb root சாப்பிடு- (*cāppiṭu-*, "to eat") + the present tense marker -கிற்- (*-kiṟ-*) + the first-person singular suffix -ஏன் (*-ēṉ*).
...
1. honorific: *-(u)si* ((으)시) is used when the speaker is honouring the subject of the sentence
2. tense: *-(e)ss* (었) for completed (past) action or state; when this slot is empty, the tense is interpreted as present (The 'ss' is pronounced as 't' if it is placed behind a consonant. For example, -었어(ess-e) is pronounced as (esse), but -었다(ess-ta) is pronounced as (etta). Note that the same rule applies to all instances of the 'ss' ending.)
3. experiential-contrastive aspect: *-(e)ss* (었) doubling the past tense marker means "the subject has had the experience described by the verb"
4. modal: *-keyss* (겠) is used with first-person-subjects only for definite future and with second-or-third-person-subjects also for probable present or past
5. formal: *-(u)pni* ((으)ㅂ니) expresses politeness to the hearer
6. retrospective aspect: *-te*; (더) indicates that the speaker recollects what he observed in the past and reports in the present situation
7. mood: *-ta* (다) for declarative, *-kka* (까) for interrogative, *-la* (라) for imperative, *-ca* (자) for propositive, *-yo* (요) for polite declarative and a large number of other possible mood markers
...
- 7 (imperative mood marker): imperative suffix *-la* (라) combines with the root *ka-* (가) to express imperative: *ka-la* (가라) 'Go!'
- 7 (propositive mood marker): if we want to express proposition rather than command, the propositive mood marker is used: *-ja* (자) instead of *-ra* (라): *ka-ca* (가자) 'Let's go!'
- 5 and 7: If the speaker wants to show respect for the hearer, he uses the politeness marker *-(u)pni* ((으)ㅂ니) (in slot 5); various mood markers may be simultaneously used (in slot 7, therefore after the politeness marker): *ka-pni-ta* (갑니다) 'He is going.' *ka-pni-kka?* (갑니까) 'Is he going?'
- 6: retrospective aspect: *Con-i cip-ey ka-te-la* (존이 집에 가더라) 'I observed that John was going home and now I am reporting that to you.'
- 7: simple indicative: *sensayng-nim-i cip-ey ka-n-ta* (선생님이 집에 간다) 'The teacher is going home. (not expressing respect or politeness)'
- 5 and 7: politeness towards the hearer: *sensayng-nim-i cip-ey ka-pni-ta* (선생님이 집에 갑니다) or *sensayng-nim-i cip-ey ka-yo* (선생님이 집에 가요) 'The teacher is going home.',
- 1 and 7: respect towards the subject: *sensayng-nim-i cip-ey ka-si-n-ta* (선생님이 집에 가신다) 'The (respected) teacher is going home.'
- 1, 5 and 7: two kinds of politeness in one sentence: *sensayng-nim-i cip-e ka-si-e-yo* (선생님이 집에 가셔요) or *sensayng-nim-i cip-ey ka-si-pni-ta* (선생님이 집에 가십니다) 'The teacher is going home. (expressing respect both to the hearer and the teacher)'
- 2, 3 and 7: past forms: *Con-i hakkyo-ey ka-ss-ta* (존이 학교에 갔다) 'John has gone to school (and is there now).' *Con-i hakkyo-ey ka-ss-ess-ta* (존이 학교에 갔었다) 'John has been to school (and has come back).'
- 4 and 7: first person modal: *nay-ka nayil ka-keyss-ta* (내가 내일 가겠다) 'I will go tomorrow.'
- 4 and 7: third person modal: *Con-i nayil ka-keyss-ta* (존이 내일 가겠다) 'I suppose that John will go tomorrow.' *Con-i ecey ka-ss-keyss-ta* (존이 어제 갔겠다) 'I suppose that John left yesterday.'
...
| *m-toto a-li-fika* 'The child arrived.' *m-toto a-ta-fika* 'The child will arrive.' *wa-toto wa-li-fika* 'The children arrived.' *wa-toto wa-ta-fika* 'The children will arrive.' | *m-tu a-li-lala* 'The person slept.' *m-tu a-ta-lala* 'The person will sleep.' *wa-tu wa-li-lala* 'The persons slept.' *wa-tu wa-ta-lala* 'The persons will sleep.' | *ki-tabu ki-li-anguka* 'The book fell.' *ki-tabu ki-ta-anguka* 'The book will fall.' *vi-tabu vi-li-anguka* 'The books fell.' *vi-tabu vi-ta-anguka* 'The books will fall.' |   |
|---|---|---|---|
...
|---|---|---|
| *talo-n* 'of the house' | *märä-n paida-n* 'of a wet shirt' | consonant gradation: the genitive suffix *-n* closes the preceding syllable;           *rk → r, t → d* |
| *talo-ssa* 'in the house' | *märä-ssä paida-ssa* 'in a wet shirt' | vowel harmony: a word containing *ä* may not contain the vowels *a, o, u*;           an allomorph of the inessive ending *-ssa/ssä* is used |
