---
title: "Aerosol"
source: https://en.wikipedia.org/wiki/Aerodynamic_diameter
...
In everyday language, *aerosol* often refers to a dispensing system that delivers a consumer product from a spray can. Other examples of human caused aerosols include perfume from atomizers, medical treatments for respiratory illnesses, dust from material or industrial sources, smoke, irrigation mist, sprayed pesticides, particulate air pollutants, and mist from the discharge at hydroelectric dams.

Human-made sulfate aerosols, primarily from burning oil and coal, affect the behavior of clouds. When aerosols absorb pollutants, it facilitates the deposition of pollutants to the surface of the earth as well as to bodies of water. This has the potential to be damaging to both the environment and human health.
...
Although all hydrometeors, solid and liquid, can be described as aerosols, a distinction is commonly made between such dispersions (i.e. clouds and precipitation) containing relatively large water drops or ice crystals, and aerosol particles. The atmosphere of Earth contains aerosols of various types and concentrations, including quantities of:
...
= standard particle density (1000
...
where $p_{s}$ is the saturation vapor pressure above a particle at equilibrium (around a curved liquid droplet), *p*0 is the saturation vapor pressure (flat surface of the same liquid) and *S* is the saturation ratio.
