...
source: https://en.wikipedia.org/wiki/Acute_radiation_syndrome
...
Usually, matter attenuates radiation, so placing any mass (for instance, lead, dirt, sandbags, vehicles, water, even air) between humans and the source will reduce the radiation dose. This is not always the case, however; care should be taken when constructing shielding for a specific purpose. For example, although high atomic number materials are very effective in shielding photons, using them to shield beta particles may cause higher radiation exposure due to the production of bremsstrahlung x-rays, and hence low atomic number materials are recommended. Also, using material with a high neutron activation cross section to shield neutrons will result in the shielding material itself becoming radioactive and hence more dangerous than if it were not present.
...
| Alvin C. Graves | 1.9 Gy | Survived |   |   |
...
| April 26, 1986 | Andrei Tormozin | 8.7 Gy | Chernobyl disaster | Survived |
| September 30, 1999 | Hisashi Ouchi | 17 Gy | Tokaimura nuclear accident | Death in 83 days |
| Masato Shinohara | 10 Gy | Death in 210 days |   |   |
