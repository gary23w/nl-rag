...
source: https://en.wikipedia.org/wiki/AMI_Aptio
...
AMI's UEFI firmware solutions. Aptio V is AMI's current main UEFI firmware product. Aptio Community Edition is an open source UEFI firmware product. Aptio 4 is a now-discontinued previous version that has been succeeded by Aptio V. Aptio is usually used by the PC and server type devices.
