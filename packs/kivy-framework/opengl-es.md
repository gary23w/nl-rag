...
The API is cross-language and multi-platform. OpenGL ES is managed by the non-profit technology consortium Khronos Group. Vulkan, a next-generation API from Khronos, is made for simpler high performance drivers for mobile and desktop devices.
...
| OES_framebuffer_object | OpenGL ES Extension #10 (became core in ES 2.0) |
...
| OES_texture_3D | OpenGL ES Extension #34 (became core in ES 3.0) |
...
| OES_vertex_array_object | OpenGL ES Extension #71 (became core in ES 3.0) |
...
OpenGL ES (and OpenGL) was deprecated in Apple's operating systems in favour of its own proprietary Metal graphics API, but still worked in up to at least iOS 12.
