...
where $T_{1}$ and $T_{2}$ are tensions in the tight side and slack side of the belt respectively. They are related as

${\frac {T_{1}}{T_{2}}}=e^{\mu \alpha },$

where $\mu$ is the coefficient of friction, and $\alpha$ is the angle (in radians) subtended by contact surface at the centre of the pulley.

### Power transmission loss form

| Belt type | Power loss |
|---|---|
...
Belts used for rolling roads for wind tunnels can be capable of 250 km/h (160 mph).
