...
source: https://docs.adonisjs.com/guides/preface/introduction
domain: adonisjs-node
...
Understand AdonisJS's approach to frontend development and choose between Hypermedia, Inertia, and API-only stacks for your application.
