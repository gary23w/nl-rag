...
Photographs are now created using a smartphone or camera, which uses a lens to focus the scene's visible wavelengths of light into a reproduction of what the human eye would perceive.
...
The word can refer either to the physical print—like a lithograph, serigraph, or photograph—or to the event itself, as in "she took a photograph", even before the image has been printed or viewed.
...
The first "selfie", or self-portrait, was taken by Robert Cornelious back in 1839. "Selfies" have become one of the most common photographs.
