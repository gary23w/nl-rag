...
source: https://en.wikipedia.org/wiki/Acrobatic_gymnastics
...
Penalties are deducted from the final score. Penalties include too large height differences (30 centimetres (12 in) or larger) between both gymnasts in a pair or between any gymnast and the next tallest one in a group, gymnasts leaving the floor boundary or going over the exercise time limit, balance elements not being held for long enough, or elements being performed out of the declared order.
