...
The transmission of electronic mail from the sender's computer and between mail hosts in the Internet uses the Simple Mail Transfer Protocol (SMTP), defined in RFC 5321 and 5322, and extensions such as RFC 6531. The mailboxes may be accessed and managed by applications on personal computers, mobile devices or webmail sites using the SMTP protocol and either the Post Office Protocol (POP) or the Internet Message Access Protocol (IMAP).
