...
source: https://en.wikipedia.org/wiki/Car_body_style
...
Type of SUV with a sloping roofline similar to fastback cars, That is often adopted to offer a styling advantage compared to standard SUVs. Manufacturers often sell them as more premium models than their standard SUV counterparts.

### Crossover/crossover SUV/crossover utility vehicle (CUV)

Vehicle with a higher ground clearence and larger space, That is built in a unibody platform shared with standard cars. Originally a North American term used for vehicles that blend characteristics between two types, it evolved to be a term for SUVs built in a unibody chassis, Even though the term SUV is used to refer both to crossovers and standard SUVs due to their visual similarities.
...
A vehicle that combines characteristics and styling of a sedan with a higher ground clearance, Similar to a crossover.

### Kammback / kamm tail / K-tail

A Kammback is a car where the rear slopes downwards before being abruptly cut off with a vertical or near vertical surface. This reduces the aerodynamic drag, improving the efficiency, while the stil keeping its traditional shape.

### Liftback

Variant of a hatchback where the roof line and the rear cargo door are more horizontal than vertical.
...
Car with a distinct rear section, With the back of the passenger compartment being in an angle to the top of what is generally the baggage compartment.
...
Has two rows of raised seats, similar to horse-drawn carriages; usually did not have front doors, a roof, or a windshield. The baquet ("bathtub") style was produced in the early 1900s in Europe.
