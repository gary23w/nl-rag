---
title: "Poincaré map"
source: https://en.wikipedia.org/wiki/Poincar%C3%A9_map
...
Given an open and connected neighborhood $U\subset S$ of *p*, a function
...
The flow of the system can be obtained by integrating the equation: for the $\theta$ component we simply have $\theta (t)=\theta _{0}+t$ while for the r component we need to separate the variables and integrate:
