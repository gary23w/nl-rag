...
source: https://en.wikipedia.org/wiki/Layer_2_Tunneling_Protocol
...
sequence number for expected message to be received. Nr is set to the Ns of the last in-order message received plus one (modulo 2
