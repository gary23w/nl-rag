...
source: https://en.wikipedia.org/wiki/Capacitive_displacement_sensor
...
$C={\dfrac {\varepsilon _{0}\varepsilon _{r}A}{d}}$

where $\varepsilon _{0}$ is the permittivity of free space constant and *$\varepsilon _{r}$* is the relative permittivity (also called the dielectric constant) of the material in the gap.
