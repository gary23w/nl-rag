...
source: https://en.wikipedia.org/wiki/FIX_protocol
...
The body length is the character count starting at tag 35 (included) all the way to tag 10 (excluded), including trailing SOH delimiters. The example below (displayed with SOH delimiters as '|') has a body length of 65:
