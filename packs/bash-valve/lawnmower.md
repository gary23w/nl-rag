---
title: "Lawn mower"
source: https://en.wikipedia.org/wiki/Lawnmower
domain: bash-valve
...
- (Hover mower (underside view))Hover mower (*underside view*)
- (Cordless and rechargeable rotary lawn mower, in mulch mode, removable battery located above rear wheels)Cordless and rechargeable rotary lawn mower, in mulch mode, removable battery located above rear wheels
- (Corded rotary lawn mower, with rear grass catcher (note the red cord attached at the handle))Corded rotary lawn mower, with rear grass catcher (note the red cord attached at the handle)
- (Gasoline rotary lawn mower, with enlarged rear wheels and side discharge)Gasoline rotary lawn mower, with enlarged rear wheels and side discharge

##### Hybrid

Cutter and propulsion is powered with a mixture of electricity and fuel. Sometimes the combustion engine is only used to recharge batteries or power electric motors and does not directly power the cutter or propulsion.
...
Some lawn mowers are designed to support grasscycling, a practice in which finely cut grass clippings are left on the lawn surface to decompose and return nutrients to the soil rather than being collected and removed.
...
- (A ride on mower being used to maintain a public garden (2015))A ride on mower being used to maintain a public garden (2015)
- (An Ursus tractor-pulled mower)An Ursus tractor-pulled mower
- (A zero-turn mower)A zero-turn mower
...
Battery-powered lawn mowers offer cleaner alternatives to consumers by producing zero emissions, being more efficient, and eliminating risks of spilled gasoline. However, this can be offset due to the process of mining and refining the lithium contained within some models of the batteries. Gasoline-powered lawnmowers are not regulated to have emission-capturing technology.
