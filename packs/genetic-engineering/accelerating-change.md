...
source: https://en.wikipedia.org/wiki/Accelerating_change
...
An updated version of Moore's Law over 120 years (based on

Kurzweil's

graph

). The seven most recent data points are all
