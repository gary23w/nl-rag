...
source: https://en.wikipedia.org/wiki/Acoustical_engineering
...
- to compress an audio signal to allow efficient transmission, e.g. perceptual coding in MP3 and Opus
- to understand the content of the signal, e.g. identification of music tracks via music information retrieval.
...
Ultrasonics deals with sound waves in solids, liquids and gases at frequencies too high to be heard by the average person. Specialist areas include medical ultrasonics (including medical ultrasonography), sonochemistry, nondestructive testing, material characterisation and underwater acoustics (sonar).
...
- Acoustical Society of America Technical Committee on Engineering Acoustics
- Audio Engineering Society
- Australian Acoustical Society
- Canadian Acoustical Association
- Institute of Acoustics, Chinese Academy of Sciences
- Institute of Acoustics (United Kingdom)
- Danish Sound Cluster (Denmark)
