---
title: "Domain theory"
source: https://en.wikipedia.org/wiki/Way-below_relation
...
(Markowsky's theorem) A poset *D* is a dcpo if and only if it is a chain complete poset, meaning that each chain in *D* has a supremum. (The 'if' direction relies on the axiom of choice.)
