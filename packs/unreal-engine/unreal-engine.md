...
**Verse** is a programming language that was developed by Epic Games for programming in UEFN, a game development software used to create player-made games in Fortnite, and Unreal Engine, a game engine developed by Epic Games. Verse was first implemented in UEFN on March 23, 2023, and it is the main scripting language for UEFN and Unreal Engine.
