...
source: https://developer.mozilla.org/en-US/docs/Learn_web_development/Core/Frameworks_libraries
domain: nuxt
...
**Note:** This section of MDN is no longer being maintained and will be removed from the website in 3 months (by August 20, 2026). The content will be archived in the MDN Museum. See this discussion for further information.
