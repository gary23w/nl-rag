...
source: https://en.wikipedia.org/wiki/Academy_of_Natural_Sciences
...
In addition to these research efforts, the Phycology Section of the Patrick Center has developed a set of online resources Archived September 6, 2019, at the Wayback Machine for using algae in environmental research. These include an algal image database, autecology datasets for freshwater algae, algae research with the USGS National Water-Quality Assessment (NAWQA) program, and a diatom paleolimnology database.
...
The Richard Hopper Day Memorial Medal, established in 1960 by his granddaughter, Margaret Day Dilks, is awarded in recognition of outstanding contributions in interpreting the natural sciences to the public. As of 2015, the recipients are:
