...
source: https://en.wikipedia.org/wiki/Definitely_endangered_language
domain: atlas-of-the-world-s-languages-in-danger
license: CC-BY-SA-4.0
tags: atlas of the world's languages in danger
fetched: 2026-07-03
---
...
. In these countries and around them are the areas that are the most linguistically diverse in the world (denoted in blue on the map).

Language death

can be the result of language shift in which

ethnic group

members no longer learn their
...
, last known native speaker of the

Cornish language

, in an engraved portrait published in 1781

The last three native speakers of
