...
- (Grid algorithm in uniform distribution) Grid algorithm in uniform distribution
- (Rotated grid algorithm (with 2 × the sample density)) Rotated grid algorithm (with 2 × the sample density)
- (Random algorithm) Random algorithm
- (Jitter algorithm) Jitter algorithm
- (Poisson disc algorithm) Poisson disc algorithm
- (Quasi-Monte Carlo method algorithm) Quasi-Monte Carlo method algorithm
- (N-Rooks) N-Rooks
- (RGSS) RGSS
- (High-resolution antialiasing (HRAA), Quincunx) High-resolution antialiasing (HRAA), Quincunx
- (Flipquad) Flipquad
- (Fliptri) Fliptri
