---
title: "MEMS"
source: https://en.wikipedia.org/wiki/Microelectromechanical_systems
domain: imu-sensors
...
provides an economy of scale for the silicon industry, crystalline silicon is still a complex and relatively expensive material to produce. Polymers on the other hand can be produced in huge volumes, with a great variety of material characteristics. MEMS devices can be made from polymers by processes such as
...
of silicon, aluminium and titanium as well as
...
are increasingly applied in MEMS fabrication due to advantageous combinations of material properties.
