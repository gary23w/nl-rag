...
- OpenSSH by default uses NTRU combined with the X25519 ECDH key exchange since August 2022, included in version 9.0.
- The GPL-licensed reference implementation
- A BSD-licensed library
- bouncycastle
- Lokinet was the first onion router implementing NTRU algorithm for its intraweb and End-2-End Encrypted events.
