...
1P0 is the highest priority of bug: all hands on deck; drop everything else until this is fixed.

2At Google, quarterly planning is public, and teams are held accountable to their plans.
