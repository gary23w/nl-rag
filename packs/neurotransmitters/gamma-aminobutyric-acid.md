...
GABA enhances the catabolism of serotonin into *N*-acetylserotonin (the precursor of melatonin) in rat pineal glands (removed from the body, *ex vivo*). It also depolarizes the GnRH-producing neurons *ex vivo* via their GABAA receptors. Melatonin modulates the strength of deploarization caused by the GABAA receptors *ex vivo* (rat brain tissue). It is thus suspected that GABA is involved in the synthesis of melatonin and thus might exert regulatory effects on sleep and reproductive functions.
