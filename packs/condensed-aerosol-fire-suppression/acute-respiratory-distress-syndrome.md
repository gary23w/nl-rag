...
source: https://en.wikipedia.org/wiki/Acute_respiratory_distress_syndrome
...
One research group has reported that broncho-alveolar lavage fluid in later-stage ARDS often contains trichomonads, in an amoeboid form (i.e. lacking their characteristic flagellum) which makes them difficult to identify under the microscope.

There is growing awareness that ARDS is not a single disease, but consists of sub-phenotypes which likely have distinct underlying mechanisms. However sub-phenotyping using the blood may not reflect changes in the alveolar space, with implications for future stratified medicine trials.
...
- decreased PaO 2/FiO 2 ratio (a decreased PaO 2/FiO 2 ratio indicates reduced arterial oxygenation from the available inhaled gas):
  - *mild ARDS*: 201 – 300 mmHg (≤ 39.9 kPa)
  - *moderate ARDS*: 101 – 200 mmHg (≤ 26.6 kPa)
  - *severe ARDS*: ≤ 100 mmHg (≤ 13.3 kPa)
  - The Berlin definition requires a minimum positive end expiratory pressure (PEEP) of 5 cmH 2O for consideration of the PaO 2/FiO 2 ratio. This degree of PEEP may be delivered noninvasively with CPAP to diagnose mild ARDS.
...
A patient with ARDS, on average, spends between 8 and 11 days on a mechanical ventilator; APRV may reduce this time significantly and thus may conserve valuable resources.
...
- hypoxemia, defined as PaO 2:FiO 2 < 200 mmHg (26.7 kPa)
...
An intravenous ascorbic acid treatment was tested in the 2019 RCT, in people with ARDS due to sepsis and there was no change in primary endpoints.
