---
title: "Scrolling"
source: https://en.wikipedia.org/wiki/Scrolling
domain: tilemap
...
In the dynamic layout of kinetic typography, scrolling typography can scroll across the flat screen, or can appear to recede or advance. An iconic example is the *Star Wars* opening crawl inspired by the Flash Gordon serials.
