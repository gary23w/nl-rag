...
source: https://en.wikipedia.org/wiki/Parallax_scrolling
domain: tilemap
...
A side view of the layers used for parallax scrolling in
...
- (Cloud layer - back) Cloud layer - back
- (Vegetation layer - middle) Vegetation layer - middle
- (Ground layer - front) Ground layer - front
- (Animation) Animation
