...
source: https://en.wikipedia.org/wiki/Time-of-flight_mass_spectrometry
domain: mass-spectrometry-chem
...
These factors for the time of flight have been grouped purposely. ${\frac {d}{\sqrt {2U}}}$ contains constants that in principle do not change when a set of ions are analyzed in a single pulse of acceleration. (**8**) can thus be given as:
...
| $t={\frac {1.5\;\mathrm {m} }{\sqrt {2(15000\;\mathrm {V} )}}}{\sqrt {\frac {(1000\;\mathrm {Da} )(1.660538921\times 10^{-27}\;\mathrm {kg\;Da} ^{-1})}{+1.602\times 10^{-19}\;\mathrm {C} }}}$ |   | 10 |
|---|---|---|
