...
source: https://en.wikipedia.org/wiki/Electrospray_ionization
...
The ions observed by mass spectrometry may be quasimolecular ions created by the addition of a hydrogen cation and denoted [**M** + H]+, or of another cation such as sodium ion, [**M** + Na]+, or the removal of a hydrogen nucleus, [**M** − H]−. Multiply charged ions such as [**M** + *n*H]*n*+ are often observed. For large macromolecules, there can be many charge states, resulting in a characteristic charge state envelope. All these are even-electron ion species: electrons (alone) are not added or removed, unlike in some other ionization sources. The analytes are sometimes involved in electrochemical processes, leading to shifts of the corresponding peaks in the mass spectrum. This effect is demonstrated in the direct ionization of noble metals such as copper, silver and gold using electrospray.
