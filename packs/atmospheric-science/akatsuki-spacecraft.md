---
title: "Akatsuki (spacecraft)"
source: https://en.wikipedia.org/wiki/Akatsuki_(spacecraft)
...
5. the infrared 2 μm camera (**IR2**) studied the night side lower clouds' opacity to the thermal emission from the surface and deeper atmosphere (1.74–2.32 μm). It also sensed on the day side the CO2 band at 2.02 μm, which can be used to infer the altitude of the top of the clouds. Finally, the 1.65-μm filter was used during the cruise phase to study the zodiacal light. Operation of the instrument was terminated in December 2016 due to an electronic failure.
...
- (An image of Venus with AKATSUKI Ultraviolet Imager (UVI))An image of Venus with AKATSUKI Ultraviolet Imager (UVI)
- (An image of Venus with a crescent shaped area that is illuminated by sunlight. The image was taken with UVI.)An image of Venus with a crescent shaped area that is illuminated by sunlight. The image was taken with UVI.
- (An image of the night side of Venus with the AKATSUKI 2-μm Camera (IR2). In the dark areas the light is absorbed by CO2 clouds.)An image of the night side of Venus with the AKATSUKI 2-μm Camera (IR2). In the dark areas the light is absorbed by CO2 clouds.
- (An image of the surface of Venus with the AKATSUKI 1-μm Camera (IR1))An image of the surface of Venus with the AKATSUKI 1-μm Camera (IR1)
