...
Riemann's statement of the Riemann hypothesis, from his 1859 paper.

(He was discussing a version of the zeta function, modified so that its roots are real rather than on the critical line. See, Riemann Xi Function.)
...
$\sum _{n=1}^{\infty }{\frac {1}{n^{s}}}=\prod _{p}^{\infty }{\frac {1}{1-p^{-s}}}{\text{ for }}s>1$
