---
title: "Allium"
source: https://en.wikipedia.org/wiki/Allium
...
| Amaryllidaceae: Subfamily Allioideae | Tribe Allieae (monogeneric, *Allium*) Tribe Tulbaghieae Tribes Gilliesieae, Leucocoryneae |
|---|---|
|   |   |
...
|---|
| *Allium* First evolutionary line Second evolutionary line Third evolutionary line |
...
The unusual telomeric sequence of *Allium cepa* was discovered and cytologically validated to be CTCGGTTATGGG A bioinformatics method for detecting this unique telomere sequence was demonstrated using SERF de novo Genome Analysis
...
Dogs and cats are very susceptible to poisoning after the consumption of certain species. Cattle have occasionally suffered onion toxicosis as well. Vegetables of the *Allium* genus can cause digestive disorders for human beings.
