...
source: https://en.wikipedia.org/wiki/Enzyme_catalysis
domain: enzymology
...
|   |
| *The effective concentration of acetate in the intramolecular reaction can be estimated as k2/k1 = 2 × 105 Molar.* |
...
Similarity between enzymatic reactions (EC) can be calculated by using bond changes, reaction centres or substructure metrics (EC-BLAST Archived 30 May 2019 at the Wayback Machine).
