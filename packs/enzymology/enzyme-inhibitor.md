...
source: https://en.wikipedia.org/wiki/Enzyme_inhibitor
domain: enzymology
...
${\begin{aligned}{\cfrac {V_{\max }}{1+{\cfrac {\ce {[I]}}{K_{i}}}}}&={V_{\max }}\left({\cfrac {K_{i}}{K_{i}+[{\ce {I}}]}}\right)&&{\text{multiply by }}{\cfrac {K_{i}}{K_{i}}}=1\\&={V_{\max }}\left({\cfrac {K_{i}+[{\ce {I}}]-[{\ce {I}}]}{K_{i}+[{\ce {I}}]}}\right)&&{\text{add }}[{\ce {I}}]-[{\ce {I}}]=0{\text{ to numerator}}\\&={V_{\max }}\left(1-{\cfrac {[{\ce {I}}]}{K_{i}+[{\ce {I}}]}}\right)&&{\text{simplify }}{\cfrac {K_{i}+[{\ce {I}}]}{K_{i}+[{\ce {I}}]}}=1\\&=V_{\max }-V_{\max }{\cfrac {\ce {[I]}}{K_{i}+[{\ce {I}}]}}&&{\text{multiply out by }}V_{\max }\end{aligned}}$
...
$V_{\max }-\Delta V_{\max }{\cfrac {\ce {[I]}}{[{\ce {I}}]+K_{i}}}$

or

$V_{\max 1}-(V_{\max 1}-V_{\max 2}){\cfrac {\ce {[I]}}{[{\ce {I}}]+K_{i}}}$
...
$V_{\max 1}-(V_{\max 1}-V_{\max 2}){\cfrac {\ce {[X]}}{[{\ce {X}}]+K_{x}}}$
