---
title: "Impeller"
source: https://en.wikipedia.org/wiki/Bladelet_(impeller)
domain: impeller
...
An impeller is a rotating component of a centrifugal pump that accelerates fluid outward from the center of rotation, thus transferring energy from the motor that drives the pump to the fluid being pumped. The acceleration generates output pressure when the outward movement of the fluid is confined by the pump casing. An impeller is usually a short cylinder with an open inlet (called an eye) to accept incoming fluid, vanes to push the fluid radially, and a splined, keyed, or threaded bore to accept a drive shaft.
