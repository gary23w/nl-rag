...
$E\equiv {\frac {\sigma (\varepsilon )}{\varepsilon }}={\frac {F/A}{\Delta L/L_{0}}}={\frac {FL_{0}}{A\,\Delta L}}$ where
...
An equivalent definition of Young's modulus is $E={\frac {L_{0}}{A}}\left.{\frac {d^{2}U}{dL^{2}}}\right|_{L_{0}}$ where U is material's energy.
...
| Beryllium (4Be) | 287 | 41.6×10^6 |   |
| Bone, human cortical | 14 | 2.0×10^6 |   |
| Brass | 106 | 15.4×10^6 |   |
| Bronze | 112 | 16.2×10^6 |   |
| Carbon nitride (CN2) | 822 | 119.2×10^6 |   |
...
| Lead (82Pb), chemical | 13 | 1.9×10^6 |   |
...
| Nickel (28Ni), commercial | 200 | 29×10^6 |   |
| Nylon 66 | 2.93 | 0.425×10^6 |   |
| Osmium (76Os) | 525–562 | 76.1×10^6–81.5×10^6 |   |
| Osmium nitride (OsN2) | 194.99–396.44 | 28.281×10^6–57.499×10^6 |   |
...
| Zinc (30Zn) | 108 | 15.7×10^6 |   |
| Zirconium (40Zr), commercial | 95 | 13.8×10^6 |   |
