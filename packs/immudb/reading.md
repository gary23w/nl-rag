...
source: https://docs.immudb.io/master/develop/reading.html
domain: immudb
...
::: tab Go <<< @/code-examples/go/develop-kv-get-set/main.go :::
...
Note that `value` is a primitive byte array. You can set the value of a String using: `"some string".getBytes(StandardCharsets.UTF_8)`
...
::: tab Go <<< @/code-examples/go/develop-kv-get-at-since/main.go :::
...
::: tab .NET This feature is not yet supported or not documented. Do you want to make a feature request or help out? Open an issue on Java sdk github project :::
