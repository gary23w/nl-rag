...
source: https://en.wikipedia.org/wiki/K_(programming_language)
domain: apl-j-k
...
K is an interpreted language where every statement is evaluated and its results displayed immediately. Literal expressions such as strings evaluate to themselves. Therefore, the "Hello, World!" program is trivial:
