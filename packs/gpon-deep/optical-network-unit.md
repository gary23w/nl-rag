...
source: https://en.wikipedia.org/wiki/Optical_Network_Unit
domain: gpon-deep
...
Generically, a NID may also be called a **network interface unit** (NIU), **telephone network interface** (TNI), **system network interface** (SNI), or **telephone network box**.
