...
be a graph. A circuit is a non-empty trail
...
- A **cycle** or **simple circuit** is a circuit in which *v*1,...,*v**n* are distinct.
...
be a directed graph. A directed circuit is a non-empty directed trail
...
- A **directed cycle** or **simple directed circuit** is a directed circuit in which *v*1,...,*v**n* are distinct.
