...
source: https://en.wikipedia.org/wiki/Eddy_(fluid_dynamics)
...
- ${\textstyle \kappa ={\tfrac {1}{2}}{\bigl (}\langle u_{1}u_{1}\rangle +\langle u_{2}u_{2}\rangle +\langle u_{3}u_{3}\rangle {\bigr )}}$ is the mean turbulent kinetic energy
