...
In 2000, scientists reported the sequencing of 88% of human genome, but as of 2020, at least 8% was still missing. In 2021, scientists reported sequencing a complete, female genome (i.e., without the Y chromosome). The human Y chromosome, consisting of 62,460,029 base pairs from a different cell line and found in all males, was sequenced completely in January 2022.
...
In 2023, the T2T consortium reported the complete sequence of a human Y chromosome, the last chromosome to be finished, correcting errors in the earlier reference and adding more than 30 million base pairs that were absent from GRCh38. A companion study that assembled 43 Y chromosomes from diverse lineages found that their length varies more than twofold between men.

In 2025, a research team preserved a digital copy of a human genome on a 5D memory crystal using femtosecond-laser inscription technology. The genome was stored as part of a long-term archival effort intended to preserve biological information for extremely long time spans (billions of years) and is housed in the Memory of Mankind archive in a salt cave in Hallstatt, Austria.
...
| Huntington's disease | 1:20000 | Huntingtin |
| Alzheimer's disease - early onset | 1:2500 | PS1, PS2, APP |
