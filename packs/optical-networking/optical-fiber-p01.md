...
A data transfer rate of 10 or 40 Gbit/s is typical in deployed systems.
...
| 2009 | 100 Pbit/s·km (15.5 Tbit/s over a single 7000 km fiber) by Bell Labs. |
| 2011 | 101 Tbit/s (370 channels at 273 Gbit/s each) on a single core. |
| January 2013 | 1.05 Pbit/s transmission through a multi-core (lightpath) fiber cable. |
| June 2013 | 400 Gbit/s over a single channel using 4-mode orbital angular momentum multiplexing. |
| October 2022 | 1.84 Pbit/s using a photonic chip |
| October 2023 | 22.9 Pbit/s by NICT |
...
Fiber optic drones have been used in the Russo-Ukrainian War since March 2024. These types of drones are immune to electromagnetic interference and are not affected by electronic warfare systems. The drones typically carry spools of glass fiber-optic cable ranging from 5 to 30 kilometres (3.1 to 18.6 mi) in length, with experimental configurations reported at up to 65 kilometres (40 mi). Because the control signals and video feed travel through the glass core at the speed of light without generating radio emissions, the drones cannot be located or disabled by conventional radio-frequency jamming or direction-finding equipment. Russia's Ushkuynik KVN was among the first mass-produced fiber-optic FPV loitering munitions, deployed from 2024 onward during the Russo-Ukrainian conflict. A physical limitation of the technology is cable snagging: if the drone maneuvers sharply through dense terrain, the trailing glass cable can catch on vegetation or structures and snap, immediately ending the mission.
...
Optical fibers are used as components in e-textiles. This was first done by Harry Wainwright in the 1980s. He used fiber optics to create "a sweatshirt with a dragon spitting flames morphing into a bird."
