...
source: https://en.wikipedia.org/wiki/Financial_modeling
...
In quantitative finance, *financial modeling* entails the development of a sophisticated mathematical model. Models here deal with asset prices, market movements, portfolio returns and the like. Relatedly, applications include:
