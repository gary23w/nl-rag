...
source: https://en.wikipedia.org/wiki/Electrical_network
...
|---|---|
| Elements |   |
| (Resistance)(Reactance)(Impedance) (Conductance) |   |
| Components |   |
|   |   |
...
|   |   |
| Two-port parameters |   |
| (z-parameters)(y-parameters)(h-parameters)(g-parameters)(S-parameters) |   |
|   |   |
