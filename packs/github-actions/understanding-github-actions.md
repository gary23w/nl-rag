...
source: https://docs.github.com/en/actions/get-started/understanding-github-actions
...
Steps run in order by default, but you can also run selected steps concurrently when your workflow benefits from parallel execution, such as starting a long-running service while later steps continue. For more information, see Workflow syntax for GitHub Actions.
