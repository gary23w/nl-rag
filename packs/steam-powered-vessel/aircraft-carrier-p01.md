---
title: "Aircraft carrier (part 1/2)"
...
The top of the carrier is the flight deck, where aircraft are launched and recovered. On the starboard side of this is the island, where ship navigation from the bridge and air traffic control from flyco are controlled and (in non-nuclear powered vessels), provides the location of the ship's funnel(s). The *Queen Elizabeth*-class has two island structures; the forward island contains the navigation bridge, while the aft structure houses flyco.
