...
Research has demonstrated that congruency between features constrains the binding process. When participants were asked to bind incongruent features together (e.g., a small digit with a large physical size, or a color word written in a conflicting font color), they made significantly more errors than when binding congruent features. This phenomenon, termed the **binding congruency effect**, suggests that the cognitive system tends to suppress incongruent combinations, affecting the feature-integration.
