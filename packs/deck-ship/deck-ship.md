---
title: "Deck (ship)"
source: https://en.wikipedia.org/wiki/Deck_(ship)
domain: deck-ship
...
- In wood – For plank thickness in inches, LOA (Length OverAll) and Beam are measured in feet. For plank thickness in mm, LOA and beam are measured in meters.
  - Plank thickness in inches ${\textstyle {}={{\sqrt {\text{LOA}}}+{\text{beam}} \over 16}}$
  - Plank thickness in mm ${\textstyle {}=\left[{\sqrt {{\text{LOA}}\cdot 3.28}}+({\text{beam}}\cdot 3.28)\cdot 1.58\right]}$
- In fiberglass – For skin thickness in inches, LWL (Length WaterLine) is in feet. For skin thickness in mm, LWL is in meters.
  - Skin thickness (inches) ${\textstyle {}=0.07+{{\text{LWL}} \over 150}}$
  - Skin thickness (mm) ${\textstyle {}=1.8+{{\text{LWL}} \over 1.8}}$
