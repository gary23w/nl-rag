...
source: https://en.wikipedia.org/wiki/Backlash_(engineering)
domain: cam-follower
...
|   | $b_{t}\;$ | = backlash due to tooth thickness modifications |
|---|---|---|
| $t_{i}\;$ | = tooth thickness on the pitch circle for ideal gearing (no backlash) |   |
| $t_{a}\;$ | = actual tooth thickness |   |
...
|   | $b_{c}\;$ | = backlash due to operating center distance modifications |
|---|---|---|
