...
- (Eye pattern of twelve thousand UIs of a 1.25 Gbit/s signal)Eye pattern of twelve thousand UIs of a 1.25 Gbit/s signal
- (Eye pattern of eight million UIs (unit intervals) of a 1.25 Gbit/s signal)Eye pattern of eight million UIs (unit intervals) of a 1.25 Gbit/s signal
...
(Eye pattern of a binary PSK system) (Eye pattern of the same system with multipath interference (MI) effects added)
...
As high frequency losses increase, the overall shape of the eye gradually degrades into a sinusoid (once higher frequency harmonics of the data have been eliminated, all that remains is the fundamental) and decreases in amplitude.
