...
The library is used as of 2023 in Google Chrome, ChromeOS, ChromiumOS, Mozilla Firefox, Mozilla Thunderbird, Android, Firefox OS, Flutter, Ladybird, Avalonia (from Alpha 4), LibreOffice (from version 7.0) and RAD Studio(since version 12.0).
