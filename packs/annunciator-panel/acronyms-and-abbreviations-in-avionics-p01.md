---
title: "List of aviation, avionics, aerospace and aeronautical abbreviations (part 1/2)"
source: https://en.wikipedia.org/wiki/Acronyms_and_abbreviations_in_avionics
...
| A/P | Autopilot |   |
| AAE | Above aerodrome elevation | In aviation, above aerodrome level (AAL), or above aerodrome elevation (AAE), denotes that an altitude is given above the nearest aerodrome or airport. |
...
| ACS1 | Airman Certification Standards | FAA pilot testing |
| ACS2 | Audio control system |   |
| ACU1 | Air conditioning (or cooling) unit |   |
| ACU2 | Alternator control unit | Protection from alternator over-voltage. |
...
| ANSP2 | Authorization of Aircraft Network Security Program (FAA) |   |
| ANT | Antenna (radio) |   |
...
| AOM1 | Aircraft operations manual |   |
| AOM2 | Airport/aerodrome operating minima |   |
...
| ATR1 1 | Air transportable racking |   |
| ATR2 | Automatic thrust restoration |   |
...
| CAT1 | clear air turbulence |   |
| CAT2 | Commercial Air Transport |   |
...
| DA1 | Decision Altitude | Precision approach or vertical guidance |
...
| EFC1 | Engine Flight Cycle |
| EFC2 | expect further clearance |
...
| Abbreviation | Term | Notes |
|---|---|---|
| N# | compressor speed | N1, N2, etc. refers to the specific compressor spool (in the order that air passes over them). (See: Jet engine) |
