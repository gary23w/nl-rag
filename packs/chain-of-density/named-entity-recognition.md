...
NER can have reference resolution ambiguities where the same name can refer to different entities of the same type. For example, "JFK" can refer to the former president of the United States or his son.

The same name can refer to completely different types. "JFK" might refer to the airport in New York. "IRA" can refer to Individual Retirement Account, International Reading Association or Irish Republican Army.
