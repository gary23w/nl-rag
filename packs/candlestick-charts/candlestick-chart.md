...
A version of a candlestick chart is a *hollow candlestick* chart, where both fill and color are used to represent different price relationships:
...
A candlestick need not have either a body or a wick. Generally, the longer the body of the candle, the more intense the trading.
