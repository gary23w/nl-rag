...
source: https://en.wikipedia.org/wiki/Digital-to-analog_converter
...
A later device, the Philips TDA1541, provides full 16-bit resolution and removes the need for the intermediate word-length reduction step. In this and later designs, the same general arrangement was retained.

This arrangement, digital interpolation followed by conversion and a relatively simple analog filter, became standard practice in CD playback and appears in later DACs such as the Crystal CS4397.
...
it uses, which is the

binary logarithm

of the number of levels. For instance, a 1-bit DAC is designed to reproduce 2 (2
...
) levels. Resolution is related to the

effective number of bits

, which is a measurement of the actual resolution attained by the DAC. Resolution determines

color depth

in video applications and
...
defines a relationship between this and the
...
. This is usually related to resolution and
