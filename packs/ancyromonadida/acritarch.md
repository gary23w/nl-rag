---
title: "Acritarch"
source: https://en.wikipedia.org/wiki/Acritarch
...
*Acritarch* was coined in 1963 from the Greek *ákritos* meaning *confused* (*a kritēs*, *without critic*) and *archē* meaning *origin* (confer archaic).
...
The Archean and earliest Proterozoic microfossils termed "acritarchs" may actually be prokaryotes. The earliest eukaryotic acritarchs known (as of 2020) are from between 1950 and 2150 million years ago.
...
There are over 900 described genera; the following is a partial list, from Fossilid.info.
