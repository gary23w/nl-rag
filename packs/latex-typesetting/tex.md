---
title: "TeX - Wikipedia"
source: https://en.wikipedia.org/wiki/TeX
...
|---|---|
| The quadratic formula is $-b \pm \sqrt{b^2 - 4ac} \over 2a$ \bye | ${\hbox{The quadratic formula is }}\textstyle {-b\pm {\sqrt {b^{2}-4ac}} \over 2a}$ |
...
| Source code | Renders as |
|---|---|
| The quadratic formula is $$-b \pm \sqrt{b^2 - 4ac} \over 2a$$ \bye | ${\begin{matrix}{\text{The quadratic formula is}}\\\displaystyle {\frac {-b\pm {\sqrt {b^{2}-4ac}}}{2a}}\end{matrix}}$ |
