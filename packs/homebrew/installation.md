...
- macOS Sonoma (14) (or higher) installed on officially supported hardware2
...
1 For 32-bit or PPC support see MacPorts or Tigerbrew.

2 macOS 14 (Sonoma) or higher is best and supported, 10.15 (Catalina) – 13 (Ventura) are unsupported but may work and 10.14 (Mojave) and older will not run Homebrew at all. Using OpenCore Legacy Patcher is a Tier 2 or Tier 3 configuration depending on CPU generation.
