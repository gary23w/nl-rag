...
Benign conditions that are *not* associated with an abnormal proliferation of tissue (such as sebaceous cysts) can also present as tumors, however, but have no malignant potential. Examples include breast cysts, which commonly occur during pregnancy and at other times, as well as other encapsulated glandular swellings (thyroid, adrenal gland, pancreas).
