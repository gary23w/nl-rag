...
source: https://en.wikipedia.org/wiki/The_Hallmarks_of_Cancer
...
do not need stimulation from external signals (in the form of
...
(cell suicide), the mechanism by which cells are programmed to die in the event they become damaged. Cancer cells are characteristically able to bypass this mechanism.
...
Non-cancer cells die after a

certain number of divisions

. Mutant cells escape this limit and are apparently capable of indefinite growth and division (
