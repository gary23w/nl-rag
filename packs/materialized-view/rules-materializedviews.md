---
title: "PostgreSQL: Documentation: 18: 39.3. Materialized Views"
...
|---|---|---|---|---|
| Prev | Up | Chapter 39. The Rule System | Home | Next |
...
| Prev | Up | Next |
|---|---|---|
| 39.2. Views and the Rule System | Home | 39.4. Rules on `INSERT`, `UPDATE`, and `DELETE` |
