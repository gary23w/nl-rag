...
source: https://sqlite.org/queryplanner.html
domain: sql-sqlite
...
(figure 1) Figure 1: Logical Layout Of Table "FruitsForSale"
...
(figure 2) Figure 2: Full Table Scan
...
(figure 3) Figure 3: Lookup By Rowid
...
(figure 4) Figure 4: An Index On The Fruit Column
...
(figure 5) Figure 5: Indexed Lookup For The Price Of Peaches
...
(figure 6) Figure 6: Indexed Lookup For The Price Of Oranges
...
(figure 7) Figure 7: Indexed Lookup Of California Oranges
...
(figure 8) Figure 8: Index On The State Column
...
(figure 9) Figure 9: Indexed Lookup Of California Oranges
...
(figure 1) Figure 1: A Two-Column Index
...
(figure 11) Figure 11: Lookup Using A Two-Column Index
...
(figure 12) Figure 12: Single-Column Lookup On A Multi-Column Index
...
(figure 13) Figure 13: A Covering Index
...
(figure 14) Figure 14: Query Using A Covering Index
...
(figure 15) Figure 15: Query With OR Constraints
...
(figure 16) Figure 16: Sorting Without An Index
...
(figure 17) Figure 17: Sorting By Rowid
...
(figure 18) Figure 18: Sorting With An Index
...
(figure 19) Figure 19: Sorting With A Covering Index
...
(figure 20) Figure 20: Search And Sort By Multi-Column Index
...
(figure 21) Figure 21: Search And Sort By Covering Index
...
(figure 22) Figure 22: Partial Sort By Index
