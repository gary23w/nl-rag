---
title: "Stack machine"
source: https://en.wikipedia.org/wiki/Stack_machine
domain: cat-language
...
- The bs calculator in Unix uses a virtual stack machine to process commands, after first transposing provided input language form, into reverse-polish notation.
- The dc calculator, one of the oldest Unix programs, uses reverse-Polish notation.
- The Lua programming language interpreter was stack based up until version 5.0. The C API still is as of version 5.x.
