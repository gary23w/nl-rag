...
of light-signals in four-dimensional space-time. A short element of one of these world-lines may be called a
...
Finite light speed, first noted by the delay in appearance of the moons of Jupiter, requires a modern kinematics. The method involves rapidity instead of velocity, and substitutes squeeze mapping for the shear mapping used earlier. This affine geometry was developed synthetically in 1912. to express the special theory of relativity. In 1984, "the affine plane associated to the Lorentzian vector space *L*2" was described by Graciela Birman and Katsumi Nomizu in an article entitled "Trigonometry in Lorentzian geometry".
