...
source: https://en.wikipedia.org/wiki/Software_metric
...
- Defect density - defects found relative to the size of a component, often expressed as defects per thousand lines of code (KLOC)
