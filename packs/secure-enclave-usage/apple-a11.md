...
The A11 has video codec encoding support for HEVC and H.264. It has decoding support for HEVC, H.264, MPEG‑4 Part 2, and Motion JPEG.
...
Bloomberg says that the neural engine is the fruit of Apple's efforts to improve its AI team, since the 2015 report by Bloomberg states that Apple's secretive nature made it difficult to attract AI research scientists. Apple has since recruited people and multiple companies working on AI, and has published papers related to AI research. In October 2016, Apple hired Russ Salakhutdinov as its director of AI research.
