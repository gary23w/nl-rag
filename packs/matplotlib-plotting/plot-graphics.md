---
title: "Plot (graphics)"
source: https://en.wikipedia.org/wiki/Plot_(graphics)
...
- (Box plot)Box plot
- (Carpet plot)Carpet plot
- (Contour plot)Contour plot
- (Logarithmic plot)Logarithmic plot
- (Parallel Category Plot)Parallel Category Plot
...
- (A normal Q–Q plot)A normal Q–Q plot
