---
title: "Bonn"
source: https://en.wikipedia.org/wiki/Bonn
domain: alois-mertes
...
**Bonn** (German pronunciation: [bɔn] ⓘ), officially the **Federal City of Bonn** (German: *Bundesstadt Bonn*), is a federal city in the German state of North Rhine-Westphalia, located on the banks of the Rhine. With a population exceeding 300,000, it lies about 24 km (15 mi) south-southeast of Cologne, in the southernmost part of the Rhine-Ruhr region.
...
View over central Bonn as seen from the Stadthaus, including the

Siebengebirge

, a hill range on the east bank of the
...
| Municipal district (*Stadtbezirk*) | Coat of arms | Population (as of December 2014) | Sub-district (*Stadtteil*) |
|---|---|---|---|
...
| Party | Votes | % | +/- | Seats | +/- |   |
|---|---|---|---|---|---|---|
|   | Christian Democratic Union (CDU) | 50,895 | 31.9 | (Increase) 6.2 | 21 | (Increase) 4 |
|   | Alliance 90/The Greens (Grüne) | 41,861 | 26.3 | (Decrease) 1.6 | 17 | (Decrease) 2 |
|   | Social Democratic Party (SPD) | 18,867 | 11.8 | (Decrease) 3.7 | 8 | (Decrease) 3 |
|   | The Left (Die Linke) | 13,856 | 8.7 | (Increase) 2.5 | 6 | (Increase) 2 |
|   | Alternative for Germany (AfD) | 9,630 | 6.0 | (Increase) 2.8 | 4 | (Increase) 2 |
|   | Citezen's Association Bonn (BBB) | 8,509 | 5.3 | (Decrease) 1.8 | 3 | (Decrease) 1 |
|   | Free Democratic Party (FDP) | 4,684 | 2.9 | (Decrease) 2.2 | 2 | (Decrease) 1 |
|   | Volt Germany (Volt) | 4,315 | 2.7 | (Decrease) 2.4 | 2 | (Decrease) 1 |
|   | Voice Bonn International (SBI) | 2,576 | 1.6 | New | 1 | New |
|   | Sahra Wagenknecht Alliance (BSW) | 1,814 | 1.1 | New | 1 | New |
|   | Die PARTEI (PARTEI) | 1,452 | 0.9 | (Decrease) 1.3 | 1 | (Steady) 0 |
|   |   |   |   |   |   |   |
|   | Alliance for Innovation and Justice (BIG) | 820 | 0.5 | (Decrease) 0.7 | 0 | (Decrease) 1 |
|   | Pirate Party Germany (Piraten) | 59 | 0.0 | (Decrease) 0.6 | 0 | (Steady) 0 |
| Valid votes | 159,458 | 99.5 |   |   |   |   |
| Invalid votes | 762 | 0.5 |   |   |   |   |
| Total | 160,220 | 100.0 |   | 66 | (Steady) 0 |   |
| Electorate/voter turnout | 247,052 | 64.9 | (Increase) 7.8 |   |   |   |
| Source: State Returning Officer |   |   |   |   |   |   |
...
The three highest structures in the city are the WDR radio mast in Bonn-Venusberg (180 m or 590 ft), the headquarters of the Deutsche Post called *Post Tower* (162.5 m or 533 ft) and the *Langer Eugen* (114.7 m or 376 ft), originally offices for Members of the Bundestag, but today home of the United Nations campus at Bonn.
...
1. The data from 1933 to 1999 comes from the Bonn-Friesdorf weather station, and the data from 2000 to date comes from the Bonn-Roleber weather station.
