...
| Default | CLI Override | API Override`false``--experimental-ternaries``experimentalTernaries: <bool>` |
|---|---|---|
...
| Default | CLI Override | API Override`"end"``--experimental-operator-position <start\|end>``experimentalOperatorPosition: "<start\|end>"` |
|---|---|---|
...
| Default | CLI Override | API Override`80``--print-width <int>``printWidth: <int>` |
|---|---|---|
...
| Default | CLI Override | API Override`2``--tab-width <int>``tabWidth: <int>` |
|---|---|---|
...
| Default | CLI Override | API Override`false``--use-tabs``useTabs: <bool>` |
|---|---|---|
...
| Default | CLI Override | API Override`true``--no-semi``semi: <bool>` |
|---|---|---|
...
| Default | CLI Override | API Override`false``--single-quote``singleQuote: <bool>` |
|---|---|---|
...
| Default | CLI Override | API Override`"as-needed"``--quote-props <as-needed\|consistent\|preserve>``quoteProps: "<as-needed\|consistent\|preserve>"` |
|---|---|---|
...
| Default | CLI Override | API Override`false``--jsx-single-quote``jsxSingleQuote: <bool>` |
|---|---|---|
...
| Default | CLI Override | API Override`"all"``--trailing-comma <all\|es5\|none>``trailingComma: "<all\|es5\|none>"` |
|---|---|---|
...
| Default | CLI Override | API Override`true``--no-bracket-spacing``bracketSpacing: <bool>` |
|---|---|---|
...
| Default | CLI Override | API Override`"preserve"``--object-wrap <preserve\|collapse>``objectWrap: "<preserve\|collapse>"` |
|---|---|---|
...
| Default | CLI Override | API Override`false``--bracket-same-line``bracketSameLine: <bool>` |
|---|---|---|
...
| Default | CLI Override | API Override`false``--jsx-bracket-same-line``jsxBracketSameLine: <bool>` |
|---|---|---|
...
| Default | CLI Override | API Override`"always"``--arrow-parens <always\|avoid>``arrowParens: "<always\|avoid>"` |
|---|---|---|
...
| Default | CLI Override | API Override`0``--range-start <int>``rangeStart: <int>``Infinity``--range-end <int>``rangeEnd: <int>` |
|---|---|---|
...
- `"json-stringify"` (parse like `JSON.parse()` except it's less strict, whitespace resembles `JSON.stringify()`) *First available in v1.13.0*
...
| Default | CLI Override | API OverrideNone`--parser <string>``parser: "<string>"` |
|---|---|---|
...
| Default | CLI Override | API OverrideNone`--stdin-filepath <string>``filepath: "<string>"` |
|---|---|---|
...
| Default | CLI Override | API Override`false``--require-pragma``requirePragma: <bool>` |
|---|---|---|
...
| Default | CLI Override | API Override`false``--insert-pragma``insertPragma: <bool>` |
|---|---|---|
...
| Default | CLI Override | API Override`false``--check-ignore-pragma``checkIgnorePragma: <bool>` |
|---|---|---|
...
- `"preserve"` - Keep the existing wrapping as-is. *First available in v1.9.0*
...
- `"always"` `The quick brown fox jumps over the lazy dog.`
- `"never"` `The quick brown fox jumps over the lazy dog.`
- `"preserve"` `The quick brown fox jumps over the lazy dog.`

| Default | CLI Override | API Override`"preserve"``--prose-wrap <always\|never\|preserve>``proseWrap: "<always\|never\|preserve>"` |
|---|---|---|
...
| Default | CLI Override | API Override`"css"``--html-whitespace-sensitivity <css\|strict\|ignore>``htmlWhitespaceSensitivity: "<css\|strict\|ignore>"` |
|---|---|---|
...
| Default | CLI Override | API Override`false``--vue-indent-script-and-style``vueIndentScriptAndStyle: <bool>` |
|---|---|---|
...
| Default | CLI Override | API Override`"lf"``--end-of-line <lf\|crlf\|cr\|auto>``endOfLine: "<lf\|crlf\|cr\|auto>"` |
|---|---|---|
...
| Default | CLI Override | API Override`"auto"``--embedded-language-formatting=<off\|auto>``embeddedLanguageFormatting: "<off\|auto>"` |
|---|---|---|
...
| Default | CLI Override | API Override`false``--single-attribute-per-line``singleAttributePerLine: <bool>` |
|---|---|---|
