...
source: https://en.wikipedia.org/wiki/Endangered_Species_Act_Amendments_of_1978
...
The environmentalists and the BLM agreed on a compromise that allowed the timber sale to continue. The BLM would develop a Long Range Forest Management Plan that would need to be approved by the FWS before any future timber sales. When the Clinton administration came into office, they withdrew the exemption request and convened a conference resulting in appointment of the Forest Ecosystem Management Assessment Team (FEMAT). The FEMAT was created to develop a plan to protect the owl while still maintaining logging and forest management across the region. FEMAT and the Clinton administration agreed to protect 10 million acres (40,000 km2) of old growth forest for the owl, while limiting logging to 1 billion board feet (2,400,000 m3) per year.
