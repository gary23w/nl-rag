...
domain: text-generation-inference
...
Assuming the above are done consecutively, the minimum plane turnaround time is:
...
Note that in software systems, benchmarking against *average* and *median* latency can be misleading because a few outliers can distort them. Instead, software architects and software developers should use "99th percentile".
