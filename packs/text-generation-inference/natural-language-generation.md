...
source: https://en.wikipedia.org/wiki/Natural_language_generation
...
Merging of similar sentences to improve readability and naturalness. For instance, merging the sentences
...
Putting words to the concepts. For example, deciding whether
...
Creating the actual text, which should be correct according to the rules of
