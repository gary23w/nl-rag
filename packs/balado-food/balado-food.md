---
title: "Balado (food)"
source: https://en.wikipedia.org/wiki/Balado_(food)
domain: balado-food
...
- Balado variants
- (Bada (anchovy) balado) *Bada* (anchovy) balado
- (Baluik (eel) balado) *Baluik* (eel) balado
- (Dendeng (dried beef) balado) *Dendeng* (dried beef) balado
- (Talua (egg) balado) *Talua* (egg) balado
- (Taruang (eggplant) balado) *Taruang* (eggplant) balado
- (Udang (prawn) balado) *Udang* (prawn) balado
