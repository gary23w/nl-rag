...
- (Arduino RS232[42] (male pins)) Arduino RS232 (male pins)
- (Arduino Diecimila[43]) Arduino Diecimila
- (Arduino Duemilanove[44] (rev 2009b)) Arduino Duemilanove (rev 2009b)
- (Arduino Uno R2[45][46]) Arduino Uno R2
- (Arduino Uno SMD R3[47]) Arduino Uno SMD R3
- (Arduino Leonardo[48]) Arduino Leonardo
- (Arduino Micro (ATmega32U4)) Arduino Micro (ATmega32U4)
- (Arduino Pro Micro (ATmega32U4)) Arduino Pro Micro (ATmega32U4)
- (Arduino Pro[49] (No USB)) Arduino Pro (No USB)
- (Arduino Mega[50]) Arduino Mega
- (Arduino Nano[51] (DIP-30 footprint)) Arduino Nano (DIP-30 footprint)
- (Arduino LilyPad 00[52] (rev 2007) (No USB)) Arduino LilyPad 00 (rev 2007) (No USB)
- (Arduino Robot[53]) Arduino Robot
- (Arduino Esplora[54]) Arduino Esplora
- (Arduino Ethernet[55] (AVR + W5100)) Arduino Ethernet (AVR + W5100)
- (Arduino Yún[56] (AVR + AR9331)) Arduino Yún (AVR + AR9331)
- (Arduino Due[57] (ARM Cortex-M3 core)) Arduino Due (ARM Cortex-M3 core)
...
- (The Adafruit Motor Shield V2 uses I2C, requiring vastly fewer digital I/O pins than attaching each motor directly.) The Adafruit Motor Shield V2 uses I2C, requiring vastly fewer digital I/O pins than attaching each motor directly.
