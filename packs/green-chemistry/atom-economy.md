---
title: "Atom economy"
source: https://en.wikipedia.org/wiki/Atom_economy
...
Atom economy can be written as: ${\text{atom economy}}={\frac {\text{molecular weight of desired product}}{\text{molecular weight of all reactants}}}\times 100\%$

For example, if we consider the reaction $A+B\rightarrow C+D,$ where C is the desired product, then ${\text{atom economy}}={\frac {{\text{Molecular weight }}C}{{\text{Molecular weight of }}A+B}}\%$
