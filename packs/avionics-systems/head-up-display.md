...
A **head-up display**, also known as a **HUD** (/hʌd/) or **head-up guidance system** (**HGS**), is any transparent display that presents data without requiring users to look away from their usual viewpoints. The origin of the name stems from a pilot being able to view information with the head positioned "up" and looking forward, instead of angled down looking at lower instruments. A HUD also has the advantage that the pilot's eyes do not need to refocus to view the outside after looking at the optically nearer instruments.
...
Other than fixed mounted HUD, there are also head-mounted displays (HMDs). These include helmet-mounted displays (both abbreviated HMDs), forms of HUD that feature a display element that moves with the orientation of the user's head.
