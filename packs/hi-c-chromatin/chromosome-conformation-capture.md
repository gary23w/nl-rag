...
source: https://en.wikipedia.org/wiki/Chromosome_conformation_capture
...
- In 1928, Emil Heitz coined the terms heterochromatin and euchromatin.
- In 1942, Conrad Waddington postulated the epigenetic landscapes.
- In 1948, Rollin Hotchkiss discovered DNA methylation.
- In 1953, Watson and Crick reported the double helix structure of DNA based on Rosalind Franklin's X-ray diffraction images.
...
- In 2013, Takashi Nagano and Peter Fraser introduced in-nuclei ligation for Hi-C and single-cell Hi-C.
...
- In 2018 S Schoenfelder et el established a comprehensive promoter capture Hi-C method to generate an atlas of long-range promoter interactions in dozens of human and mouse cell types in a non-biased interactions in dozens of human and mouse cell types in a non-biased wa.
...
A number of methods sequence multiple ligation junctions simultaneously to detect higher-order structures where multiple regions of chromatin may be interacting. These methods include Tri-C, 3way 4C/C-walks, multi-contact 4C (MC-4C), and hiPore-C.
...
ChIA-PET combines Hi-C with ChIP-seq to detect all interactions mediated by a protein of interest. HiChIP was designed to allow similar analysis as ChIA-PET with less input material.

## Restriction enzyme vs non-sequence specific endonuclease

The endonuclease used in these assays is important. This is because data are only generated from the endonuclease cut sites the choice of enzyme determines the maximum potential resolution of the assay. 3C methods initially used restriction endonucleases which cut with specific recognition sequences. The early 3C and Hi-C used 6-cutter restriction enzymes, such as HindIII, which cut approximately every 4096 base pairs. Subsequently, 4-cutter enzymes such as DpnII were used, particularly in 4C and Capture-C assays and these were later adopted widely in Hi-C methods. These cut approximately every 254 base pairs and afford a 16-fold potential increase in resolution. Subsequently, non-sequence specific endonucleases have been introduced which allow an increase in potential resolution, providing deep enough datasets can be generated. Micrococcal nuclease based 3C was first developed by the Rando lab in yeast and has subsequently been adapted for mammalian cells. These allow a substantial increase in resolution and even potentially allow contacts between individual DNA binding proteins to be resolved.
...
PPD2 (polydactyly of a triphalangeal thumb) is caused by a mutation of ZRS enhancer, which in turn strengthened the production of SHH gene.
...
Hi-C and its subsequent analyses are evolving. Fit-Hi-C is a method based on a discrete binning approach with modifications of adding distance of interaction (initial spline fitting, aka spline-1) and refining the null model (spline-2). The result of Fit-Hi-C is a list of pairwise intra-chromosomal interactions with their p-values and q-values.
