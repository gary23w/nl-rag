...
source: https://docs.web3js.org/guides/smart_contracts/smart_contracts_guide
domain: web3js
...
For the purposes of this tutorial, the above script uses relatively arbitrary values for `gas` and `gasPrice` when demonstrating how to interact with a smart contract. Refer to the Gas and Priority Fees guide to learn how to properly set these values.
