...
2. Oxidation of hydrocarbons (unburnt and partially burned fuel) to carbon dioxide and water: C*x*H2*x*+2 + [(3*x*+1)/2]O2 → *x*CO2 + (*x*+1)H2O (a combustion reaction)
...
The three-way catalytic converters have the additional advantage of controlling the emission of nitric oxide (NO) and nitrogen dioxide (NO2) (both together abbreviated with NO*x* and not to be confused with nitrous oxide (N2O)). NO*x* are precursors to acid rain and smog.
