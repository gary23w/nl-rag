---
title: "Galois theory"
source: https://en.wikipedia.org/wiki/Galois_theory
...
(change of sign of both square roots)
...
It is known that a Galois group modulo a prime is isomorphic to a subgroup of the Galois group over the rationals. A permutation group on 5 objects with elements of orders 6 and 5 must be the symmetric group *S*5, which is therefore the Galois group of *f*(*x*).
