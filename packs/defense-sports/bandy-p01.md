---
title: "Bandy (part 1/2)"
source: https://en.wikipedia.org/wiki/Bandy
...
Bandy is a swift game. Elite players have a mean skating velocity of over 16 km/h (10 mph) and the skating velocity can in some cases reach 37 km/h (23 mph).
...
Yellow: warning, White: 5 minutes penalty, Blue: 10 minutes penalty, Red:
...
The bandy stick should not have similar colours to the ball, such as orange or pink; it should be no longer than 127 centimetres (50 in), and no wider than 7 centimetres (2.8 in).
...
In Czechia, the national federation has developed its own version of rink bandy with somewhat different rules, which is meant to help the players transition to playing on a full-sized bandy rink. This is called short bandy. Read more in the section on Czechia below.
