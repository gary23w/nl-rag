...
source: https://www.cockroachlabs.com/docs/stable/architecture/distribution-layer.html
domain: cockroachdb
...
As described in the meta ranges section, the locations of all the ranges in a cluster are stored in a two-level index:
...
1. `meta1` contains the address for the nodes containing the `meta2` replicas. `# Points to meta2 range for keys [A-M) meta1/M -> node1:26257, node2:26257, node3:26257 # Points to meta2 range for keys [M-Z] meta1/maxKey -> node4:26257, node5:26257, node6:26257`
2. `meta2` contains addresses for the nodes containing the replicas of each range in the cluster: `# Contains [A-G) meta2/G -> node1:26257, node2:26257, node3:26257 # Contains [G-M) meta2/M -> node1:26257, node2:26257, node3:26257 #Contains [M-Z) meta2/Z -> node4:26257, node5:26257, node6:26257 #Contains [Z-maxKey) meta2/maxKey-> node4:26257, node5:26257, node6:26257`
...
- Membership changes to a range's Raft group (discussed in more detail in the Replication Layer)
- Range splits
- Range merges
...
By default, CockroachDB attempts to keep ranges/replicas at the default range size. Once a range reaches that limit, we split it into two smaller ranges (composed of contiguous key spaces).
...
Learn how CockroachDB copies data and ensures consistency in the replication layer.
