...
To learn more about Consul and how it compares to similar products, refer to Consul use cases.
...
Consul supports both IPv4 and IPv6 networks. To learn more about Consul's service discovery features and how they compares to similar products, refer to Consul compared to other DNS tools.
...
You can also schedule Consul workloads with HashiCorp Nomad to provide secure service-to-service communication between Nomad jobs and task groups.
