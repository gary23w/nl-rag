...
source: https://en.wikipedia.org/wiki/Abkhaz_language
...
1. Unique to the Bzyp dialect
2. Found in the Bzyp and Sadz dialects of Abkhaz, but not in Abzhywa.
...
**Inflectional Suffixes** These suffixes convey either plural number or case-like adverbial information. Plural markers are addressed further below; the other possible inflectional suffixes are the following:
...
[darbanzaːlakʼ awaɥɨ tʂəʊpʼ jɨχɨ dakʷʰitʰnɨ ǁ awaː zəgʲ zinləɪ pʼatʼwɨləɪ əɪqʼarəʊpʼ ǁ wərtʰ jɨrɨməʊpʼ aχʂɨɥiː alamɨsiː ǀ dara daragʲ ajəʃəɪ ajəʃəɪ rəɪpʰʂ əɪzɨqʼazarəʊpʼ ǁ]
