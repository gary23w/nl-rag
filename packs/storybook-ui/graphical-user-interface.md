...
- (MATE) MATE
- (Windows on an example Wayland compositor) Windows on an example Wayland compositor
- (Xfce) Xfce
- (Enlightenment) Enlightenment
- (Sugar) Sugar
- (A twm X Window System environment) A twm X Window System environment
- (The dwm tiling window manager) The dwm tiling window manager
- (Cinnamon) Cinnamon
- (Phosh) Phosh
...
— Andrew Fluegelman on the Macintosh, 1985
