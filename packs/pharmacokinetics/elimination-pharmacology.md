---
title: "Elimination (pharmacology)"
source: https://en.wikipedia.org/wiki/Elimination_(pharmacology)
...
Where: $CL_{o}$ is the organ's clearance rate, $C_{A}$ is the drug's plasma concentration in arterial blood, $C_{V}$ is the drug's plasma concentration in venous blood and Q an organ's blood flow.
