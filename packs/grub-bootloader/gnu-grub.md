---
title: "GNU GRUB"
source: https://en.wikipedia.org/wiki/GNU_GRUB
...
```
linux (hd0,1)/kernel/vmlinuz-3.20.1-4 ro  # use the file named "vmlinuz-…" located in the directory /kernel on the first partition of the first hard disk as linux kernel image
...
In March 2026, the development moved to freedesktop.org.
