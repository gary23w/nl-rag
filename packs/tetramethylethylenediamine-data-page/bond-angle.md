...
source: https://en.wikipedia.org/wiki/Bond_angle
domain: tetramethylethylenediamine-data-page
license: CC-BY-SA-4.0
tags: tetramethylethylenediamine data page
fetched: 2026-07-04
---
...
- *β* = 0.0890 for Δ*E* = 0500 cm−1
- *β* = 0.0080 for Δ*E* = 1000 cm−1
- *β* = 0.0007 for Δ*E* = 1500 cm−1.
...
$0={\begin{vmatrix}\cos \theta _{11}&\cos \theta _{12}&\cos \theta _{13}&\cos \theta _{14}\\\cos \theta _{21}&\cos \theta _{22}&\cos \theta _{23}&\cos \theta _{24}\\\cos \theta _{31}&\cos \theta _{32}&\cos \theta _{33}&\cos \theta _{34}\\\cos \theta _{41}&\cos \theta _{42}&\cos \theta _{43}&\cos \theta _{44}\end{vmatrix}}$
