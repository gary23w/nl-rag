---
title: "Kernel (operating system) (part 1/2)"
...
- Using a special system call instruction. This technique requires special hardware support that common architectures (notably, x86) may lack. System call instructions have been added to recent models of x86 processors, however, and some operating systems for PCs make use of them when available.
