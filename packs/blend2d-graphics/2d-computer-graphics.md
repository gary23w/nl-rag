...
source: https://en.wikipedia.org/wiki/2D_computer_graphics
...
If *T* is a translation, then the image of a subset *A* under the function *T* is the **translation** of *A* by *T*. The translation of *A* by *T***v** is often written *A* + **v**.
