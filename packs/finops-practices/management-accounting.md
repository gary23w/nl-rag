...
source: https://en.wikipedia.org/wiki/Management_accounting
...
To facilitate its educational objectives, the Institute has accredited a number of universities whose master's degree subjects are equivalent to the CMA program. Some of these universities also provide in-house training and examinations for the CMA program. Accounting graduates can complete CMA-accredited units at these universities to qualify for CMA status. The ICMA also has a number of Recognised Provider Institutions (RPIs) that run the CMA program in Australia and overseas. The CMA program is also available online in regions where face-to-face delivery of the program is not possible.
...
A modern approach to close accounting is continuous accounting, which focuses on achieving a point-in-time close, where accounting processes that are typically performed at period-end are distributed evenly throughout the period.
