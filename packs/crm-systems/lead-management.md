...
source: https://en.wikipedia.org/wiki/Lead_management
domain: crm-systems
...
Businesses need to keep track of all inquiries and sales leads that are generated from numerous sources and know the conversion from the source of various sales leads. A good inquiry management system can save time. Most lead management systems can filtering and categorizing lead data. There are myriad ways to accomplish this process and some of them may be specific to industries. Possible functions include:
