---
title: "rel='preload' HTML attribute value - HTML"
source: https://developer.mozilla.org/en-US/docs/Web/HTML/Attributes/rel/preload
...
# `rel="preload"` HTML attribute value
...
**Note:** There's more detail about these values and the web features they expect to be consumed by in the HTML spec — see Link type "preload". Also note that the full list of values the `as` attribute can take is governed by the HTML spec — see Link type "preload" destinations.
