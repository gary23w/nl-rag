---
title: "kdb+"
source: https://en.wikipedia.org/wiki/Kdb+
domain: kdb-q-lang
...
In April 2007, KX announced that it was releasing a version of kdb+ for Mac OS X. Then, kdb+ was also available on the operating systems Linux, Windows, and Solaris.
