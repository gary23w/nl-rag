...
source: https://en.wikipedia.org/wiki/Green_Hills_Software
...
Integrity is a POSIX real-time operating system (RTOS). An Integrity variant, named Integrity-178B, was certified to Common Criteria Evaluation Assurance Level (EAL) 6+, High Robustness in November 2008. Micro Velosity (stylized as *μ-velOSity*) is a real-time microkernel for resource-constrained devices.
