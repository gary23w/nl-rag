...
source: https://en.wikipedia.org/wiki/Arenga_pinnata
...
- (Bark fiber)Bark fiber
- (Saplings from North Sumatra)Saplings from North Sumatra
- (Fruits harvested from Java)Fruits harvested from Java
- (Fruits preserved in syrup from the Philippines are commonly sold internationally as "kaong")Fruits preserved in syrup from the Philippines are commonly sold internationally as "kaong"
