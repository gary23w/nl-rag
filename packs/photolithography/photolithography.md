...
source: https://en.wikipedia.org/wiki/Photolithography
...
$DOF=k_{2}\cdot {\frac {\lambda }{\,{NA}^{2}}}$

Here, $\,k_{2}$ is another process-related coefficient. The depth of focus restricts the thickness of the photoresist and the depth of the topography on the wafer. Chemical mechanical polishing is often used to flatten topography before high-resolution lithographic steps.
