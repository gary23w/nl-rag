---
title: "</> htmx ~ Documentation (part 1/2)"
...
Note: Idiomorph does not follow the naming convention of htmx extensions. Use `idiomorph` instead of `htmx-ext-idiomorph`. For example, `https://cdn.jsdelivr.net/npm/idiomorph` or `npm install idiomorph`.
