...
source: https://en.wikipedia.org/wiki/Array_programming
domain: dex-language
...
(associativity also holds for matrices)
...
(associativity also holds for matrices, commutativity is no more required)
