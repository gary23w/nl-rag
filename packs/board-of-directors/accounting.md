...
The first published work on a double-entry bookkeeping system was the *Summa de arithmetica*, published in Italy in 1494 by Luca Pacioli (the "Father of Accounting"). Accounting began to transition into an organized profession in the 19th century, with local professional bodies in England merging to form the Institute of Chartered Accountants in England and Wales in 1880.
...
Tax accounting in the United States concentrates on the preparation, analysis and presentation of tax payments and tax returns. The U.S. tax system requires the use of specialised accounting principles for tax purposes which can differ from the generally accepted accounting principles (GAAP) for financial reporting. U.S. tax law covers three basic forms of business ownership: partnership, corporation, and disregarded entity. Corporate and personal income are taxed at different rates, both varying according to income levels and including varying marginal rates (taxed on each additional dollar of income) and average rates (set as a percentage of overall income).
