...
- Type **fish** to start a shell: > fish
- Type **exit** to end the session: > exit
...
1. Add the shell to `/etc/shells` with: > command -v fish | sudo tee -a /etc/shells
2. Change your default shell with: > chsh -s "$(command -v fish)"
