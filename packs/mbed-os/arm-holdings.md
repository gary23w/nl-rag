---
title: "Arm Holdings"
source: https://en.wikipedia.org/wiki/Arm_Holdings
domain: mbed-os
...
Allant Software, a developer of

debugging

software

Infinite Designs, a design company based in
...
The engineering team of Noral Micrologics, a debug hardware and software company based in
...
Adelante Technologies of Belgium, creating its OptimoDE data engines business, a form of lightweight
...
Axys Design Automation, a developer of

ESL

design tools

and Artisan Components, a designer of
...
(MCU) market, including

8051

and C16x platforms.

ARM also acquired the engineering team of PowerEscape.
...
SOISIC, who specialise in developing
...
(In February 2015, PolarSSL has been rebranded to

mbed TLS

to better show its fit inside the
...
company that developed a suite of tools that automate the process of IP configuration and IP integration

**2015**

Sansa Security, a provider of hardware security

intellectual property

(IP) and software for advanced system-on-chip components deployed in Internet of Things (IoT) and mobile devices

Wicentric, a

Bluetooth

Smart stack and profile provider
...
($600 million acquisition), provides enterprise data management software for device-to-data IoT platform
...
completed the acquisition of Arm Artisan Foundation IP, which ARM originally acquired from Artisan Components in 2004.
