---
title: "OpenAL"
source: https://en.wikipedia.org/wiki/OpenAL
...
AeonWave-OpenAL is an LGPL-licensed OpenAL emulation layer that takes advantage of the hardware acceleration provided by the

non-free

but low cost AeonWave 4D-audio library for Linux and Windows made by

Adalin B.V.

The author claims that AeonWave-OpenAL implementation renders 3D audio five (on an
...
library this implementation supports HRTF as well as spatialised surround sound for up to eight speakers.

**Rapture3D OpenAL Driver**

The Rapture3D OpenAL Driver is a

non-free

, commercial, Windows only, software implementation made by

Blue Ripple Sound

. The library is intended as a high performance drop-in replacement for other implementations. It features:
...
Tiny (single-file), full OpenAL 1.1 implementation built on top of
