---
title: "1,000,000,000"
source: https://en.wikipedia.org/wiki/1,000,000,000_(number)
...
- **1,073,742,724** : Leyland number using 2 and 30 (230 + 302)
- **1,073,792,449** : Leyland number using 4 and 15 (415 + 154)
...
- **1,160,290,625** = 655
- **1,162,261,467** = 319
- **1,162,268,326** : Leyland number using 3 and 19 (319 + 193)
...
- **1,173,741,824** : Leyland number using 8 and 10 (810 + 108)
- **1,220,703,125** = 513
- **1,221,074,418** : Leyland number using 5 and 13 (513 + 135)
- **1,252,332,576** = 665
- **1,280,000,000** = 207
...
- **1,626,557,542** : Is "QWERTY" in base 36.
...
- **1,996,813,914** : Leyland number using 7 and 11 (711 + 117)
...
- **2,147,483,648** = 231
- **2,147,484,609** : Leyland number using 2 and 31 (231 + 312)
- **2,176,782,336** = 466562 = 12963 = 2164 = 366 = 612
- **2,179,768,320** : Leyland number using 6 and 12 (612 + 126)
...
- **3,404,825,447** = 237
- **3,405,691,582** = CAFEBABE16; used as a magic debug value in programming.
- **3,405,697,037** = CAFED00D16; used as a magic debug value in programming.
- **3,461,824,644** : number of secondary structures of RNA molecules with 28 nucleotides
- **3,486,784,401** = 590492 = 2434 = 815 = 910 = 320
- **3,486,792,401** : Leyland number using 3 and 20 (320 + 203)
...
- **3,735,928,559** = DEADBEEF16; used as a magic debug value in programming.
- **3,735,929,054** = DEADC0DE16; used as a magic debug value in programming.
- **3,939,040,643** = 835
...
- **4,294,968,320** : Leyland number using 2 and 32 (232 + 322)
- **4,295,032,832** : Leyland number using 4 and 16 (416 + 164)
- **4,437,053,125** = 855
- **4,444,444,444** : repdigit
- **4,467,033,943** : number of parallelogram polyominoes with 28 cells.
- **4,486,784,401** : Leyland number using 9 and 10 (910 + 109)
- **4,586,471,424** = 247
- **4,704,270,176** = 865
...
- **5,159,780,352** = 17283 = 129 = 1,000,000,00012, or a great-great-great-gross (1,000,00012 great-grosses or 100012 great-great-grosses)
- **5,277,319,168** = 885
...
- **6,104,053,449** : Leyland number using 5 and 14 (514 + 145)
...
- **8,589,935,681** : Leyland prime using 2 and 33 (233 + 332)
