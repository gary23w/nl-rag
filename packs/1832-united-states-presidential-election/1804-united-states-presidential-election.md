...
| (Democratic-Republican Party)**1804 Democratic-Republican Party ticket** |   |
|---|---|
...
| (Federalist Party)**1804 Federalist Party ticket** |   |
|---|---|
...
- a.**^** *In six states, electors were chosen by the legislature rather than by popular vote. The 11 states where electors were chosen via popular vote had widely varying restrictions on suffrage.*
- b.**^** *Popular vote figures from North Carolina and Tennessee are incomplete.*
- c.**^** *In states where electors were chosen by popular vote, the Federalist ticket was formally unpledged.*
- d.**^** *Unpledged electors carried two Maryland districts; these electors voted for Pinckney and King.*

|   |   |   |
|---|---|---|
| **Jefferson** |  | 72.8% |
| Unpledged electors |  | 26.8% |
| Others |  | 0.4% |
...
- (Popular vote by state)Popular vote by state
- (Popular vote by county)Popular vote by county
- (Popular vote by electoral district)Popular vote by electoral district
