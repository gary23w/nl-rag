...
source: https://en.wikipedia.org/wiki/Quantitative_structure%E2%80%93activity_relationship
...
One of the first historical QSPR applications (as pre-condition to QSAR) was to predict boiling points.
...
| 7. | AZOrange | RT, SVM, ANN, and RF | *"AZCompTox/AZOrange: AstraZeneca add-ons to Orange". *GitHub*. 2018-09-19.* |
...
| 13. | alvaModel | Regression (OLS, PLS, k-NN, SVM, DT, RF and Consensus) and Classification (LDA/QDA, PLS-DA, k-NN, SVM, DT, RF and Consensus) | *"alvaModel: a software tool to create QSAR/QSPR models". *alvascience.com*.* |
| 14. | scikit-learn (Python) | Logistic Regression, Naive Bayes, kNN, RF, SVM, GP, ANN, and others | *"SciKit-Learn". *scikit-learn.org*. Retrieved 13 August 2023.* |
| 15. | Scikit-Mol | Integration of Scikit-learn models and RDKit featurization | scikit-mol on pypi.org |
| 16. | scikit-fingerprints | Molecular fingerprints, API compatible with Scikit-learn models | *"scikit-fingerprints". *GitHub*. Retrieved 29 December 2024.* |
