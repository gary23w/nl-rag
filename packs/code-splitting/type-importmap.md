---
title: "<script type='importmap'> HTML attribute value - HTML"
...
# `<script type="importmap">` HTML attribute value
...
Supporting browsers can declare one or more import maps anywhere in the document, provided they are defined before any module that depends on them is loaded (some browser versions allow only a single import map declaration, which must appear before any module is loaded).
