---
title: "ScreenOrientation: lock() method - Web APIs"
...
Thrown if there is any other `lock()` method invoking or if `unlock()` is called while the lock promise is pending.
