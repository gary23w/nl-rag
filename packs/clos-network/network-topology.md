...
- *Signal traces* on printed circuit boards are common for board-level serial communication, particularly between certain types of integrated circuits, a common example being SPI.
...
- An *optical fiber* is a glass fiber. It carries pulses of light that represent data. Some advantages of optical fibers over metal wires are very low transmission loss and immunity from electrical interference. Optical fibers can simultaneously carry multiple wavelengths of light, which greatly increases the rate at which data can be sent, and helps enable data rates of up to trillions of bits per second. Optic fibers can be used for long runs of cable carrying very high data rates, and are used for undersea communications cables to interconnect continents.
...
- *Radio and spread spectrum technologies* – Wireless local area networks use a high-frequency radio technology similar to digital cellular and a low-frequency radio technology. Wireless LANs use spread-spectrum technology to enable communication between multiple devices in a limited area. IEEE 802.11 defines a common flavor of open-standard wireless radio-wave technologies known collectively as Wi-Fi.
