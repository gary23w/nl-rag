...
source: https://en.wikipedia.org/wiki/Josiah_Willard_Gibbs
...
where $k_{\text{B}}$ is the Boltzmann constant, while the sum is over all possible microstates i , with $p_{i}$ the corresponding probability of the microstate (see Gibbs entropy formula). This same formula would later play a central role in Claude Shannon's information theory and is therefore often seen as the basis of the modern information-theoretical interpretation of thermodynamics.
