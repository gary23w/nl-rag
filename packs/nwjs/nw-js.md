...
source: https://en.wikipedia.org/wiki/NW.js
domain: nwjs
...
Many Chromium-based browsers, such as Google Chrome and Microsoft Edge, include the proprietary components, such as proprietary wrapper libraries for hardware acceleration.
...
Google first chose the name "Chrome" with intention to minimize *chrome* for its browser. Then the open-source release was named "Chromium" because chromium metal is used to make chrome plating.
...
The Chromium browser codebase is widely used, so others have made important contributions, most notably Microsoft, Avast, Igalia, Yandex, Intel, Samsung, LG, Opera, Vivaldi, and Brave. Some employees of these companies also have @chromium.org email addresses.
...
| 12 | historic (120.0.6099.129 (IA-32)) |   |
| OpenBSD -current | current (x64, ARM64) |   |
| OpenBSD -stable | 7.8 | historic (145.0.7632.109 (x64, ARM64)) |
| 7.5 | historic (122.0.6261.111 (IA-32)) |   |

## Browsers based on Chromium

In addition to Google Chrome, Microsoft Edge, Opera, Vivaldi and Brave, many other actively developed browsers are based on the Chromium code. Most of these are proprietary, like Chrome, but some remain free and open-source software (FOSS), like Chromium.
