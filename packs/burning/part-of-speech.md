...
Some modern classifications include additional classes, such as particles (*yes*, *no*) and postpositions (*ago*, *notwithstanding*), although these categories contain a much smaller number of words.
...
) or concrete entity (concrete noun: e.g.
...
; some can belong to either category. The most common part of speech; they are called naming words.
...
a modifier of a noun or pronoun (
...
a modifier of an adjective, verb, sentence, or another adverb (
...
a grammatical marker of definiteness (
...
). The article is not always listed separately as its own part of speech. It is considered by some grammarians to be a type of adjective

or sometimes the term '
