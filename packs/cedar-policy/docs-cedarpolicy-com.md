...
This guide is a reference for Version 4.5 of the Cedar policy language.
...
Amazon Verified Permissions is a managed service using Cedar. For a list of some of the other services that use Cedar as their policy language, see Cedar Integrations
