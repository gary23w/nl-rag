---
title: "Fuel"
source: https://en.wikipedia.org/wiki/Fuel
domain: fuel
...
- (Locomotive diesel)Locomotive diesel
- (Gasoline)Gasoline
- (Kerosene)Kerosene
- (Petroleum based motor oil)Petroleum based motor oil
- (Residual fuel oil or Bunker C oil)Residual fuel oil or Bunker C oil
...
| Fuel type | Specific energy (MJ/kg) | Air–fuel ratio (stoichiometric) | Energy @ *λ*=1 (MJ/kg(Air)) |
|---|---|---|---|
