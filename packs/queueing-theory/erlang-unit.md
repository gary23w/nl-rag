...
The formula provides the GoS (grade of service) which is the probability *P*b that a new call arriving to the resources group is rejected because all resources (servers, lines, circuits) are busy: *B*(*E*, *m*) where *E* is the total offered traffic in erlang, offered to *m* identical parallel resources (servers, communication channels, traffic lanes).

$P_{\text{b}}=B(E,m)={\frac {\frac {E^{m}}{m!}}{\sum _{i=0}^{m}{\frac {E^{i}}{i!}}}}$

where:

- *P*b is the probability of blocking
