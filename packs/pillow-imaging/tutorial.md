...
|   | `thumbnail()` | `contain()` | `cover()` | `fit()` | `pad()` |
|---|---|---|---|---|---|
| Given size | `(100, 150)` | `(100, 150)` | `(100, 150)` | `(100, 150)` | `(100, 150)` |
| Resulting image | (../_images/image_thumbnail.webp) | (../_images/imageops_contain.webp) | (../_images/imageops_cover.webp) | (../_images/imageops_fit.webp) | (../_images/imageops_pad.webp) |
