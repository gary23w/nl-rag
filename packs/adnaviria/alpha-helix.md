---
title: "Alpha helix"
source: https://en.wikipedia.org/wiki/Alpha-helix
domain: adnaviria
...
detail. Two hydrogen bonds for the same peptide group are highlighted in magenta; the H to O distance is about 2
...
chain runs upward here; that is, its

N-terminus

is at the bottom and its C-terminus at the top. Note that the sidechains (black stubs) angle slightly downward, toward the N-terminus, while the peptide oxygens (red) point up and the peptide NHs (blue with grey stubs) point down.

Top view of the same helix shown above. Four
...
| Amino acid | 3- letter | 1- letter | Helical penalty |   |
|---|---|---|---|---|
| kcal/mol | kJ/mol |   |   |   |
