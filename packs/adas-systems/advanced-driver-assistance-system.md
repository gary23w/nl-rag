...
source: https://en.wikipedia.org/wiki/Advanced_driver-assistance_system
domain: adas-systems
...
- (Auto-HUD displayed on windshield) Auto-HUD displayed on windshield
- (Automotive night vision display) Automotive night vision display
- (Backup camera displayed in digital instrument panel) Backup camera displayed in digital instrument panel
...
ADAS behavior might change from car to car as well; for instanc,e ACC speed might be temporarily overridden in most cars, while some switch to standby after one minute.
