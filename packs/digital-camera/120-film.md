---
title: "120 film"
source: https://en.wikipedia.org/wiki/120_film
...
120's sister format **220**, introduced in 1965, is largely the same as 120, but is twice the length. Many cameras which shoot 120 are also designed to shoot 220, although older 120 cameras that use frame number windows are unsuitable for 220, as it lacks the backing paper that 120 has. Like 620, new rolls of 220 roll film are not produced by many manufacturers.
...
Cameras using 120 film will often combine the numbers of the frame size in the name e.g. Pentax 6×7 (6×7), Fuji 617 (6×17), and many *645*s (6×4.5). The number '6' in general, and the word 'six' are also commonly used in naming cameras e.g. Kiev 60 and Pentacon Six.
