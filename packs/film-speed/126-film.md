---
title: "126 film"
source: https://en.wikipedia.org/wiki/126_film
domain: film-speed
...
- (A strip of 126 negatives, showing the square format and single perforation. The film is pre-exposed with frame lines and numbers, a feature intended to make printing and viewing easier.)A strip of 126 negatives, showing the square format and single perforation. The film is pre-exposed with frame lines and numbers, a feature intended to make printing and viewing easier.
- (126 negative strip (converted to positive) with numbered leaders on a roll of 20 exposures from the 1970s showing the manufacturer text "Kodak Safety Film" indicating acetate base (non-nitrate).)126 negative strip (converted to positive) with numbered leaders on a roll of 20 exposures from the 1970s showing the manufacturer text "Kodak Safety Film" indicating acetate base (non-nitrate).
