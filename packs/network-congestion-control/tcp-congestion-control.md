...
When a loss occurs, retransmission is sent, half of the current CWND is saved as

ssthresh

and slow start begins again from its initial CWND.
...
is sent, half of the current CWND is saved as

ssthresh

and as the new value for CWND, thus skipping slow start and going directly to the congestion avoidance algorithm. The overall algorithm here is called
