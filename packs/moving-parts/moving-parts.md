---
title: "Moving parts"
source: https://en.wikipedia.org/wiki/Moving_parts
domain: moving-parts
...
The *kinetic energy of rotation of the moving parts* can be determined by noting that every such system of moving parts can be reduced to a collection of connected bodies rotating about an instantaneous axis, which form either a ring or a portion of an ideal ring, of radius a rotating at n revolutions per second. This ideal ring is known as the *equivalent flywheel*, whose radius is the *radius of gyration*. The integral of the squares of the radii all the portions of the ring with respect to their mass $\int a^{2}dm$ , also expressible if the ring is modelled as a collection of discrete particles as the sum of the products of those mass and the squares of their radii $\sum _{k=0}^{n}m_{k}\times a_{k}^{2}$ is the ring's moment of inertia, denoted I . The rotational kinetic energy of the whole system of moving parts is ${\frac {1}{2}}I\omega ^{2}$ , where $\omega$ is the angular velocity of the moving parts about the same axis as the moment of inertia.

The *kinetic energy of translation* of the moving parts is ${\frac {1}{2}}mv^{2}$ , where m is the total mass and v is the magnitude of the velocity. This gives the formula for the *total kinetic energy of the moving parts of a machine* as ${\frac {1}{2}}I\omega ^{2}+{\frac {1}{2}}mv^{2}$ .
