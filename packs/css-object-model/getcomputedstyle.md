---
title: "Window: getComputedStyle() method - Web APIs"
...
A *live* `CSSStyleProperties` object, which updates automatically when the element's styles change.
