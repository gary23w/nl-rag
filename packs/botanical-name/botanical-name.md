...
source: https://en.wikipedia.org/wiki/Botanical_name
...
(Japanese barberry) a species name, i.e., a

combination

consisting of a genus name and one epithet
...
Lacecap Group – a genus name and Group epithet

Lilium

Darkest Red Group – a genus name and Group epithet

Paphiopedilum

Greenteaicecreamandraspberries grex

snowdrop 'John Gray' – an unambiguous common name for the genus

Galanthus

and a cultivar epithet
...
(American hedge bindweed), a combination consisting of a genus name and two epithets
...
Gemmifera Group – a species name and Group epithet
...
is the name of a species, in which

perennis

is the specific epithet. There is no connecting term involved to indicate the rank.
