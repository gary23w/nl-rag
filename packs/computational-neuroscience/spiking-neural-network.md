...
source: https://en.wikipedia.org/wiki/Spiking_neural_network
...
- snnTorch – an open-source Python library that simplifies building spiking neural networks and implementing gradient-based training using PyTorch.
