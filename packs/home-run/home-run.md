---
title: "Home run"
source: https://en.wikipedia.org/wiki/Home_run
domain: home-run
...
The term "four-run homer" is never used. Instead, it is called a "grand slam". Hitting a grand slam is the best possible result for the batter's turn at bat and the worst possible result for the pitcher and his team.
...
On October 25, 2024, Freddie Freeman made history by hitting a walk-off grand slam in the bottom of the 10th inning in Game 1 of the World Series, leading the Los Angeles Dodgers to a 6-3 victory over the New York Yankees. Freeman is the only player in MLB history to do so in the World Series.
...
A leadoff home run is a home run hit by the first batter of a team, the leadoff hitter of the first inning of the game. In MLB (major league Baseball), Rickey Henderson holds the career record with 81 lead-off home runs. Craig Biggio holds the National League career record with 53, fourth overall following Henderson, George Springer with 61, and Alfonso Soriano with 54. As of August 26, 2025, Springer holds the career record among active players, with 61 leadoff home runs, which also ranks second all-time.
