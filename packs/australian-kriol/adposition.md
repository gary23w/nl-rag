---
title: "Adposition"
source: https://en.wikipedia.org/wiki/Adposition
domain: australian-kriol
license: CC-BY-SA-4.0
tags: australian kriol
fetched: 2026-07-05
---
...
- Khmer: **លើ**ក្តារខៀន [**ləː** kdaːkʰiən] ("**on** (the) blackboard")
...
- Latin: *me**cum*** ("**with** me", literally "me **with**")
- Turkish: *benim**le*** or *benim **ile*** ("**with** me", literally "my **with**")
- Hungarian: *fa **alatt*** ("**under** the tree", literally "tree **under**")
- Chinese: 桌子**上** *zhuōzi **shàng*** (lit. "table **on**"); this is a nominal form, which usually requires an additional preposition to form an adverbial phrase (see Chinese locative phrases)
...
- Chinese: **从**冰箱**里** ***cóng** bīngxiāng **lǐ*** ("from the inside of the refrigerator", lit. "from refrigerator inside")
...
- Tigrinya: ***ካብ** ሕጂ '***ን**ደሓር ("from now on", lit. "from now to later")
...
*Cymerodd ef hi **ohonof*** – 'he took it **from me**'.
...
- Finnish: (case) *talo**ssa*** (house-*inessive*, "in the house") vs. (postposition) *talon **edessä*** (house-*genitive* in front, "in front of the house")
- Hungarian: (case) *tető**n*** (roof-*superessive*, "on the roof") vs. (postposition) *tető **alatt*** ("under the roof")
