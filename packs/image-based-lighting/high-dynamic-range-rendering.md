...
source: https://en.wikipedia.org/wiki/High-dynamic-range_rendering
...
Currently HDRR has been prevalent in games, primarily for PCs but was previously prevalent in Microsoft's Xbox 360and Sony's PlayStation 3. It has also been simulated on the PlayStation 2, GameCube, Xbox and Amiga systems. Sproing Interactive Media had announced that their Athena game engine for the Wii will support HDRR, which added the Wii to the list of systems that support it.
