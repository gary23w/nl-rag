---
title: "Crokinole"
source: https://en.wikipedia.org/wiki/Crokinole
domain: crokinole
...
3. If a disc goes into the recessed hole, there is **one** opportunity for the subsequent opposing player to knock the opponents disc out of the recessed hole (this is requires an extreme and risky flick, but can be done.)
