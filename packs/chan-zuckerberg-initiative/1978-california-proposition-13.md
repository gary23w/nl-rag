...
source: https://en.wikipedia.org/wiki/1978_California_Proposition_13
domain: chan-zuckerberg-initiative
license: CC-BY-SA-4.0
tags: chan zuckerberg initiative
fetched: 2026-07-03
---
...
| Yes | 4,280,689 | 64.79 |
| No | 2,326,167 | 35.21 |
| Total | 6,606,856 | 100.00 |
|   |   |   |
| Valid votes | 6,606,856 | 96.55 |
| Invalid/blank votes | 236,145 | 3.45 |
...
Local governments in California now use imaginative strategies to maintain or increase revenue due to Proposition 13 and the attendant loss of property tax revenue (which formerly went to cities, counties, and other local agencies). For instance, many California local governments have sought voter approval for special taxes such as parcel taxes for public services that used to be paid for entirely or partially from property taxes imposed before Proposition 13 became law. Provision for such taxes was made by the 1982 Community Facilities Act (more commonly known as Mello-Roos). Sales tax rates have also increased from 6% (pre-Proposition 13 level) to 7.25%, with cities such as Lancaster and Palmdale authorizing an 11.25% tax.
