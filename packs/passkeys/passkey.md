---
title: "WebAuthn"
source: https://en.wikipedia.org/wiki/Passkey
domain: passkeys
...
*Passkey* is the de facto non-technical term for a WebAuthn credential. Most user interfaces that support WebAuthn use only *passkey* to refer to WebAuthn credentials.
