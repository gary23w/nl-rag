---
title: "Making network requests with JavaScript - Learn web development"
source: https://developer.mozilla.org/en-US/docs/Web/Guide/AJAX
...
|---|---|
| Learning outcomes: | Asynchronous network requests, which is by far the most common asynchronous JavaScript use case on the web. Common types of resources that are fetched from the network: JSON, media assets, data from RESTful APIs. How to use `fetch()` to implement asynchronous network requests. |
