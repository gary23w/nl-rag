...
source: https://en.wikipedia.org/wiki/Coordination_complex
...
The central atom or ion is bonded to a fixed number of donor atoms, a value known as the coordination number; the most common coordination numbers are 2, 4, and 6. The geometry of the complex such as octahedral, tetrahedral, or square planar depends on the coordination number, the size and charge of the metal ion, and the nature of the ligands. Many coordination complexes exhibit isomerism, including cis–trans isomerism and optical isomerism.

The systematic study of coordination compounds began in the late 19th century with the work of Christian Wilhelm Blomstrand and Sophus Mads Jørgensen, and was definitively established by Alfred Werner, whose 1893 theory of coordination geometry earned him the Nobel Prize in Chemistry in 1913.

The electronic structure of coordination complexes, described by crystal field theory and ligand field theory, governs their characteristic properties, including their often vivid colors, their magnetic behavior, and their reactivity. The colors of transition metal complexes arise from electronic transitions between d orbitals or from charge-transfer processes.
...
It was not until 1893 that the most widely accepted version of the theory today was published by Alfred Werner. Werner's work included two important changes to the Blomstrand theory. The first was that Werner described the two possibilities in terms of location in the coordination sphere. He claimed that if the ions were to form a chain, this would occur outside of the coordination sphere while the ions that bound directly to the metal would do so within the coordination sphere. Werner also disproved the majority of the chain theory. Werner discovered the spatial arrangements of the ligands that were involved in the formation of the complex hexacoordinate cobalt. His theory explained the difference between a coordinated ligand and a charge-balancing ion in a compound for example, the chloride ion in the cobaltammine chlorides and accounted for many previously inexplicable isomers.

In 1911, Werner first resolved the cobalt/ammonia coordination complex hexol into optical isomers, overthrowing the theory that only carbon compounds could possess chirality.
...
- (cis-[CoCl2(NH3)4]+) *cis*-[CoCl2(NH3)4]+
- (trans-[CoCl2(NH3)4]+) *trans*-[CoCl2(NH3)4]+
- (fac-[CoCl3(NH3)3]) *fac*-[CoCl3(NH3)3]
- (mer-[CoCl3(NH3)3]) *mer*-[CoCl3(NH3)3]
...
- (Λ-[Fe(ox)3]3−) Λ-[Fe(ox)3]3−
- (Δ-[Fe(ox)3]3−) Δ-[Fe(ox)3]3−
- (Λ-cis-[CoCl2(en)2]+) Λ-*cis*-[CoCl2(en)2]+
- (Δ-cis-[CoCl2(en)2]+) Δ-*cis*-[CoCl2(en)2]+
...
4. **Coordination isomerism** occurs when both positive and negative ions of a salt are complex ions and the two isomers differ in the distribution of ligands between the cation and the anion. For example, [Co(NH3)6][Cr(CN)6] and [Cr(NH3)6][Co(CN)6].
...
contains a porphyrin complex of magnesium
...
→ tetrachloridonickelate(II) ion (The use of chloro- was removed from IUPAC naming convention)
