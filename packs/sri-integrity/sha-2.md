...
SHA-256 and SHA-512 are vulnerable to a length extension attack, but SHA-384 and SHA-256/512 are not vulnerable because their output is a truncated version of their internal state.
