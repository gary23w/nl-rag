---
title: "Amber"
source: https://en.wikipedia.org/wiki/Amber
domain: oar
...
Amber is heterogeneous in composition, consisting of several resinous substances that are more or less soluble in alcohol, ether, and chloroform, along with an insoluble bituminous fraction. It is a macromolecule formed by free radical polymerization of terpenoid precursors—diterpenes in gymnosperms, particularly labdane-type compounds such as communic acid, communol, and biformene. In angiosperms, the terpenoids are dominated by triterpenes, although amber from the family Fabaceae also contains labdane-based diterpenes. These compounds provide alkene groups that enable polymerization. Over time, amber matures through further polymerization, isomerization, crosslinking, and cyclization, resulting in its characteristic stable, fossilized structure.
...
Goethe is documented as a rare user of amber, from which he cut lenses to visualize certain optical phenomena. Motivated by a manuscript sent to him by T. J. Seebeck in 1813 "on the reflection and refraction of light", he also conducted experiments on entoptic phenomena. Goethe attempted to replicate such phenomena on pieces of amber that he pierced himself. New evidence in 2026 showed that he held a small collection of 42 amber pieces. Of these, 40 were the subject of a detailed examination for bioinclusions in 2026, during which two nematoceran flies and an ant were found.
...
- Other fossil resins: burmite in Burma, rumanite in Romania, and simetite in Sicily.
...
- Acetylcellulose (no longer used)
