...
workstation oriented as both a desktop
...
. Optional plastic feet

(pictured bottom right)

allow the workstation to be held sturdily upright in the tower configuration.
...
Open Frame cases have easy service access, and have no airflow problems, are great for building liquid-cooled systems and have an industrial design look, but will draw a lot of dust on components and needs cleaning them more often, yet the design allows blowing dust away with ease.
...
server with rack-mountable and desktop variants

HP9000

workstation, based on an Integrity desktop server
