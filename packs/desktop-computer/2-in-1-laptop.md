---
title: "2-in-1 laptop"
source: https://en.wikipedia.org/wiki/2-in-1_laptop
...
Operating systems such as Android even show the mouse cursor when a mouse is connected to a device running it, whereas Ubuntu Touch takes it even further by allowing the user to change the UI to a typical desktop environment which allows for desktop level multitasking, albeit with a smaller display.
