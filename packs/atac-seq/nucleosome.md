---
title: "Nucleosome"
source: https://en.wikipedia.org/wiki/Nucleosome
domain: atac-seq
...
DNA must be compacted into nucleosomes to fit within the cell nucleus. In addition to nucleosome wrapping, chromatin is further compacted by being folded into a series of more complex structures, eventually forming a chromosome. Each human cell contains about 30 million nucleosomes.
...
Also viruses can form nucleosome particles that include variants of canonical histones, which are sometimes fused in doublets in the same polipeptide chain thus giving place to a double histone fold.
...
The crystal structure of the nucleosome core particle (PDB: 1EQZ) - different views showing details of histone folding and organization. Histones H2A, H2B, H3, H4 and DNA are coloured.
