...
source: https://en.wikipedia.org/wiki/Organic_chemistry
...
Three representations of an organic compound,
...
Nonsystematic nomenclature is simpler and unambiguous, at least to organic chemists. Nonsystematic names do not indicate the structure of the compound. They are common for complex molecules, which include most natural products. Thus, the informally named lysergic acid diethylamide is systematically named (6a*R*,9*R*)-*N*,*N*-diethyl-7-methyl-4,6,6a,7,8,9-hexahydroindolo-[4,3-*fg*] quinoline-9-carboxamide.
