---
title: "Acetyl-CoA"
source: https://en.wikipedia.org/wiki/Acetyl-CoA
domain: 2-phosphoglyceric-acid
license: CC-BY-SA-4.0
tags: 2-phosphoglyceric acid
fetched: 2026-07-09
---
...
Konrad Bloch and Feodor Lynen were awarded the 1964 Nobel Prize in Physiology or Medicine for their discoveries linking acetyl-CoA and fatty acid metabolism. Fritz Lipmann won the Nobel Prize in 1953 for his discovery of the cofactor coenzyme A.
...
Within mitochondria, MCD similarly facilitates acetyl-CoA production by decarboxylating malonyl-CoA, thereby supporting metabolic flexibility during low-glucose states.
...
- Cholesterol synthesis:
  - The cytosolic acetyl-CoA can also condense with acetoacetyl-CoA to form 3-hydroxy-3-methylglutaryl-CoA (HMG-CoA) which is the rate-limiting step controlling the synthesis of cholesterol. Cholesterol can be used as is, as a structural component of cellular membranes, or it can be used to synthesize steroid hormones, bile salts, and vitamin D.
...
- Melatonin synthesis
- Acetylation:
  - Acetyl-CoA is also the source of the acetyl group incorporated onto certain lysine residues of histone and nonhistone proteins in the posttranslational modification acetylation. This acetylation is catalyzed by acetyltransferases. This acetylation affects cell growth, mitosis, and apoptosis.
- Allosteric regulator:
  - Acetyl-CoA serves as an allosteric regulator of pyruvate dehydrogenase kinase (PDK). It regulates through the ratio of acetyl-CoA versus CoA. Increased concentration of acetyl-CoA activates PDK.
