...
- (ASIMO environment sensor suite) ASIMO environment sensor suite
- (Two cameras behind ASIMO's visor) Two cameras behind ASIMO's visor
- (Pairs of black markings used for autonomous navigation) Pairs of black markings used for autonomous navigation
- (Ground sensors and front ultrasonic sensor, located at the lower torso) Ground sensors and front ultrasonic sensor, located at the lower torso
- ASIMO autonomously navigating through targets
- (Foot padding, called "Floor Reaction Control", accounts for small surface irregularities) Foot padding, called "Floor Reaction Control", accounts for small surface irregularities
- (Rear view) Rear view
