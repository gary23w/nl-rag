...
source: https://en.wikipedia.org/wiki/Cursor_(user_interface)
...
Though it is distinct from the text cursor, the mouse pointer is also being called a cursor, mouse cursor or a mouse.
