...
source: https://en.wikipedia.org/wiki/Resource_management_(computing)
...
with open(filename) as f:
    r: Iterator[list[str]] = csv.reader(f)
    # Use r.
