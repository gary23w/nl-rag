...
- the analysis of animal dispersal, which uses the observation that "fitness" should be equal at an "equilibrium" if we are to achieve an ideal free distribution is sourced to Stephen D. Fretwell and Henry L Lucas (1970).
...
| Cooperate Defect Cooperate 3, 3 1, 4 Defect 4, 1 2, 2 *Prisoner's Dilemma* | A B A 2, 2 1, 2 B 2, 1 2, 2 *Harm thy neighbor* |
|---|---|
...
| C D C 2, 2 1, 2 D 2, 1 0, 0 *Harm everyone* | Swerve Stay Swerve 0,0 −1,+1 Stay +1,−1 −20,−20 *Chicken* |
|---|---|
