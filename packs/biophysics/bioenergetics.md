---
title: "Bioenergetics"
source: https://en.wikipedia.org/wiki/Bioenergetics
domain: biophysics
...
The free energy (Δ*G*) gained or lost in a reaction can be calculated as follows: Δ*G* = Δ*H* − *T*Δ*S* where ∆*G* = Gibbs free energy, ∆*H* = enthalpy, *T* = temperature (in kelvins), and ∆*S* = entropy.
