---
title: "Fermion"
source: https://en.wikipedia.org/wiki/Fermion
...
Most Standard Model fermions are believed to be Dirac fermions, although it is unknown at this time whether the neutrinos are Dirac or Majorana fermions (or both). Dirac fermions can be treated as a combination of two Weyl fermions. In July 2015, Weyl fermions were experimentally realized in Weyl semimetals.

## Composite fermions

Composite particles (such as hadrons, nuclei, and atoms) can be bosons or fermions depending on their constituents. More precisely, because of the relation between spin and statistics, a particle containing an odd number of fermions is itself a fermion. It will have a half-integer spin. The number of bosons within a composite particle made up of simple particles bound with a potential has no effect on whether it is a boson or a fermion.
...
Fermions can exhibit bosonic behavior when they become bound in pairs. This is the origin of superconductivity and the superfluidity of helium-3. In superconducting materials, electrons interact through the exchange of phonons, forming Cooper pairs, while in helium-3, the atoms interact and pair via spin fluctuations.
