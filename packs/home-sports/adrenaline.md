---
title: "Adrenaline"
source: https://en.wikipedia.org/wiki/Adrenaline
domain: home-sports
...
| Biosynthetic pathways for catecholamines and trace amines in the human brain (Graphic of catecholamine and trace amine biosynthesis) L-Phenylalanine L-Tyrosine L-DOPA **Adrenaline** Phenethylamine *p*-Tyramine Dopamine Noradrenaline *N*-Methylphenethylamine *N*-Methyltyramine *p*-Octopamine Synephrine 3-Methoxytyramine AADC AADC AADC primary pathway PNMT PNMT PNMT PNMT AAAH AAAH brain CYP2D6 minor pathway COMT DBH DBH (The image above contains clickable links)Epinephrine is produced in a small group of neurons in the human brain (specifically, in the medulla oblongata) via the metabolic pathway shown above. |
|---|
