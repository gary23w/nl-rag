---
title: "Data model"
source: https://en.wikipedia.org/wiki/Structured_data
domain: serilog-dotnet-lib
...
Similar to a relational database model, but objects, classes, and inheritance are directly supported in
...
- (Concept-oriented model) Concept-oriented model
...
- (Groups relate to process of making a map[15]) Groups relate to process of making a map
- (NGMDB data model applications[15]) NGMDB data model applications
- (NGMDB databases linked together[15]) NGMDB databases linked together
- (Representing 3D map information[15]) Representing 3D map information
