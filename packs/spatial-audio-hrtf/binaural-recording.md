...
source: https://en.wikipedia.org/wiki/Binaural_recording
...
More common is using a binaural head, also known as a dummy head, or *Kunstkopf*. These typically have two microphones, 15 cm (5.9 in) apart, facing away from each other, with a head shaped mass between them. Typically these microphones will be embedded within the head with a silicone mould of a pair of ears in front of them.
