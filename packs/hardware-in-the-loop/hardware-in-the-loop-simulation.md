...
source: https://en.wikipedia.org/wiki/Hardware-in-the-loop_simulation
...
Simulating sensor feedback to missile guidance systems allows developers to simulate the attitude sensors and record the drive to thrust vectoring systems and aerodynamic control surface devices to test their control algorithms in the lab. Providing fault conditions to missile control system sensors allows observation of the how guidance systems respond to those faults. The resilience of the system can be observed and subsequently improved using this technique.
