...
{\displaystyle SS_{n+1}=SS_{n}+{\frac {n}{n+1}}(x_{n+1}-{\bar {x}}_{n})^{2}}
...
{\displaystyle ns_{n}^{2}=(n-1)s_{n}^{2}+{\frac {n}{n+1}}(x_{n+1}-{\bar {x}}_{n})^{2}}
...
{\displaystyle s_{n}^{2}={\frac {n}{n+1}}(x_{n+1}-{\bar {x}}_{n})^{2}}
...
{\displaystyle x_{n+1}={\bar {x}}_{n}\pm s_{n}{\sqrt {\frac {n+1}{n}}}}
...
{\displaystyle (n+1)\sigma _{n+1}^{2}=n\sigma _{n}^{2}+{\frac {n}{n+1}}(x_{n+1}-\mu _{n})^{2}}
...
{\displaystyle (n+1)\sigma _{n}^{2}=n\sigma _{n}^{2}+{\frac {n}{n+1}}(x_{n+1}-\mu _{n})^{2}}
...
{\displaystyle \sigma _{n}^{2}={\frac {n}{n+1}}(x_{n+1}-\mu _{n})^{2}}
...
{\displaystyle x_{n+1}=\mu _{n}\pm \sigma _{n}{\sqrt {\frac {n+1}{n}}}}
