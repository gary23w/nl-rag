...
Enzymes can be classified by two main criteria: either their enzymatic activity or their amino acid sequence similarity (and thus evolutionary relationship).
...
| ${\ce {CO2{}+H2O->[{\text{Carbonic anhydrase}}]H2CO3}}$ (in tissues; high CO2 concentration) |   | 1 |
|---|---|---|

| ${\ce {CO2{}+H2O<-[{\text{Carbonic anhydrase}}]H2CO3}}$ (in lungs; low CO2 concentration) |   | 2 |
|---|---|---|
...
A chemical reaction mechanism with or without
...
(left) and the anti-cancer drug

methotrexate

(right) are very similar in structure (differences show in green). As a result, methotrexate is a competitive inhibitor of many enzymes that use folates.
