---
title: "Diesel cycle"
source: https://en.wikipedia.org/wiki/Diesel_cycle
...
$T_{3}$ can be approximated to the flame temperature of the fuel used. The flame temperature can be approximated to the adiabatic flame temperature of the fuel with corresponding air-to-fuel ratio and compression pressure, $p_{3}$ . $T_{1}$ can be approximated to the inlet air temperature.
