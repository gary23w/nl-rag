...
Oliver Selfridge's 1958 Pandemonium - A Paradigm for Learning paper was an important early theorectical contribution in establishing agent orientated architecture, though it used the term metaphorical 'demon' instead of agent. Carl Hewitt 1973 Actor model contained one of the earliest uses of agents as active entities rather than passive structures.
...
| JUNE | 2021 |   | Epidemic model used in the UK named after June Almeida. |
