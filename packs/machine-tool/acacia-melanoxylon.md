...
source: https://en.wikipedia.org/wiki/Acacia_melanoxylon
domain: machine-tool
...
The timber is susceptible to attacked by furniture beetles, termites and powder-post beetles (sapwood) due to its physical resistance to effective preservative treatments.
...
- (Acacia melanoxylon foliage and seeds with elaiosomes) *Acacia melanoxylon* foliage and seeds with elaiosomes
- (Seed pods) Seed pods
- (Seeds) Seeds
- (Inflorescences) Inflorescences
- (Saplings) Saplings
- (A. melanoxylon older bark) *A. melanoxylon* older bark
- (Tree outside Mount Field National Park) Tree outside Mount Field National Park
- (In 7th Brigade Park, Chermside, Queensland.) In 7th Brigade Park, Chermside, Queensland.
- (Habit) Habit
- (Yellow-tailed black-cockatoo searching for insect larvae in branches) Yellow-tailed black-cockatoo searching for insect larvae in branches
