---
title: "1893 Spanish general election"
source: https://en.wikipedia.org/wiki/1893_Spanish_general_election
domain: 1893-spanish-general-election
license: CC-BY-SA-4.0
tags: 1893 spanish general election
fetched: 2026-07-04
---
...
The Cortes were officially dissolved on 5 January and 4 February 1893, with the corresponding decree setting election day for 5 March (Congress) and 19 March 1893 (Senate) and scheduling for both chambers to reconvene on 5 April.
...
- Being taxpayers with a minimum quota of $5 (in Cuba) or $10 (in Puerto Rico)—amended in 1892—in property or corporate taxes (paid by the time of enrollment);
...
As a result of the aforementioned allocation, 331 single-member districts (including five special districts) were established, and each Congress multi-member constituency (a total of 34, electing 116 seats) was entitled the following seats:
...
- (Election results by constituency (Congress))Election results by constituency (Congress)
- (Election results by constituency (Senate))Election results by constituency (Senate)

### Distribution by group

| Group | Parties and alliances | C | S | Total |   |   |
|---|---|---|---|---|---|---|
|   | **PL** |   | Liberal Party (PL) | 275 | 107 | **416** |
