---
title: "Geographic information system (part 2/2)"
...
**Geological exploration and mineral resource assessment.**

In geology, GIS is increasingly used for the assessment and forecasting of mineral deposits, particularly for commonly occurring mineral resources (COMR) such as construction sands, clays, and peat. Unlike the dense and uniformly distributed borehole data typical of oil and gas exploration, COMR exploration often relies on sparse and unevenly distributed datasets. This requires specialized GIS algorithms, for instance, those based on Voronoi diagrams, to create three-dimensional geological models from incomplete information. Beyond modeling, GIS enables a comprehensive evaluation by integrating geological and industrial parameters—such as overburden ratio and deposit thickness—with land-use data to classify and rank potential mining sites based on their economic and environmental acceptability. A case study of this integrated approach was demonstrated for the Brest region in Belarus, where a regional digital model was created to forecast and evaluate new non-metallic mineral deposits, considering both geological constraints and land-use regulations for open-pit mining development.
...
With the popularization of GIS in decision making, scholars have begun to scrutinize the social and political implications of GIS. GIS can also be misused to distort reality for individual and political gain. GIS technologies played a central role during the COVID-19 pandemic by enabling public health agencies and researchers to visualize and monitor disease spread in real time. The *Johns Hopkins University COVID-19 Dashboard* became one of the most widely cited GIS applications, demonstrating how web-based spatial data can inform policy and public awareness. It has been argued that the production, distribution, use, and representation of geographic information are largely related with the social context and has the potential to increase citizen trust in government. Other related topics include discussion on copyright, privacy, and censorship. A more optimistic social approach to GIS adoption is to use it as a tool for public participation.
...
GIS has been an important tool in archaeology since the early 1990s.
