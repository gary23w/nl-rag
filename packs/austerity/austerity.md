---
title: "Austerity"
source: https://en.wikipedia.org/wiki/Austerity
domain: austerity
...
For example, the US Congressional Budget Office estimated that the payroll tax (levied on all wage earners) has a higher multiplier (impact on GDP) than does the income tax (which is levied primarily on wealthier workers). In other words, raising the payroll tax by $1 as part of an austerity strategy would slow the economy more than would raising the income tax by $1, resulting in less net deficit reduction.
...
According to economist Martin Wolf, the US and many Eurozone countries experienced rapid increases in their budget deficits in the wake of the 2008 crisis as a result of significant private-sector retrenchment and ongoing capital account surpluses.
...
By definition, the sum of the surpluses or deficits across these three sectors must be zero. In the US and many Eurozone countries other than Germany, a foreign financial surplus exists because capital is imported (net) to fund the trade deficit. Further, there is a private-sector financial surplus because household savings exceed business investment.
...
Economist Paul Krugman also explained in December 2011 the causes of the sizable shift from private-sector deficit to surplus in the US: "This huge move into surplus reflects the end of the housing bubble, a sharp rise in household saving, and a slump in business investment due to lack of customers."
...
Eurostat reported that the overall debt-to-GDP ratio for the EA17 was 70.1% in 2008, 80.0% in 2009, 85.4% in 2010, 87.3% in 2011, and 90.6% in 2012. Further, real GDP in the EA17 declined for six straight quarters from Q4 2011 to Q1 2013.
...
- Albania — 1962
- Argentina — 1952, 1985, 1998–2003, 2012, 2018–2019, 2022–
- Australia — 2014
...
- Romania — Ceaușescu's 1981–1989 austerity, 2010, 2025
- Spain — 1979, 2010–2014
- Sweden — 1995–1997
- United States — 1921, 1937, 1946, Omnibus Budget Reconciliation Act of 1993
- United Kingdom — during and after the two World Wars, 1976–1979, 2011–2019, 2021–2024
- Venezuela — 1989, 2016

## Criticism

According to economist David Stuckler and physician Sanjay Basu in their study *The Body Economic: Why Austerity Kills*, a health crisis is being triggered by austerity policies, including up to 10,000 additional suicides that have occurred across Europe and the US since the introduction of austerity programs.
...
J. Bradford DeLong and Lawrence Summers explained why an expansionary fiscal policy is effective in reducing a government's future debt burden, pointing out that the policy has a positive impact on its future productivity level. They pointed out that when an economy is depressed and its nominal interest rate is near zero, the real interest rate charged to firms $r^{f}$ is linked to the output as ${\frac {\partial r^{f}}{\partial Y}}=-\delta$ . This means that the rate decreases as the real GDP increases, and the actual fiscal multiplier $\mu$ is higher than that in normal times; a fiscal stimulus is more effective for the case where the interest rates are at the zero bound. As the economy is boosted by government spending, the increased output yields higher tax revenue, and so we have

${\frac {\partial D}{\partial G}}=1-\mu \tau \;,$

where $\tau$ is a baseline marginal tax-and-transfer rate. Also, we need to take account of the economy's long-run growth rate g , as a steady economic growth rate may reduce its debt-to-GDP ratio. Then we can see that an expansionary fiscal policy is self-financing:

$(r-g)dD-\tau dY=(r-g)(1-\mu \tau )dG-\tau \eta \mu dG$

${\frac {\partial B}{\partial G}}=(r-g)(1-\mu \tau )-\tau \eta \mu \;,$

as long as ${\frac {\partial B}{\partial G}}$ is less than zero. Then we can find that a fiscal stimulus makes the long-term budget in surplus if the real government borrowing rate satisfies the following condition:

$(r-g)(1-\mu \tau )<\tau \eta \mu$

### Impacts on short-run budget deficit

Research by Gauti Eggertsson et al. indicates that a government's fiscal austerity measures actually increase its short-term budget deficit if the nominal interest rate is very low. In normal time, the government sets the tax rates $\tau _{s},\tau _{i}$ and the central bank controls the nominal interest rate i . If the rate is so low that monetary policies cannot mitigate the negative impact of the austerity measures, the significant decrease of tax base makes the revenue of the government and the budget position worse. If the multiplier is

${\frac {\partial Y}{\partial G}}>\gamma ={\frac {1+\tau _{s}+\theta \sigma ^{-1}\psi }{\tau _{i}+\tau _{s}+\theta }}$

then we have ${\frac {\partial D}{\partial G}}<0\;$ , where

$\theta ={\frac {b}{Y}}(1+i){\frac {\kappa }{(1-\beta \mu )}}\;.$

That is, the austerity measures are counterproductive in the short-run, as long as the multiplier is larger than a certain level $\gamma$ . This erosion of the tax base is the effect of the endogenous component of the deficit. Therefore, if the government increases sales taxes, then it reduces the tax base due to its negative effect on the demand, and it upsets the budget balance.
...
- Infrastructure-based development and Productivity-improving technologies
...
### Combining stimulus and austerity
