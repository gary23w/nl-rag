...
set from the /etc/passwd line of the crontab´s owner.  HOME and
...
they´re attached to. For example, specifying "*/35" for the minute
field of a crontab entry won´t cause that entry to be executed
