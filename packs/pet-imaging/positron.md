---
title: "Positron"
source: https://en.wikipedia.org/wiki/Positron
domain: pet-imaging
...
The **positron** or **antielectron** is the particle with an electric charge of +1*e*, a spin of 1/2 *ħ* (the same as the electron), and the same mass as an electron. It is the antiparticle (antimatter counterpart) of the electron. When a positron collides with an electron, annihilation occurs. If this collision occurs at low energies, it results in the production of two or more photons.
