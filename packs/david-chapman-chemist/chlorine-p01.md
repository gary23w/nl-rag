...
Chlorine gas was first used as a weapon on 22 April 1915 at the Second Battle of Ypres by the German Army. The effect on the Allied forces was devastating because the existing gas masks were difficult to deploy and had not been broadly distributed.
...
In the laboratory, hydrogen chloride gas may be made by drying the a concentrated aqueous solution of acid with concentrated sulfuric acid. Deuterium chloride, DCl, may be produced by reacting benzoyl chloride with heavy water (D2O).
...
The blue [Cl4]+ cation is formed by oxidation of elemental chlorine with IrF6:
...
This cation was characterized by X-ray diffraction as being rectangular in geometry (194 pm Cl–Cl and 294 pm Cl···Cl), consisting of two Cl2 units bonded by π*–π* orbital interactions. Despite the long bond length between the two Cl2 units, dissociation to Cl2 + Cl+2 was found to be endothermic by approximately 25 kcal/mol. It reacts with O2 to give a complex containing the [Cl2O2]+ cation.

### Chlorine fluorides

The three fluorides of chlorine form a subset of the interhalogen compounds, all of which are diamagnetic. Some cationic and anionic derivatives are known, such as ClF− 2, ClF− 4, ClF+ 2, and Cl2F+. Some pseudohalides of chlorine are also known, such as cyanogen chloride (ClCN, linear), chlorine cyanate (ClNCO), chlorine thiocyanate (ClSCN, unlike its oxygen counterpart), and chlorine azide (ClN3).
