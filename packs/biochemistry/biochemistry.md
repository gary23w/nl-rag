---
title: "Biochemistry"
source: https://en.wikipedia.org/wiki/Biochemistry
domain: biochemistry
...
Just six elements—carbon, hydrogen, nitrogen, oxygen, calcium and phosphorus—make up almost 99% of the mass of living cells, including those in the human body (see composition of the human body for a complete list). This short list is abbreviated **CHNOPS** (carbon, hydrogen, nitrogen, oxygen, phosphorus, and sulfur) as an aid to memory. In addition to the six major elements that compose most of the human body, humans require smaller amounts of possibly 18 more.
