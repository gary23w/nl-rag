...
domain: trusted-execution-environment
license: CC-BY-SA-4.0
tags: trusted execution environment, secure enclave isolation, trusted computing base, hardware root of trust, isolated execution environment
fetched: 2026-07-02
---
...
|---|---|---|---|---|---|
| Alibaba | Cloud Link TEE |   | GlobalPlatform | Full |   |
| Apple | Secure Enclave | Separate processor | Proprietary |   |   |
| BeanPod |   | ARM TrustZone | GlobalPlatform |   |   |
| Huawei | iTrustee | ARM TrustZone | GlobalPlatform | Full |   |
...
| Samsung | TEEgris and Knox | ARM TrustZone | GlobalPlatform | Full |   |
| TrustKernel | T6 | Arm / Intel | GlobalPlatform |   |   |
| Trustonic | Kinibi | ARM TrustZone | GlobalPlatform | Full |   |
| Trustonic | SW TEE | SW TEE on | GlobalPlatform |   |   |
| uberSpark | uberXMHF | ARM TrustZone / Intel |   | Formal Mechanized Proof |   |
| Watchdata | WatchTrust | ARM TrustZone | GlobalPlatform | Full |   |
