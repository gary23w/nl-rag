...
In linear models, the genotypes can be encoded in different manners. Let us consider a biallelic locus with two possible alleles, encoded by ${\textstyle A}$ and a . We consider **A** to correspond to the dominant allele to the reference allele ${\textstyle a}$ . The following table details the different encoding.

| Genotype | ${\textstyle AA}$ | ${\textstyle Aa}$ | ${\textstyle aa}$ |
|---|---|---|---|
