...
used in international matches, all of the same size:

i) A new white ball. White balls are mainly used in limited overs cricket, especially in matches played at night, under floodlights (left). ii) A new red ball. Red balls are used in day Test cricket, first-class cricket and some other forms of cricket (center).

iii) A used pink ball. Pink balls are used in
