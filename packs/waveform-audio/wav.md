...
Audio compact discs (CDs) do not use the WAV file format, instead using Red Book audio. The commonality is that audio CDs are encoded as uncompressed 16-bit 44.1 kHz stereo LPCM, which is one of the formats supported by WAV.
