...
The Einstein field equations are a system of 10 partial differential equations which describe how matter affects the curvature of spacetime. The system may be expressed in the form $G_{\mu \nu }+\Lambda g_{\mu \nu }=\kappa T_{\mu \nu },$ where Gμν is the Einstein tensor, gμν is the metric tensor, Tμν is the stress–energy tensor, Λ is the cosmological constant, G is the Newtonian constant of gravitation and c is the speed of light. The constant $\kappa ={\frac {8\pi G}{c^{4}}}$ is referred to as the Einstein gravitational constant.
