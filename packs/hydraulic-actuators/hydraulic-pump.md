...
source: https://en.wikipedia.org/wiki/Hydraulic_pump
...
- $\scriptstyle Q$ , flow (m3/s)
- $\scriptstyle n$ , stroke frequency (Hz)
- $\scriptstyle V_{\text{stroke}}$ , stroked volume (m3)
- $\scriptstyle \eta _{\text{vol}}$ , volumetric efficiency
...
- $\scriptstyle \eta _{\text{mech,hydr}}$ , mechanical/hydraulic efficiency
