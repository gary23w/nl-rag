...
From EIP-721 (opens in a new tab):
...
- Etherscan NFT Tracker (opens in a new tab) list the top NFT on Ethereum by transfers volume.
- CryptoKitties (opens in a new tab) is a game centered around breedable, collectible, and oh-so-adorable creatures we call CryptoKitties.
- Sorare (opens in a new tab) is a global fantasy football game where you can collect limited editions collectibles, manage your teams and compete to earn prizes.
- The Ethereum Name Service (ENS) (opens in a new tab) offers a secure & decentralized way to address resources both on and off the blockchain using simple, human-readable names.
- POAP (opens in a new tab) delivers free NFTs to people who attend events or complete specific actions. POAPs are free to create and distribute.
- Unstoppable Domains (opens in a new tab) is a San Francisco-based company building domains on blockchains. Blockchain domains replace cryptocurrency addresses with human-readable names and can be used to enable censorship-resistant websites.
- Gods Unchained Cards (opens in a new tab) is a TCG on the Ethereum blockchain that uses NFT's to bring real ownership to in-game assets.
- Bored Ape Yacht Club (opens in a new tab) is a collection of 10,000 unique NFTs, which, as well as being a provably-rare piece of art, acts as a membership token to the club, providing member perks and benefits that increase over time as a result of community efforts.

## Tutorials: Build with non-fungible tokens (ERC-721) on Ethereum

- Vyper ERC-721 Contract Walkthrough *– An annotated walkthrough of a full ERC-721 NFT contract written in Vyper.*
- How to Write & Deploy an NFT (Part 1/3) *– Step-by-step guide to writing and deploying your first ERC-721 smart contract.*
- How to Mint an NFT (Part 2/3) *– How to mint an ERC-721 NFT using your deployed smart contract and Web3.*
- How to View Your NFT in Your Wallet (Part 3/3) *– How to display your minted NFT in MetaMask after deployment.*
- NFT Minter Tutorial *– Build a full-stack NFT minting dapp with a React frontend, MetaMask, and Alchemy.*
