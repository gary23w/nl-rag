...
The number of mitochondria in a cell varies widely by organism, tissue, and cell type. A mature red blood cell has no mitochondria, whereas a liver cell can have more than 2000.
...
The inner membrane of mitochondria have folding to increase surface area, which in turn increases ATP (adenosine triphosphate) production. Mitochondria stripped of their outer membrane are called mitoplasts.
...
It contains more than 151 different polypeptides, and has a very high protein-to-phospholipid ratio (more than 3:1 by weight, which is about 1 protein for 15 phospholipids). The inner membrane is home to around 1/5 of the total protein in a mitochondrion. Additionally, the inner membrane has an unusual lipid profile, being rich in cardiolipin. This phospholipid was originally discovered in cow hearts in 1942, and is usually characteristic of mitochondrial and bacterial plasma membranes. Cardiolipin contains four fatty acids rather than two, and may help to make the inner membrane impermeable, and its disruption can lead to multiple clinical disorders including neurological disorders and cancer. Unlike the outer membrane, the inner membrane does not contain porins, and is highly impermeable to all molecules. Almost all ions and molecules require special membrane transporters to enter or exit the matrix. Proteins are ferried into the matrix via the translocase of the inner membrane (TIM) complex or via OXA1L. In addition, there is a membrane potential across the inner membrane, formed by the action of the enzymes of the electron transport chain. Inner membrane fusion is mediated by the inner membrane protein OPA1.
...
The electrons from NADH and FADH2 are transferred between multiple coenzymes, and ultimately to oxygen (O2) in several steps via the electron transport chain. NADH and FADH2 molecules are produced within the matrix via the citric acid cycle and in the cytoplasm by glycolysis. Reducing equivalents from the cytoplasm can be imported via the malate-aspartate shuttle system of antiporter proteins or fed into the electron transport chain using a glycerol phosphate shuttle.
...
Due to heat production, some studies suggested that mitochondria run at a higher temperature. The internal temperature in mitochondria was previously estimated to be 10C higher than the cytoplasm. However, the theory of this remains controversial and disputed as an issue with the sensor, and that temperatures this high would cause damage to mitochondrial components.
...
Mitochondrial proteins, including those produced from mitochondrial DNA and those imported from the cytoplasm, vary depending on the tissue and the species. In humans, 615 distinct types of proteins have been identified from cardiac mitochondria, whereas in rats, 940 proteins have been reported. The mitochondrial proteome is thought to be dynamically regulated.

Not every function of the mitochondrion is universally conserved in every organism that has it, but some are more commonly kept than the others. Most make ATP in some way (the vast majority by oxidative phosphorylation; a minority called hydrogenosomes instead use a hydrogenase). All known versions perform iron–sulphur cluster biosynthesis: this is made especially clear by the mitosome, which retains *only* this function. Also universally kept is the machinery for importing proteins from the cytoplasm into the mitochondrion, without which the mitochondrion cannot function at all.
...
Changes in mitochondrial number, structure, and activity accompany shifts in cellular state and environmental conditions. In many stem and progenitor cells, differentiation is associated with increased mitochondrial content and greater reliance on oxidative phosphorylation. Reprogramming differentiated cells into induced pluripotent stem cells generally produces the opposite pattern, with increased reliance on glycolysis and a less developed mitochondrial network.

Mitochondrial metabolism and signaling also influence the activation, differentiation, and function of immune cells. Mitochondrial networks are continually altered through fission, fusion, mitophagy, and intracellular transport. These processes affect mitochondrial distribution, quality control, metabolism, signaling, and cellular responses to stress. Abnormal mitochondrial dynamics have been associated with metabolic, cardiovascular, neurodegenerative, and neoplastic diseases.
...
Eukaryotes with less conventional life habits, especially anaerobes and parasitic species, tend to have vastly reduced versions of the mitochondrion because many features are simply useless to their lifestyle. In more stiking cases of reduction, "core" features such as electron transport chain, oxidative phosphorylation, even ATP production can be dispensed of. Mitochondrial proteins responsible for these functions, whether originally found in mtDNA or the nucleus, is simply lost. Some also have lost mitochondrial DNA altogether. Having separately occurred in many lineages to different degrees, these changes exemplify convergent evolution.

The Alveolata includes many parasitic species, some with no mitochondrial DNA. Even in a typical photosynthetic free-living organism of the group (*Chromera*), the mitochondrion has lost oxidative phosphorylation complexes I and III completely. Its mtDNA only has three genes, *cox1*, *cox3*, and a rRNA fragment. The parasite *Cryptosporidium* has no mitochondrial DNA, with what little functions it performs presumably transferred to the nucleus. It has an altered ATP generation system that renders the parasite resistant to many classical mitochondrial inhibitors such as cyanide, azide, and atovaquone. *Amoebophrya cerati*, a marine parasitic dinoflagellate (a kind of alveolate), also has no mitochondrial DNA. Using *Chomera* as a reference, it has moved *cox1* to the nuclear genome and lost the two other genes.

The hydrogenosomes, mitochondrion derivatives that has lost all OXPHOS ability and instead uses a newly acquired hydrogenase to make ATP, also largely lack DNA save for some transitional examples. The mitosomes, which does not make any energy at all and is presumably only kept for the ability to make iron-sulfur clusters, have no DNA. Both terms are merely *descriptive* terms based on the functions of the organelles and both have eolved more than just once.

#### Complete loss

*Monocercomonoides* and other oxymonads appear to have lost their mitochondria completely and at least some of the mitochondrial functions seem to be carried out by cytoplasmic proteins now. These organisms belong to the group of Preaxostyla, a group known for the prevalance of reductive evolution of mitochondria resulting in various mitochondrion-related organelles (MROs) such as hydrogensomes and mitosomes. By comparing the genomes of preaxostylids that have recognizable MROs to the oxymonads, a "roadmap" can be made of how the loss had finally happened.
