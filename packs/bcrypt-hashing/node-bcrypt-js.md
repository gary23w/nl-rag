...
|---|---|---|---|
| Latest commit History627 Commits627 Commits |   |   |   |
...
Because it's come up multiple times in this project and other bcrypt projects, it needs to be said. The `bcrypt` library is not susceptible to timing attacks. From bcrypt-ruby/bcrypt-ruby#42:
