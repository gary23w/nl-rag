---
title: "Matroid"
source: https://en.wikipedia.org/wiki/Matroid
...
This defines a closure operator $\operatorname {cl} :{\mathcal {P}}(E)\mapsto {\mathcal {P}}(E)$ where ${\mathcal {P}}$ denotes the power set, with the following properties:
