...
source: https://en.wikipedia.org/wiki/Automatic_speech_recognition
domain: whisper-asr
...
e.g. the 26 letters of the

English alphabet

are difficult to discriminate because they are confusing words (most notoriously, the E-set: "B, C, D, E, G, P, T, V, Z (when "Z" is pronounced "zee" rather than "zed", depending on region); an 8% error rate is considered good for this vocabulary.
