---
title: "Antecedent (grammar)"
source: https://en.wikipedia.org/wiki/Antecedent_(grammar)
...
tells everyone to buy him chocolate.
...
- Prepositional phrase as antecedent

e. Thomas plays soccer

in the park

. The kids all congregate
...
- Verb phrase as antecedent

h.

Susan lies all the time
...
- Entire clause as antecedent

i.

Our politicians have been pandering again

.

This

demotivates the voters.
...
- Discontinuous word combination as antecedent
...
In some cases, the wording could have an uncertain antecedent, where the antecedent of a pronoun is not clear because two or more prior nouns or phrases could match the count, gender, or logic as a prior reference. In such cases, scholars have recommended to rewrite the sentence structure to be more specific, or repeat the words of the antecedent rather than use only a pronoun phrase, as a technique to resolve the uncertain antecedent.
...
that she did not call

.

- Clause as postcedent, example of
...
- Prepositional phrase as postcedent
