...
**`pub use tls::Certificate;`Not (WebAssembly and (`target_os=unknown` or bare-metal)) and `__tls`**

**`pub use tls::Identity;`Not (WebAssembly and (`target_os=unknown` or bare-metal)) and `__tls`**

## Modules

**blockingNot (WebAssembly and (`target_os=unknown` or bare-metal)) and `blocking`**

A blocking Client API.

**cookieNot (WebAssembly and (`target_os=unknown` or bare-metal)) and `cookies`**

HTTP Cookies

**dnsNot (WebAssembly and (`target_os=unknown` or bare-metal))**
...
**multipartNot (WebAssembly and (`target_os=unknown` or bare-metal)) and `multipart`**

multipart/form-data

**redirectNot (WebAssembly and (`target_os=unknown` or bare-metal))**

Redirect Handling

**retryNot (WebAssembly and (`target_os=unknown` or bare-metal))**

Retry requests

**tlsNot (WebAssembly and (`target_os=unknown` or bare-metal)) and `__tls`**

TLS configuration and types

## Structs

**BodyNot (WebAssembly and (`target_os=unknown` or bare-metal))**

An asynchronous request body.

**ClientNot (WebAssembly and (`target_os=unknown` or bare-metal))**
...
**ClientBuilderNot (WebAssembly and (`target_os=unknown` or bare-metal))**
...
**NoProxyNot (WebAssembly and (`target_os=unknown` or bare-metal))**

A configuration for filtering out requests that shouldn’t be proxied

**ProxyNot (WebAssembly and (`target_os=unknown` or bare-metal))**
...
**RequestNot (WebAssembly and (`target_os=unknown` or bare-metal))**
...
**RequestBuilderNot (WebAssembly and (`target_os=unknown` or bare-metal))**
...
**ResponseNot (WebAssembly and (`target_os=unknown` or bare-metal))**
...
**UpgradedNot (WebAssembly and (`target_os=unknown` or bare-metal))**
...
**UnixSocketProviderUnix and not (WebAssembly and (`target_os=unknown` or bare-metal)) and `docsrs`**
