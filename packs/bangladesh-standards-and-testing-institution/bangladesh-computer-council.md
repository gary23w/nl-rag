...
source: https://en.wikipedia.org/wiki/Bangladesh_Computer_Council
domain: bangladesh-standards-and-testing-institution
license: CC-BY-SA-4.0
tags: bangladesh standards and testing institution
fetched: 2026-07-03
---
...
| Project name | Background | Year of Project Initiation | Objective |
|---|---|---|---|
| **Development of National Infra-Network for Bangladesh Government Phase-I**(*BanglaGovNet*) | To establish a robust ICT backbone network in Bangladesh. | 2010 | ● Connect all district administrations, 64 upazila administrations, 240 government ministries and departments, and important government offices in Dhaka District. ● Facilitate the smooth and successful implementation of e-government services in Bangladesh |
| **Development of National ICT Infra-Network for Bangladesh Government Phase-II**(*Info-Sarker Phase-II*) | Expand and enhance the ICT backbone network established in the BanglaGovNet project. | 2013 | Coverage Expansion: Extend the network to the upazila level. Connected government offices at the district and upazila levels. Create backbone connectivity from 64 districts to 487 upazilas. Additional Services: Implement video conferencing systems at various government offices. Provision of telemedicine services at rural government hospitals. |
| **Development of the National ICT Infra-network for Bangladesh Government Phase-III**(*Info-Sarker Phase-III*) | Expand network connectivity from Phase-II. | 2017 | Coverage Expansion: Connect 2600 unions using optical fiber. Establish VPN connections in 1,000 offices of Bangladesh Police. Provide high-speed internet facilities at the union level. |
| **Establishment of Broadband Connectivity in the Areas of Underprivileged Telecommunication Facilities**(*Connected Bangladesh*) | Establish optical fiber network connectivity for 617 remote and underprivileged unions where network connectivity has not already been established by Info-Sarker Phase-III and BTCL | 2018 | Coverage Expansion: Connect more than 617 remote and underprivileged unions. Provide network connectivity to all the schools/colleges/madrasas, growth centers, telecom operator sites, etc. in these unions. Provide Internet connection to people in remote areas**.** |
| **Innovation Design & Entrepreneurship Academy Project**(*iDEA)* | Establishing a national entrepreneurship platform and developing its supporting ecosystem |   | ● Establish a national entrepreneurship platform in Bangladesh through iDEA. ● Offer support to startup entrepreneurs with mentoring, funding, co-working spaces, marketing, and legal assistance. ● Build a regulatory framework ● Promote Bangladesh as a global startup hub |
| **Enhancement of Bangla Language in ICT through Research & Development** | To establish Bengali as a leading language on the global platform | 2016 | ● Establish Bangla as a leading language in computing globally through ICT. ● Standardize Bangla language features, develop tools and technologies ● Research to enhance Bangla-based computing. |
| **Strengthening of Government Video Conferencing Platform Project** | The installation of a 4K and artificial intelligence technology video conferencing system in the President's Office, the Prime Minister's Office, and various government offices for conducting online meetings, seminars, etc. | 2021 | Implementation of the video conferencing system President's Office, Prime Minister's Office, various government offices including the Cabinet Division, ECNEC meeting room, all district administrations, etc. |
| **Support to Hi-Tech Park Authority to Establish Hi-Tech Park at Kaliakoir, Gazipur** | Construction of Hi-Tech Park infrastructure | 2010 |   |
| **Digital Island- Moheshkhali** | Improve the quality of life of the residents of Maheshkhali Island using information and communication technology. | 2017 |   |
| **e-government Master Plan for Digital Bangladesh** | Implement a pilot project to establish a transparent and accountable e-government system in all spheres of government. | 2016 | Develop strategies for implementing eGovernment and change the Bangladesh government’s perception towards it |
| **Bangladesh e-government ERP (GRP)** | ● Establish a transparent and accountable e-government system across the whole of the Bangladesh Government. ● Create a common ERP aimed at automating the resource management of all government organizations | 2016 | Develop Bangladesh e-government Enterprise Resource Planning (ERP) software |
