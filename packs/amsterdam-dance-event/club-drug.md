---
title: "Club drug"
source: https://en.wikipedia.org/wiki/Club_drug
...
A psychedelic is a psychoactive drug whose primary action is to alter cognition and perception, typically by agonising serotonin receptors, causing thought and visual/auditory changes, and heightened state of consciousness. Major psychedelic drugs include LSD, psilocybin, DMT, mescaline, and 2C-B.
...
While not all club drugs are addictive (e.g. nitrous oxide), some can pose a risk of addiction when used recreationally (e.g. amphetamines).
