...
> When two initially isolated systems are combined into a new system, then the total internal energy of the new system, *U*system, will be equal to the sum of the internal energies of the two initial systems, *U*1 and *U*2: $U_{\rm {system}}=U_{1}+U_{2}.$
...
where *S* is the entropy of the system, *k*B is the Boltzmann constant, and *Ω* the number of microstates. At absolute zero there is only 1 microstate possible (*Ω* = 1 as all the atoms are identical for a pure substance, and as a result all orders are identical as there is only one combination) and $\ln(1)=0$ .
